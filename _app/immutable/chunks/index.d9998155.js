...
const P = {
  ...
  , G = i => typeof ArrayBuffer.isView == "function" ? ArrayBuffer.isView(i) : i && i.buffer instanceof ArrayBuffer
  , V = ({type: i, data: e}, t, s) => Q && e instanceof Blob ? t ? s(e) : $(e, s) : j && (e instanceof ArrayBuffer || G(e)) ? t ? s(e) : $(new Blob([e]), s) : s(y[i] + (e || ""))
  , $ = (i, e) => {
...
for (let i = 0; i < z.length; i++)
    E[z.charCodeAt(i)] = i;
const ue = i => {
    let e = i.length * .75, t = i.length, s, n = 0, r, o, c, h;
    i[i.length - 1] === "=" && (e--,
    i[i.length - 2] === "=" && e--);
...
function A(i, e) {
    ...
    for (let n = 0; n < e; n++)
        t[n] = i[0][s++],
        s === i[0].length && (i.shift(),
        s = 0);
    return i.length && s < i[0].length && (i[0] = i[0].slice(s)),
    t
}
function ge(i, e) {
    x || (x = new TextDecoder);
        ...
        transform(o, c) {
            for (t.push(o); ; ) {
                if (s === 0) {
                    ...
                    n = f * Math.pow(2, 32) + g.getUint32(4),
                    s = 3
                } else {
                    if (k(t) < n)
                        break;
                    const h = A(t, n);
                    c.enqueue(M(r ? h : x.decode(h), e)),
                    s = 0
                }
                if (n === 0 || n > i) {
                    c.enqueue(P);
...
u.prototype.off = u.prototype.removeListener = u.prototype.removeAllListeners = u.prototype.removeEventListener = function(i, e) {
    ...
    return t.length === 0 && delete this._callbacks["$" + i],
    this
}
;
...
const C = ( () => typeof Promise == "function" && typeof Promise.resolve == "function" ? e => Promise.resolve().then(e) : (e, t) => t(e, 0))()
  ...
  , _e = "arraybuffer";
function se(i, ...e) {
    return e.reduce( (t, s) => (i.hasOwnProperty(s) && (t[s] = i[s]),
    t), {})
}
const be = l.setTimeout
  , we = l.clearTimeout;
function S(i, e) {
    e.useNativeTimers ? (i.setTimeoutFn = be.bind(l),
    i.clearTimeoutFn = we.bind(l)) : (i.setTimeoutFn = l.setTimeout.bind(l),
...
function ke(i) {
    ...
    for (let s = 0, n = i.length; s < n; s++)
        e = i.charCodeAt(s),
        e < 128 ? t += 1 : e < 2048 ? t += 2 : e < 55296 || e >= 57344 ? t += 3 : (s++,
        t += 4);
    return t
}
function ie() {
...
class H extends u {
    ...
    onError(e, t, s) {
        return super.emitReserved("error", new Re(e,t,s)),
        this
    }
    open() {
...
class Oe extends H {
    ...
    uri() {
        const e = this.opts.secure ? "https" : "http"
          , t = this.query || {};
        return this.opts.timestampRequests !== !1 && (t[this.opts.timestampParam] = ie()),
...
class d extends u {
    ...
    _create() {
        ...
        try {
            ...
            s.onreadystatechange = () => {
                var n;
                s.readyState === 3 && ((n = this._opts.cookieJar) === null || n === void 0 || n.parseCookies(s.getResponseHeader("set-cookie"))),
        ...
        typeof document < "u" && (this._index = d.requestsCount++,
    ...
    _cleanup(e) {
        if (!(typeof this._xhr > "u" || this._xhr === null)) {
            if (this._xhr.onreadystatechange = Se,
            e)
                try {
                    this._xhr.abort()
                } catch {}
...
class Le extends H {
    ...
    doOpen() {
        const e = this.uri()
          ...
          , s = oe ? {} : se(this.opts, "agent", "perMessageDeflate", "pfx", "key", "passphrase", "cert", "ca", "ciphers", "rejectUnauthorized", "localAddress", "protocolVersion", "origin", "maxPayload", "family", "checkServerIdentity");
    ...
    uri() {
        const e = this.opts.secure ? "wss" : "ws"
          , t = this.query || {};
        return this.opts.timestampRequests && (t[this.opts.timestampParam] = ie()),
...
function Fe(i, e) {
    const t = /\/{2,9}/g
      , s = e.replace(t, "/").split("/");
    return (e.slice(0, 1) == "/" || e.length === 0) && s.splice(0, 1),
...
class _ extends u {
    ...
    setTransport(e) {
        this.transport && this.transport.removeAllListeners(),
        this.transport = e,
        e.on("drain", this._onDrain.bind(this)).on("packet", this._onPacket.bind(this)).on("error", this._onError.bind(this)).on("close", t => this._onClose("transport close", t))
    }
    onOpen() {
        this.readyState = "open",
...
let He = class extends Me {
    constructor(e, t={}) {
        ...
        (!s.transports || s.transports && typeof s.transports[0] == "string") && (s.transports = (s.transports || ["polling", "websocket", "webtransport"]).map(n => De[n]).filter(n => !!n)),
        super(e, s)
    }
}
;
function Ke(i, e="", t) {
    ...
    typeof i == "string" && (i.charAt(0) === "/" && (i.charAt(1) === "/" ? i = t.protocol + i : i = t.host + i),
    /^(https?|wss?):\/\//.test(i) || (typeof t < "u" ? i = t.protocol + "//" + i : i = "https://" + i),
    s = q(i)),
    s.port || (/^(http|ws)$/.test(s.protocol) ? s.port = "80" : /^(http|ws)s$/.test(s.protocol) && (s.port = "443")),
    s.path = s.path || "/";
    const r = s.host.indexOf(":") !== -1 ? "[" + s.host + "]" : s.host;
    return s.id = s.protocol + "://" + r + ":" + s.port + e,
    s.href = s.protocol + "://" + r + (t && t.port === s.port ? "" : ":" + s.port),
    s
}
const We = typeof ArrayBuffer == "function"
  , $e = i => typeof ArrayBuffer.isView == "function" ? ArrayBuffer.isView(i) : i.buffer instanceof ArrayBuffer
  , ae = Object.prototype.toString
  , Ye = typeof Blob == "function" || typeof Blob < "u" && ae.call(Blob) === "[object BlobConstructor]"
  , ze = typeof File == "function" || typeof File < "u" && ae.call(File) === "[object FileConstructor]";
function K(i) {
...
function Xe(i, e) {
    return i.data = U(i.data, e),
    delete i.attachments,
    i
}
function U(i, e) {
    if (!i)
...
class Ge {
    ...
    encodeAsString(e) {
        let t = "" + e.type;
        return (e.type === a.BINARY_EVENT || e.type === a.BINARY_ACK) && (t += e.attachments + "-"),
        e.nsp && e.nsp !== "/" && (t += e.nsp + ","),
        e.id != null && (t += e.id),
...
class W extends u {
    ...
    add(e) {
        ...
        if (typeof e == "string") {
            ...
            s || t.type === a.BINARY_ACK ? (t.type = s ? a.EVENT : a.ACK,
...
class ce extends u {
    ...
    emit(e, ...t) {
        ...
        typeof t[t.length - 1] == "function") {
            const f = this.ids++
              , m = t.pop();
            this._registerAckCallback(f, m),
            o.id = f
        }
        const c = (n = (s = this.io.engine) === null || s === void 0 ? void 0 : s.transport) === null || n === void 0 ? void 0 : n.writable
          , h = this.connected && !(!((r = this.io.engine) === null || r === void 0) && r._hasPingExpired());
        return this.flags.volatile && !c || (h ? (this.notifyOutgoingListeners(o),
    ...
    _addToQueue(e) {
        ...
        e.push( (n, ...r) => s !== this._queue[0] ? void 0 : (n !== null ? s.tryCount > this._opts.retries && (this._queue.shift(),
        t && t(n)) : (this._queue.shift(),
        t && t(null, ...r)),
        s.pending = !1,
        this._drainQueue())),
        this._queue.push(s),
...
class F extends u {
    constructor(e, t) {
        ...
        this.randomizationFactor((s = t.randomizationFactor) !== null && s !== void 0 ? s : .5),
        this.backoff = new b({
    ...
    socket(e, t) {
        let s = this.nsps[e];
        return s ? this._autoConnect && !s.active && s.connect() : (s = new ce(this,e,t),
        this.nsps[e] = s),
        s
    }
    _destroy(e) {
        ...
        if (this.backoff.attempts >= this._reconnectionAttempts)
            ...
            const s = this.setTimeoutFn( () => {
                ...
                !e.skipReconnect && e.open(n => {
                    n ? (e._reconnecting = !1,
                    e.reconnect(),
                    this.emitReserved("reconnect_error", n)) : e.onreconnect()
                }
                ))
            }
            , t);
...
function L(i, e) {
    ...
    let h;
    return c ? h = new F(s,e) : (v[n] || (v[n] = new F(s,e)),
    h = v[n]),
