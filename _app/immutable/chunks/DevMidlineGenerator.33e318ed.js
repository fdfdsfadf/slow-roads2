...
var bl = (l, i, e) => i in l ? Sl(l, i, {
    enumerable: !0,
    configurable: !0,
    writable: !0,
    value: e
}) : l[i] = e;
var o = (l, i, e) => (bl(l, typeof i != "symbol" ? i + "" : i, e),
e);
import {b3 as yl, b4 as ia, b5 as Sr, b6 as Dl, b7 as sa, b8 as br, C as st, b9 as yr, ba as Ml, ak as Ll, g as Te, ax as Ut, bb as Gt, bc as rs, m as ns, V as m, o as Rl, O as we, bd as Cl, be as Tl, ap as _s, bf as Il, bg as wt, bh as Dr, aW as et, aP as Fl, bi as ks, ao as $t, aU as ci, h as Rt, bj as _l, B as gt, bk as kl, t as ei, bl as Pl, am as Qe, bm as El, aQ as Nl, bn as Ps, aj as Ol, bo as Bl, bp as Ul, bq as Hl, br as zl, bs as Wl, bt as Mr, bu as Lr, bv as Gl, bw as Vl, bx as jl, by as Zl, k as pt, b2 as aa, bz as Ql, bA as Xl, bB as Yl, bC as To, bD as Io, bE as Fo, bF as _o, bG as Kl, r as Rr, bH as ql, bI as ii, f as K, bJ as Jl, l as U, a as L, aO as Ve, ai as vi, a2 as E, aZ as Cr, a_ as Tr, a$ as Ir, b0 as Fr, L as ka, M as le, I as ee, T as mt, a4 as Me, A as De, d as se, a5 as Ri, a3 as $l, bK as ko, ab as eh, aG as is, D as Po, c as q, E as Z, S as Pa, b as pi, bL as Ea, bM as Na, bN as Eo, bO as Es, aH as No, F as Ye, s as _r, aY as Ci, bP as th, aX as Ti, q as At, i as xs, n as kr, j as We, N as ih, bQ as sh, bR as ah, au as oh, bS as rh, bT as nh, bU as lh, bV as hh, aV as xi, b1 as dh, bW as ch} from "./conifers.3f25b06c.js";
...
function Oo(l, i) {
    ...
    if (i === ia || i === Sr) {
        ...
        if (i === ia)
            ...
            for (let r = 0; r < s; r++)
                r % 2 === 0 ? (a.push(e.getX(r)),
                a.push(e.getX(r + 1)),
                a.push(e.getX(r + 2))) : (a.push(e.getX(r + 2)),
                a.push(e.getX(r + 1)),
                a.push(e.getX(r)));
...
class Oa extends Dl {
    ...
    load(i, e, s, a) {
        const t = this;
        let r;
        this.resourcePath !== "" ? r = this.resourcePath : this.path !== "" ? r = this.path : r = sa.extractUrlBase(i),
    ...
    setKTX2Loader(i) {
        return this.ktx2Loader = i,
        this
    }
    setMeshoptDecoder(i) {
        return this.meshoptDecoder = i,
        this
    }
    register(i) {
        return this.pluginCallbacks.indexOf(i) === -1 && this.pluginCallbacks.push(i),
        this
    }
    unregister(i) {
        return this.pluginCallbacks.indexOf(i) !== -1 && this.pluginCallbacks.splice(this.pluginCallbacks.indexOf(i), 1),
        this
    }
    parse(i, e, s, a) {
        let t;
        ...
        if (t.extensionsUsed)
            for (let x = 0; x < t.extensionsUsed.length; ++x) {
                ...
                case Q.KHR_MESH_QUANTIZATION:
                    ...
                    break;
                default:
                    S.indexOf(w) >= 0 && c[w] === void 0 && console.warn('THREE.GLTFLoader: Unknown extension "' + w + '".')
                }
            }
        f.setExtensions(r),
        f.setPlugins(c),
...
class uh {
    ...
    _markDefs() {
        ...
        for (let s = 0, a = e.length; s < a; s++) {
            const t = e[s];
            t.extensions && t.extensions[this.name] && t.extensions[this.name].light !== void 0 && i._addNodeRef(this.cache, t.extensions[this.name].light)
        }
    }
    _loadLight(i) {
        const e = this.parser
        ...
        case "spot":
            ...
            f.distance = w,
            g.spot = g.spot || {},
            g.spot.innerConeAngle = g.spot.innerConeAngle !== void 0 ? g.spot.innerConeAngle : 0,
            g.spot.outerConeAngle = g.spot.outerConeAngle !== void 0 ? g.spot.outerConeAngle : Math.PI / 4,
    ...
    createNodeAttachment(i) {
        ...
        return c === void 0 ? null : this._loadLight(c).then(function(g) {
...
class fh {
    ...
    extendParams(i, e, s) {
        ...
        if (t) {
            ...
            t.baseColorTexture !== void 0 && a.push(s.assignTexture(i, "map", t.baseColorTexture, Ut))
        }
...
class ph {
    constructor(i) {
        this.parser = i,
        this.name = Q.KHR_MATERIALS_EMISSIVE_STRENGTH
    }
    extendMaterialParams(i, e) {
        ...
        return t !== void 0 && (e.emissiveIntensity = t),
        Promise.resolve()
    }
}
class Ah {
    constructor(i) {
        this.parser = i,
        this.name = Q.KHR_MATERIALS_CLEARCOAT
    }
    getMaterialType(i) {
    ...
    extendMaterialParams(i, e) {
        ...
        if (r.clearcoatFactor !== void 0 && (e.clearcoat = r.clearcoatFactor),
        r.clearcoatTexture !== void 0 && t.push(s.assignTexture(e, "clearcoatMap", r.clearcoatTexture)),
        r.clearcoatRoughnessFactor !== void 0 && (e.clearcoatRoughness = r.clearcoatRoughnessFactor),
        r.clearcoatRoughnessTexture !== void 0 && t.push(s.assignTexture(e, "clearcoatRoughnessMap", r.clearcoatRoughnessTexture)),
        r.clearcoatNormalTexture !== void 0 && (t.push(s.assignTexture(e, "clearcoatNormalMap", r.clearcoatNormalTexture)),
...
class mh {
    constructor(i) {
        this.parser = i,
        this.name = Q.KHR_MATERIALS_IRIDESCENCE
    }
    getMaterialType(i) {
        const s = this.parser.json.materials[i];
        return !s.extensions || !s.extensions[this.name] ? null : Gt
    ...
    extendMaterialParams(i, e) {
        ...
        const t = []
          , r = a.extensions[this.name];
        return r.iridescenceFactor !== void 0 && (e.iridescence = r.iridescenceFactor),
        r.iridescenceTexture !== void 0 && t.push(s.assignTexture(e, "iridescenceMap", r.iridescenceTexture)),
        ...
        r.iridescenceThicknessMinimum !== void 0 && (e.iridescenceThicknessRange[0] = r.iridescenceThicknessMinimum),
        r.iridescenceThicknessMaximum !== void 0 && (e.iridescenceThicknessRange[1] = r.iridescenceThicknessMaximum),
        r.iridescenceThicknessTexture !== void 0 && t.push(s.assignTexture(e, "iridescenceThicknessMap", r.iridescenceThicknessTexture)),
        Promise.all(t)
    }
}
class vh {
    constructor(i) {
        this.parser = i,
        this.name = Q.KHR_MATERIALS_SHEEN
    }
    getMaterialType(i) {
        const s = this.parser.json.materials[i];
        return !s.extensions || !s.extensions[this.name] ? null : Gt
    ...
    extendMaterialParams(i, e) {
        ...
        if (!a.extensions || !a.extensions[this.name])
            return Promise.resolve();
        const t = [];
        e.sheenColor = new st(0,0,0),
        e.sheenRoughness = 0,
        e.sheen = 1;
        const r = a.extensions[this.name];
        return r.sheenColorFactor !== void 0 && e.sheenColor.fromArray(r.sheenColorFactor),
        r.sheenRoughnessFactor !== void 0 && (e.sheenRoughness = r.sheenRoughnessFactor),
        r.sheenColorTexture !== void 0 && t.push(s.assignTexture(e, "sheenColorMap", r.sheenColorTexture, Ut)),
        r.sheenRoughnessTexture !== void 0 && t.push(s.assignTexture(e, "sheenRoughnessMap", r.sheenRoughnessTexture)),
        Promise.all(t)
    }
}
class wh {
    constructor(i) {
        this.parser = i,
        this.name = Q.KHR_MATERIALS_TRANSMISSION
    }
    getMaterialType(i) {
        const s = this.parser.json.materials[i];
        return !s.extensions || !s.extensions[this.name] ? null : Gt
    ...
    extendMaterialParams(i, e) {
        ...
        const t = []
          , r = a.extensions[this.name];
        return r.transmissionFactor !== void 0 && (e.transmission = r.transmissionFactor),
        r.transmissionTexture !== void 0 && t.push(s.assignTexture(e, "transmissionMap", r.transmissionTexture)),
        Promise.all(t)
    }
}
class xh {
    constructor(i) {
        this.parser = i,
        this.name = Q.KHR_MATERIALS_VOLUME
    }
    getMaterialType(i) {
        const s = this.parser.json.materials[i];
        return !s.extensions || !s.extensions[this.name] ? null : Gt
    ...
    extendMaterialParams(i, e) {
        ...
        r.thicknessTexture !== void 0 && t.push(s.assignTexture(e, "thicknessMap", r.thicknessTexture)),
        e.attenuationDistance = r.attenuationDistance || 1 / 0;
        const c = r.attenuationColor || [1, 1, 1];
        return e.attenuationColor = new st(c[0],c[1],c[2]),
        Promise.all(t)
    }
}
class Sh {
    ...
    extendMaterialParams(i, e) {
        ...
        return e.ior = t.ior !== void 0 ? t.ior : 1.5,
        Promise.resolve()
    }
}
class bh {
    constructor(i) {
        this.parser = i,
        this.name = Q.KHR_MATERIALS_SPECULAR
    }
    getMaterialType(i) {
        const s = this.parser.json.materials[i];
        return !s.extensions || !s.extensions[this.name] ? null : Gt
    ...
    extendMaterialParams(i, e) {
        ...
        r.specularTexture !== void 0 && t.push(s.assignTexture(e, "specularIntensityMap", r.specularTexture));
        const c = r.specularColorFactor || [1, 1, 1];
        return e.specularColor = new st(c[0],c[1],c[2]),
        r.specularColorTexture !== void 0 && t.push(s.assignTexture(e, "specularColorMap", r.specularColorTexture, Ut)),
        Promise.all(t)
    }
}
class yh {
    constructor(i) {
        this.parser = i,
        this.name = Q.KHR_MATERIALS_ANISOTROPY
    }
    getMaterialType(i) {
        const s = this.parser.json.materials[i];
        return !s.extensions || !s.extensions[this.name] ? null : Gt
    ...
    extendMaterialParams(i, e) {
        ...
        const t = []
          , r = a.extensions[this.name];
        return r.anisotropyStrength !== void 0 && (e.anisotropy = r.anisotropyStrength),
        r.anisotropyRotation !== void 0 && (e.anisotropyRotation = r.anisotropyRotation),
        r.anisotropyTexture !== void 0 && t.push(s.assignTexture(e, "anisotropyMap", r.anisotropyTexture)),
        Promise.all(t)
    }
}
class Dh {
    constructor(i) {
        this.parser = i,
        this.name = Q.KHR_TEXTURE_BASISU
    }
    loadTexture(i) {
        const e = this.parser
          , s = e.json
...
class Mh {
    ...
    loadTexture(i) {
        const e = this.name
          ...
          , a = s.json
          , t = a.textures[i];
        if (!t.extensions || !t.extensions[e])
            return null;
        ...
        return this.detectSupport().then(function(f) {
            if (f)
                return s.loadTextureImage(i, r.source, g);
...
class Rh {
    constructor(i) {
        this.name = Q.EXT_MESHOPT_COMPRESSION,
        this.parser = i
    }
    loadBufferView(i) {
        ...
        if (s.extensions && s.extensions[this.name]) {
            ...
            return t.then(function(c) {
                ...
                return r.decodeGltfBufferAsync ? r.decodeGltfBufferAsync(x, w, S, a.mode, a.filter).then(function(D) {
                    return D.buffer
                }) : r.ready.then(function() {
                    const D = new ArrayBuffer(x * w);
                    return r.decodeGltfBuffer(new Uint8Array(D), x, w, S, a.mode, a.filter),
                    D
                })
            })
        } else
...
class Ch {
    constructor(i) {
        this.name = Q.EXT_MESH_GPU_INSTANCING,
        this.parser = i
    }
    createNodeMesh(i) {
        const e = this.parser.json
        ...
        for (const f of a.primitives)
            if (f.mode !== Xe.TRIANGLES && f.mode !== Xe.TRIANGLE_STRIP && f.mode !== Xe.TRIANGLE_FAN && f.mode !== void 0)
                return null;
        const r = s.extensions[this.name].attributes
          , c = []
          , g = {};
        for (const f in r)
            c.push(this.parser.getDependency("accessor", r[f]).then(x => (g[f] = x,
            g[f])));
        return c.length < 1 ? null : (c.push(this.parser.createNodeMesh(i)),
        Promise.all(c).then(f => {
            ...
            for (const C of w) {
                ...
                for (const z in g)
                    z !== "TRANSLATION" && z !== "ROTATION" && z !== "SCALE" && C.geometry.setAttribute(z, g[z]);
                we.prototype.copy.call(O, C),
                this.parser.assignFinalMaterial(O),
                D.push(O)
            }
            return x.isGroup ? (x.clear(),
            x.add(...D),
            x) : D[0]
        }
        ))
    ...
    decodePrimitive(i, e) {
        ...
        return e.getDependency("bufferView", t).then(function(x) {
            return new Promise(function(w) {
                a.decodeDracoFile(x, function(S) {
...
class Fh {
    ...
    extendTexture(i, e) {
        return (e.texCoord === void 0 || e.texCoord === i.channel) && e.offset === void 0 && e.rotation === void 0 && e.scale === void 0 || (i = i.clone(),
...
class Ph extends Er {
    interpolate_(i, e, s, a) {
        ...
        return kh.fromArray(t).normalize().toArray(t),
        t
    }
}
const Xe = {
...
function Nh(l) {
    return l.DefaultMaterial === void 0 && (l.DefaultMaterial = new ci({
        color: 16777215,
        emissive: 0,
        metalness: 1,
        roughness: 1,
...
function jt(l, i, e) {
    for (const s in e.extensions)
        l[s] === void 0 && (i.userData.gltfExtensions = i.userData.gltfExtensions || {},
...
function Oh(l, i, e) {
    ...
    for (let f = 0, x = i.length; f < x; f++) {
        const w = i[f];
        if (s) {
            const S = w.POSITION !== void 0 ? e.getDependency("accessor", w.POSITION) : l.attributes.position;
            r.push(S)
        }
        if (a) {
            const S = w.NORMAL !== void 0 ? e.getDependency("accessor", w.NORMAL) : l.attributes.normal;
            c.push(S)
        }
        if (t) {
            const S = w.COLOR_0 !== void 0 ? e.getDependency("accessor", w.COLOR_0) : l.attributes.color;
            g.push(S)
        }
    }
    return Promise.all([Promise.all(r), Promise.all(c), Promise.all(g)]).then(function(f) {
        const x = f[0]
          , w = f[1]
          , S = f[2];
        return s && (l.morphAttributes.position = x),
...
function Uh(l) {
    ...
    if (e ? i = "draco:" + e.bufferView + ":" + e.indices + ":" + Bs(e.attributes) : i = l.indices + ":" + Bs(l.attributes) + ":" + l.mode,
    l.targets !== void 0)
...
class Wh {
    constructor(i={}, e={}) {
        ...
        typeof createImageBitmap > "u" || s || a && t < 98 ? this.textureLoader = new Cl(this.options.manager) : this.textureLoader = new Tl(this.options.manager),
    ...
    parse(i, e) {
        ...
        Promise.all(this._invokeAll(function(r) {
            ...
            jt(t, c, a),
            Nt(c, a),
            Promise.all(s._invokeAll(function(g) {
    ...
    _markDefs() {
        ...
        for (let a = 0, t = i.length; a < t; a++) {
            const r = i[a];
            r.mesh !== void 0 && (this._addNodeRef(this.meshCache, r.mesh),
            r.skin !== void 0 && (s[r.mesh].isSkinnedMesh = !0)),
            r.camera !== void 0 && this._addNodeRef(this.cameraCache, r.camera)
        }
    }
    _addNodeRef(i, e) {
        e !== void 0 && (i.refs[e] === void 0 && (i.refs[e] = i.uses[e] = 0),
        i.refs[e]++)
    }
    _getNodeRef(i, e, s) {
        if (i.refs[e] <= 1)
        ...
        const a = s.clone()
          , t = (r, c) => {
            ...
            for (const [f,x] of r.children.entries())
                t(x, c.children[f])
        }
        ;
        return t(s, a),
        a.name += "_instance_" + i.uses[e]++,
        a
    }
    _invokeOne(i) {
    ...
    getDependency(i, e) {
        ...
        if (!a) {
            ...
            case "camera":
                ...
                break;
            default:
                if (a = this._invokeOne(function(t) {
    ...
    getDependencies(i) {
        ...
        if (!e) {
            ...
            e = Promise.all(a.map(function(t, r) {
    ...
    loadAccessor(i) {
        ...
        const t = [];
        return a.bufferView !== void 0 ? t.push(this.getDependency("bufferView", a.bufferView)) : t.push(null),
        a.sparse !== void 0 && (t.push(this.getDependency("bufferView", a.sparse.indices.bufferView)),
        ...
        Promise.all(t).then(function(r) {
            const c = r[0]
              ...
              , w = x * g
              , S = a.byteOffset || 0
              , D = a.bufferView !== void 0 ? s.bufferViews[a.bufferView].byteStride : void 0
              , C = a.normalized === !0;
            let k, T;
            if (D && D !== w) {
                const P = Math.floor(S / D)
                  , B = "InterleavedBuffer:" + a.bufferView + ":" + a.componentType + ":" + P + ":" + a.count;
                let O = e.cache.get(B);
                O || (k = new f(c,P * D,a.count * D / x),
                O = new Il(k,D / x),
                e.cache.add(B, O)),
                T = new Yl(O,g,S % D / x,C)
            } else
                c === null ? k = new f(a.count * g) : k = new f(c,S,a.count * g),
                T = new _s(k,g,C);
            if (a.sparse !== void 0) {
                const P = Ns.SCALAR
    ...
    loadTextureImage(i, e, s) {
        ...
        const f = this.loadImageSource(e, s).then(function(x) {
            x.flipY = !1,
            x.name = r.name || c.name || "",
            x.name === "" && typeof c.uri == "string" && c.uri.startsWith("data:image/") === !1 && (x.name = c.uri);
            const S = (t.samplers || {})[r.sampler] || {};
            return x.magFilter = Uo[S.magFilter] || wt,
            x.minFilter = Uo[S.minFilter] || Dr,
            x.wrapS = Ho[S.wrapS] || et,
            x.wrapT = Ho[S.wrapT] || et,
            a.associations.set(x, {
                textures: i
            }),
            x
        }).catch(function() {
    ...
    loadImageSource(i, e) {
        ...
        const x = Promise.resolve(g).then(function(w) {
            ...
            return f === !0 && c.revokeObjectURL(g),
            w.userData.mimeType = r.mimeType || Hh(r.uri),
            w
        }).catch(function(w) {
            throw console.error("THREE.GLTFLoader: Couldn't load texture", g),
            w
        });
        return this.sourceCache[i] = x,
        x
    }
    assignTexture(i, e, s, a) {
        ...
        return this.getDependency("texture", s.index).then(function(r) {
            if (!r)
                return null;
            if (s.texCoord !== void 0 && s.texCoord > 0 && (r = r.clone(),
            r.channel = s.texCoord),
            t.extensions[Q.KHR_TEXTURE_TRANSFORM]) {
                const c = s.extensions !== void 0 ? s.extensions[Q.KHR_TEXTURE_TRANSFORM] : void 0;
                if (c) {
            ...
            return a !== void 0 && (r.colorSpace = a),
            i[e] = r,
            r
        })
    }
    assignFinalMaterial(i) {
        ...
        if (a || t || r) {
            ...
            t && (g.vertexColors = !0),
            r && (g.flatShading = !0),
            a && (g.normalScale && (g.normalScale.y *= -1),
    ...
    loadMaterial(i) {
        ...
        if (g[Q.KHR_MATERIALS_UNLIT]) {
            ...
            r = w.getMaterialType(),
            f.push(w.extendParams(c, t, e))
        } else {
            const w = t.pbrMetallicRoughness || {};
            if (c.color = new st(1,1,1),
            c.opacity = 1,
            ...
            w.baseColorTexture !== void 0 && f.push(e.assignTexture(c, "map", w.baseColorTexture, Ut)),
            c.metalness = w.metallicFactor !== void 0 ? w.metallicFactor : 1,
            c.roughness = w.roughnessFactor !== void 0 ? w.roughnessFactor : 1,
            w.metallicRoughnessTexture !== void 0 && (f.push(e.assignTexture(c, "metalnessMap", w.metallicRoughnessTexture)),
            ...
            f.push(Promise.all(this._invokeAll(function(S) {
                return S.extendMaterialParams && S.extendMaterialParams(i, c)
            })))
        }
        t.doubleSided === !0 && (c.side = Rt);
        const x = t.alphaMode || Os.OPAQUE;
        if (x === Os.BLEND ? (c.transparent = !0,
        c.depthWrite = !1) : (c.transparent = !1,
        x === Os.MASK && (c.alphaTest = t.alphaCutoff !== void 0 ? t.alphaCutoff : .5)),
        t.normalTexture !== void 0 && r !== Te && (f.push(e.assignTexture(c, "normalMap", t.normalTexture)),
        c.normalScale = new rs(1,1),
        t.normalTexture.scale !== void 0)) {
            const w = t.normalTexture.scale;
            c.normalScale.set(w, w)
        }
        return t.occlusionTexture !== void 0 && r !== Te && (f.push(e.assignTexture(c, "aoMap", t.occlusionTexture)),
        t.occlusionTexture.strength !== void 0 && (c.aoMapIntensity = t.occlusionTexture.strength)),
        t.emissiveFactor !== void 0 && r !== Te && (c.emissive = new st().fromArray(t.emissiveFactor)),
        t.emissiveTexture !== void 0 && r !== Te && f.push(e.assignTexture(c, "emissiveMap", t.emissiveTexture, Ut)),
        Promise.all(f).then(function() {
            const w = new r(c);
            return t.name && (w.name = t.name),
            Nt(w, t),
            e.associations.set(w, {
                materials: i
            }),
    ...
    loadGeometries(i) {
        ...
        function t(c) {
            return s[Q.KHR_DRACO_MESH_COMPRESSION].decodePrimitive(c, e).then(function(g) {
                return zo(g, c, e)
            })
        }
        const r = [];
        for (let c = 0, g = i.length; c < g; c++) {
            ...
            if (w)
                ...
                let S;
                f.extensions && f.extensions[Q.KHR_DRACO_MESH_COMPRESSION] ? S = t(f) : S = zo(new gt, f, e),
                a[x] = {
                    primitive: f,
                    promise: S
                },
    ...
    loadMesh(i) {
        ...
        for (let g = 0, f = r.length; g < f; g++) {
            const x = r[g].material === void 0 ? Nh(this.cache) : this.getDependency("material", r[g].material);
            c.push(x)
        }
        return c.push(e.loadGeometries(r)),
        Promise.all(c).then(function(g) {
            ...
            for (let D = 0, C = x.length; D < C; D++) {
                ...
                let P;
                const B = f[D];
                if (T.mode === Xe.TRIANGLES || T.mode === Xe.TRIANGLE_STRIP || T.mode === Xe.TRIANGLE_FAN || T.mode === void 0)
                    P = t.isSkinnedMesh === !0 ? new kl(k,B) : new ei(k,B),
                    P.isSkinnedMesh === !0 && P.normalizeSkinWeights(),
                    T.mode === Xe.TRIANGLE_STRIP ? P.geometry = Oo(P.geometry, Sr) : T.mode === Xe.TRIANGLE_FAN && (P.geometry = Oo(P.geometry, ia));
                else if (T.mode === Xe.LINES)
                    P = new Pl(k,B);
                else if (T.mode === Xe.LINE_STRIP)
                    P = new Qe(k,B);
                else if (T.mode === Xe.LINE_LOOP)
                    P = new El(k,B);
                else if (T.mode === Xe.POINTS)
                    P = new Nl(k,B);
                else
            ...
            for (let D = 0, C = w.length; D < C; D++)
                e.associations.set(w[D], {
                    meshes: i,
                    primitives: D
                });
            if (w.length === 1)
                return t.extensions && jt(a, w[0], t),
                w[0];
            const S = new Ps;
            t.extensions && jt(a, S, t),
            e.associations.set(S, {
                meshes: i
            });
            for (let D = 0, C = w.length; D < C; D++)
                S.add(w[D]);
    ...
    loadCamera(i) {
        ...
        return s.type === "perspective" ? e = new Ol(Bl.radToDeg(a.yfov),a.aspectRatio || 1,a.znear || 1,a.zfar || 2e6) : s.type === "orthographic" && (e = new Ul(-a.xmag,a.xmag,a.ymag,-a.ymag,a.znear,a.zfar)),
    ...
    loadSkin(i) {
        ...
        return e.inverseBindMatrices !== void 0 ? s.push(this.getDependency("accessor", e.inverseBindMatrices)) : s.push(null),
        Promise.all(s).then(function(a) {
            ...
            for (let f = 0, x = r.length; f < x; f++) {
                ...
                if (w) {
                    c.push(w);
                    const S = new ns;
                    t !== null && S.fromArray(t.array, f * 16),
                    g.push(S)
                } else
                    console.warn('THREE.GLTFLoader: Joint "%s" could not be found.', e.joints[f])
            }
            return new Hl(c,g)
        })
    }
    loadAnimation(i) {
        ...
        for (let w = 0, S = a.channels.length; w < S; w++) {
            ...
            k.node !== void 0 && (r.push(this.getDependency("node", T)),
            c.push(this.getDependency("accessor", P)),
            g.push(this.getDependency("accessor", B)),
            f.push(C),
            x.push(k))
        }
        return Promise.all([Promise.all(r), Promise.all(c), Promise.all(g), Promise.all(f), Promise.all(x)]).then(function(w) {
            const S = w[0]
              , D = w[1]
              , C = w[2]
              , k = w[3]
    ...
    createNodeMesh(i) {
        const e = this.json
          , s = this
          , a = e.nodes[i];
        return a.mesh === void 0 ? null : s.getDependency("mesh", a.mesh).then(function(t) {
            const r = s._getNodeRef(s.meshCache, a.mesh, t);
            return a.weights !== void 0 && r.traverse(function(c) {
                if (c.isMesh)
    ...
    loadNode(i) {
        ...
        const g = a.skin === void 0 ? Promise.resolve(null) : s.getDependency("skin", a.skin);
        return Promise.all([t, Promise.all(r), g]).then(function(f) {
            const x = f[0]
              , w = f[1]
              , S = f[2];
            S !== null && x.traverse(function(D) {
    ...
    _loadNodeShallow(i) {
        ...
        return g && c.push(g),
        t.camera !== void 0 && c.push(a.getDependency("camera", t.camera).then(function(f) {
            return a._getNodeRef(a.cameraCache, t.camera, f)
        })),
        a._invokeAll(function(f) {
        ...
        this.nodeCache[i] = Promise.all(c).then(function(f) {
            let x;
            if (t.isBone === !0 ? x = new Wl : f.length > 1 ? x = new Ps : f.length === 1 ? x = f[0] : x = new we,
            x !== f[0])
                for (let w = 0, S = f.length; w < S; w++)
                    x.add(f[w]);
            if (t.name && (x.userData.name = t.name,
            x.name = r),
            Nt(x, t),
            t.extensions && jt(s, x, t),
            t.matrix !== void 0) {
                const w = new ns;
                w.fromArray(t.matrix),
                x.applyMatrix4(w)
            } else
            ...
            return a.associations.has(x) || a.associations.set(x, {}),
    ...
    _createAnimationTracks(i, e, s, a, t) {
        const r = []
          ...
          , g = [];
        Ct[t.path] === Ct.weights ? i.traverse(function(S) {
        ...
        for (let S = 0, D = g.length; S < D; S++) {
            ...
            a.interpolation === "CUBICSPLINE" && this._createCubicSplineTrackInterpolant(C),
            r.push(C)
        }
        return r
    }
...
function Gh(l, i, e) {
    ...
    if (s.POSITION !== void 0) {
        ...
        if (g !== void 0 && f !== void 0) {
            if (a.set(new m(g[0],g[1],g[2]), new m(f[0],f[1],f[2])),
            c.normalized) {
                const x = ra(gi[c.componentType]);
                a.min.multiplyScalar(x),
                a.max.multiplyScalar(x)
            }
        } else {
        ...
        for (let f = 0, x = t.length; f < x; f++) {
            ...
            if (w.POSITION !== void 0) {
                ...
                if (D !== void 0 && C !== void 0) {
                    if (g.setX(Math.max(Math.abs(D[0]), Math.abs(C[0]))),
...
class $h {
    constructor() {
        ...
        o(this, "redlight", new ci({
            color: 6702148,
            emissive: 16711680,
            roughness: .5,
            emissiveIntensity: 0
        }));
        o(this, "rearlight", new ci({
            color: 6702148,
            emissive: 16711680,
            roughness: .5,
            emissiveIntensity: 0
        }));
        o(this, "reverselight", new ci({
            color: 6710852,
            emissive: 16777096
        }));
        o(this, "headlight", new ci({
            color: 6710886,
            emissive: 16777181
        }));
        o(this, "window", new ii({
            color: 6712183,
            specular: 8961023,
            shininess: 30
        }));
        o(this, "windscreen", new K({
            color: 5596791,
            transparent: !0,
            opacity: 1
        }));
        o(this, "shadow", new Te({
            color: 0,
            colorWrite: !1,
            depthWrite: !1,
            side: Jl
    ...
    setBrakeLights(i, e=!1) {
        this.brakesOn = i,
        i ? e ? this.redlight.emissiveIntensity = Math.max(.2, .2 + L.softBrakeForce ** 2 - .3) : this.redlight.emissiveIntensity = .9 : this.redlight.emissiveIntensity = 0
    }
    getMaterialByName(i) {
        let e = this.default
          , s = i.split("_")[1];
    ...
    setOnObject(i) {
        i.traverse(e => {
            e.isMesh && (e.material = this.getMaterialByName(e.name),
...
const W = new $h
  ...
  , Hp = (l, i, e) => {
    ...
    u.checkInterval = 10; u.checkInterval > 0; u.checkInterval -= 9) {
        for (u.checkMargin = u.checkInterval == 10 ? 1.9 : 1.2,
        u.closestFwdNode = u.closestNode,
        u.closestRearNode = u.closestNode,
        u.lastChance = !1,
        u.checkCount = 0,
        u.checkNode = u.closestFwdNode; !(u.checkCount >= 10 || u.checkNode.i + u.checkInterval > v.tail.i); ) {
            if (u.checkInterval > 1 ? u.checkNode = u.checkNode.next.next.next.next.next.next.next.next.next.next : u.checkNode = u.checkNode.next,
            u.dist = (u.checkNode.p.x - l) * (u.checkNode.p.x - l) + (u.checkNode.p.z - i) * (u.checkNode.p.z - i),
            u.dist < u.closestDist)
                u.lastChance = !1,
                u.closestDist = u.dist,
                u.closestFwdDist = u.closestDist,
                u.closestFwdNode = u.checkNode;
            else if (u.dist < u.closestDist * u.checkMargin)
                u.lastChance = !1;
            else if (!u.lastChance)
                u.lastChance = !0;
            else
                break;
            u.checkCount++
        }
        for (u.checkNode = u.closestRearNode,
        u.lastChance = !1,
        u.checkCount = 0; !(u.checkCount >= 10 || u.checkNode.i - u.checkInterval < v.head.i); ) {
            if (u.checkInterval > 1 ? u.checkNode = u.checkNode.prev.prev.prev.prev.prev.prev.prev.prev.prev.prev : u.checkNode = u.checkNode.prev,
            u.dist = (u.checkNode.p.x - l) * (u.checkNode.p.x - l) + (u.checkNode.p.z - i) * (u.checkNode.p.z - i),
            u.dist < u.closestDist)
                u.lastChance = !1,
                u.closestDist = u.dist,
        ...
        u.closestFwdDist < u.closestRearDist ? u.closestNode = u.closestFwdNode : u.closestNode = u.closestRearNode
    }
    return {
        n: u.closestNode,
        d2: u.closestDist
  ...
  , Wo = (l, i, e) => {
    ...
    u.n0 = e,
    u.fine = !1; u.n; )
        if (u.t = u.n.n.x * (i - u.n.p.z) - u.n.n.z * (l - u.n.p.x),
        u.t < 0 && u.n.nextFine)
            if (u.fine) {
                if (u.t1 = u.n.nextFine.n.x * (i - u.n.nextFine.p.z) - u.n.nextFine.n.z * (l - u.n.nextFine.p.x),
                u.t1 > 0)
                    break;
                u.n = u.n.nextFine
            } else {
                if (u.t1 = u.n.next.n.x * (i - u.n.next.p.z) - u.n.next.n.z * (l - u.n.next.p.x),
                u.t1 > 0) {
                    u.n0 = u.n,
                    u.fine = !0;
                    continue
            ...
            if (u.fine)
                ...
                if (u.t1 = u.n.prev.n.x * (i - u.n.prev.p.z) - u.n.prev.n.z * (l - u.n.prev.p.x),
                u.t1 < 0) {
                    u.n0 = u.n.prev,
                    u.fine = !0;
                    continue
    ...
    u.t0 = ((l - u.x1) * (u.x2 - u.x1) + (i - u.z1) * (u.z2 - u.z1)) / u.len,
    ...
    u.n.nextFine)
        ...
        if (Math.floor(Math.sqrt((u.n.p.x - l) ** 2 + (u.n.p.z - i) ** 2)) < 100)
            throw new Error("Midline failed to generate beyond tail " + v.tail.i + " with vehicle/head " + v.vehicleIndex + "/" + v.head.i);
        if (!u.nf)
            return u.x1 = u.x1 - l,
            u.z1 = u.z1 - i,
            {
    ...
    return u.x2 = u.nf.p.x,
    u.z2 = u.nf.p.z,
    u.len = (u.x2 - u.x1) * (u.x2 - u.x1) + (u.z2 - u.z1) * (u.z2 - u.z1),
    u.t1 = ((l - u.x1) * (u.x2 - u.x1) + (i - u.z1) * (u.z2 - u.z1)) / u.len,
    ...
    for (u.n = e; u.n; )
        ...
        u.t < 0 && u.n.next) {
            ...
            u.t1 > 0)
                break;
            u.n = u.n.next
        } else if (u.t > 0 && u.n.prev)
            u.n = u.n.prev;
        else
            break;
    return (s = u.n) != null && s.next || (u.n = e.prev.prev),
    u.x1 = u.n.p.x,
    u.z1 = u.n.p.z,
    u.x2 = u.n.next.p.x,
    u.z2 = u.n.next.p.z,
...
const ce = new ed
  ...
  , Gp = () => {
    ...
    V.set("speedControlTarget", Math.max(Math.min(n.tuning.topSpeed * 3.6, l + 5 / vi[L.units]), 5))
}
  , Vp = () => {
    let l = V.speedControlTarget;
    V.set("speedControlTarget", Math.max(Math.min(n.tuning.topSpeed * 3.6, l - 5 / vi[L.units]), 5))
  ...
  , V = new Ve("Vehicle",id, (l, i) => !(l == "type" && n.isLoading), (l, i) => i)
  , sd = {
    type: {
  ...
  , ye = new Ve("Keys",bt, (l, i) => l == "mapping" ? !0 : l in at.settings ? at.settings[l].type == E.Range ? Cr(i, at.settings[l].min, at.settings[l].max) : at.settings[l].type == E.Enum ? Tr(i, at.settings[l].labels.length) : !0 : !1, (l, i) => l == "mapping" ? i : l in at.settings ? at.settings[l].type == E.Range ? Ir(i, at.settings[l].precision) : at.settings[l].enum == E.Enum ? Fr(i) : i : null);
ye.updateMapping = () => {
    ye.set("mapping", {
        ...Za,
        ...ye.mapping
  ...
  , ot = {
    settings: {
        directSteer: {
            ...
            overrides: ["steerSmoothing", "steerRange", "speedSteerFactor", "linearity", "deadzone"]
        },
        autoBoost: {
...
class ud {
    constructor() {
        ...
        o(this, "gamepadHeld", {});
        o(this, "deadzoneMin", .05);
        o(this, "deadzoneFactor", 1.05);
        o(this, "gamepadLocked", !1);
        o(this, "updateDeadzoneBound", this.updateDeadzone.bind(this));
        o(this, "updateKeySteerSmootherBound", this.updateKeySteerSmoother.bind(this));
        o(this, "updateMouseSteerSmootherBound", this.updateMouseSteerSmoother.bind(this));
        o(this, "onToggleUseMouseBound", this.onToggleUseMouse.bind(this));
        o(this, "updateGamepadSteerSmootherBound", this.updateGamepadSteerSmoother.bind(this));
        o(this, "mouseReset", !1);
        o(this, "mouseToggles", []);
        ...
        this.keyAccelSmoother = new bi(.5),
        this.keyBrakeSmoother = new bi(.5),
        this.mouseSteerSmoother = new bi,
        this.gamepadSteerSmoother = new bi,
        od.subscribe(this.onScreenInputEnabled.bind(this))
    }
    updateDeadzone() {
        te.directSteer ? this.deadzoneMin = 0 : this.deadzoneMin = te.deadzone / 100,
    ...
    onScreenInputEnabled(i) {
        if (this.hasScreenInput = i,
        this.hasScreenSteer = !1,
        this.hasScreenAccel = !1,
        i)
            this.screenInput.listeners.push(rd.subscribe(e => this.screenInput.accel = e)),
            this.screenInput.listeners.push(nd.subscribe(e => this.screenInput.brake = e)),
            this.screenInput.listeners.push(dd.subscribe(e => this.screenInput.boost = e)),
            this.screenInput.listeners.push(ld.subscribe(e => this.screenInput.steer = e)),
            this.screenInput.listeners.push(hd.subscribe(e => this.screenInput.reset = e));
        else
    ...
    lockMouse() {
        ...
        le.useMouse && (this.gamepadSignal.Left = 0,
    ...
    updateKeySteerSmoother() {
        this.keySteerSmoother.type != ye.softSteer && (ye.softSteer ? this.keySteerSmoother = new Zo : this.keySteerSmoother = new bi),
    ...
    update(i) {
        ...
        !le.useMouse && this.hasGamepadInput)
            ...
            this.signal.Forward = Math.min(1, this.signal.Forward + this.gamepadSignal.Forward),
            this.signal.Backward = Math.min(1, this.signal.Backward + this.gamepadSignal.Backward),
            this.signal.Boost = Math.min(1, this.signal.Boost + this.gamepadSignal.Boost),
            this.signal.CameraLeft = Math.min(1, this.signal.CameraLeft + this.gamepadSignal.CameraLeft),
            this.signal.CameraRight = Math.min(1, this.signal.CameraRight + this.gamepadSignal.CameraRight),
            this.signal.CameraUp = Math.min(1, this.signal.CameraUp + this.gamepadSignal.CameraUp),
            this.signal.CameraDown = Math.min(1, this.signal.CameraDown + this.gamepadSignal.CameraDown);
        else {
            if (this.signal.Forward == 0 && n.speed < 5 && (this.gamepadCheckTimer -= i,
            this.gamepadCheckTimer <= 0 && (this.gamepadCheckTimer = 1,
            ...
            le.useMouse && (this.updateMouse(i),
            this.signal.Forward = Math.min(1, this.signal.Forward + this.gamepadSignal.Forward),
            this.signal.Backward = Math.min(1, this.signal.Backward + this.gamepadSignal.Backward))
        }
        this.signal.ToggleHandbrake ? (this.toggled.Handbrake = !this.toggled.Handbrake,
        this.on("ToggleHandbrake", this.toggled.Handbrake)) : this.toggled.Handbrake && this.signal.Handbrake && (this.toggled.Handbrake = !1,
        this.on("ToggleHandbrake", !1)),
        this.signal.Handbrake = this.toggled.Handbrake || this.signal.Handbrake > 0 ? 1 : 0,
        this.filtered.steer = Math.min(Math.max(-1, this.smooth.keySteer + this.smooth.mouseSteer + this.smooth.gamepadSteer), 1)
    }
    updateKeys(i) {
        if (He = ye.mapping,
        this.signal.Forward = 0,
        ee.key[He.Forward] || ee.key.ArrowUp ? (this.hasScreenInput && L.set("touchscreen", !1),
        !this.keyState.hasAccel && ye.doubleTapBoost && (!this.keyState.hasAccel && mt.appTime - this.keyState.lastAccel < .2 && (ye.toggleBoost ? (this.toggled.Boost = !this.toggled.Boost,
        this.keyState.boostFromTap = this.toggled.Boost) : this.keyState.boostFromTap = !0),
        this.keyState.lastAccel = mt.appTime),
        this.signal.Forward = 1,
        this.signal.Forward *= ye.accelFactor,
        this.keyState.hasAccel = !0) : (this.keyState.hasAccel = !1,
        this.keyState.boostFromTap = !1),
        this.signal.Backward = 0,
        (ee.key[He.Backward] || ee.key.ArrowDown) && (this.signal.Backward = 1,
        this.signal.Backward *= Math.max(.8, ye.accelFactor)),
        ye.lockedSteerMode == 0 ? (this.signal.StickySteer = ee.key[He.StickySteer] ? 1 : 0,
        this.toggled.StickySteer = !1) : this.checkToggleKey("StickySteer", !1),
        this.signal.Left = 0,
        ...
        this.signal.StickySteer) {
            ...
            e && (this.smooth.keySteer = this.keySteerSmoother.update(e, i * ye.lockedSteerSpeed * ye.lockedSteerSpeed))
        } else
            this.smooth.keySteer = this.keySteerSmoother.update(this.signal.Left - this.signal.Right, i);
        ...
        this.keyState.boostFromTap ? this.signal.Boost = 1 : ye.toggleBoost ? (this.checkDebouncedKey("Boost", !1),
        this.signal.Boost && (this.toggled.Boost = !this.toggled.Boost,
        this.keyState.boostFromTap = !1),
        this.signal.Boost = this.toggled.Boost) : this.signal.Boost = ee.key[He.Boost] ? 1 : 0,
    ...
    updateScreen(i) {
        this.keyState.hasAccel || (this.screenInput.accel < 0 ? this.signal.Backward = -this.screenInput.accel : this.signal.Forward = this.screenInput.accel),
        this.signal.Left = Math.min(0, Math.min(-this.signal.Left, this.screenInput.steer)) * -1,
        this.signal.Right = Math.max(0, Math.max(this.signal.Right, this.screenInput.steer)),
        ...
        this.signal.Boost && (this.signal.Forward = Math.min(1, .5 + this.signal.Forward)),
        this.screenInput.brake > 0 && (n.direction > 0 ? (this.signal.Backward = Math.min(Math.max(.5, n.speed / n.tuning.topSpeed * 2), 1),
        this.signal.Forward = 0) : (this.signal.Forward = Math.min(Math.max(.5, n.speed / n.tuning.topSpeed * 2), 1),
        this.signal.Backward = 0)),
        this.screenInput.reset && (this.screenInput.reset = 0,
        this.signal.Reset = 1)
    }
    resetByMouse() {
        this.mouseReset = !0
    ...
    updateMouse(i) {
        ...
        if (this.mouseLockCounter <= 0)
            for (e in Hi)
                ...
                Hi[e] != null && (s = Hi[e],
                le.clickInputMode == 0 && le.doubleClickBoost && e == "Forward" && !this.mouseHasAccel && ee.mouseDown[s] && mt.appTime - this.mouseLastAccel < le.doubleClickInterval * 1 && (this.mouseHasBoost = !0),
                jo[e] ? ee.mouseClick[s] && (Vo[e] && (this.signal[e] = 1),
                this.on(e, 1)) : le.clickInputMode == 1 ? (ee.mouseClick[s] && (this.gamepadSignal[e] = !this.gamepadSignal[e]),
                e == "Forward" ? this.gamepadSignal[e] *= le.accelFactor : e == "Backward" && (this.gamepadSignal[e] *= Math.max(.8, le.accelFactor)),
                this.signal[e] = this.signal[e] || this.gamepadSignal[e]) : (this.gamepadSignal[e] = ee.mouseDown[s] ? 1 : 0,
                e == "Forward" ? this.gamepadSignal[e] *= le.accelFactor : e == "Backward" && (this.gamepadSignal[e] *= Math.max(.8, le.accelFactor)),
                this.signal[e] = Math.min(1, this.signal[e] + this.gamepadSignal[e])));
        this.gamepadSignal.Forward ? this.mouseHasAccel = !0 : this.mouseHasAccel && (this.mouseHasAccel = !1,
        this.mouseHasBoost = !1,
        this.mouseLastAccel = mt.appTime),
        this.mouseHasBoost && (this.gamepadSignal.Boost = 1,
        this.signal.Boost = 1),
        this.mouseReset && (this.mouseReset = !1,
        this.signal.Reset = 1,
        this.gamepadSignal.Reset = 1),
        ee.mouse.y > window.innerHeight - 200 ? (this.gamepadSignal.Left = 0,
        this.gamepadSignal.Right = 0) : (this.gamepadSignal.Left = Math.min(1, Math.max(0, -(ee.mouseScreen.x / le.steerBarWidth))),
        this.gamepadSignal.Right = Math.min(1, Math.max(0, ee.mouseScreen.x / le.steerBarWidth)));
        let a = this.gamepadSignal.Left - this.gamepadSignal.Right;
        a < 0 ? a = a * le.linearity + a * a * (1 - le.linearity) * -1 : a = a * le.linearity + a * a * (1 - le.linearity),
        le.smoothing > 0 ? this.smooth.mouseSteer = this.mouseSteerSmoother.update(a, i) : this.smooth.mouseSteer = a,
        a != 0 && Ss && !Go.usedMouse && (Go.usedMouse = !0,
        console.log("USED MOUSE"))
    }
    updateGamepad(i) {
        var s;
        if (Us = te.mapping,
        si = (s = navigator.getGamepads) == null ? void 0 : s.call(navigator)[te.controllerIndex],
        !this.gamepadLocked)
            if (si) {
                for (let a in Us)
                    this.getGamepadValue(a);
                this.gamepadSignal.Forward *= 1 - this.gamepadSignal.Backward,
                te.autoBoost && this.gamepadSignal.Boost == 0 && (this.gamepadSignal.Boost = this.gamepadSignal.Forward > .99)
            } else
        ...
        te.directSteer ? this.smooth.gamepadSteer = e : (e *= te.steerRange,
        e < 0 ? e = e * te.linearity + e * e * (1 - te.linearity) * -1 : e = e * te.linearity + e * e * (1 - te.linearity),
        te.steerSmoothing > 0 ? this.smooth.gamepadSteer = this.gamepadSteerSmoother.update(e, i, !0) : this.smooth.gamepadSteer = e)
    }
    checkDebouncedKey(i, e=!0) {
        this.signal[i] = 0,
        ee.key[He[i]] ? this.held[i] || (this.signal[i] = 1,
        this.held[i] = !0,
        e && this.on(i)) : this.held[i] = !1
    }
    ...
    getGamepadValue(i, e=!1) {
        ...
        this.c)
            if (this.c.type == ke.Button && si.buttons[this.c.index] !== void 0)
                ...
                this.v > .5 ? jo[i] && (this.gamepadHeld[i] || (this.gamepadHeld[i] = !0,
                Vo[i] && (this.signal[i] = 1),
                this.on(i, 1))) : this.gamepadHeld[i] = !1,
                this.gamepadSignal[i] = this.v;
            else {
                let s = si.axes[this.c.index] || 0;
                this.c.sign < 0 ? this.c.mode == 2 ? s = 1 - Math.max(0, s) : this.c.mode == 1 ? s = 1 - (s + 1) / 2 : s = -s : this.c.mode == 2 ? s = Math.max(0, -s) : this.c.mode == 1 && (s = (s + 1) / 2),
                s = Math.max(0, Math.min(1, (s - this.deadzoneMin) * this.deadzoneFactor)),
                te.directSteer && i == "Backward" && (s = Math.min(1, s * te.brakeSense)),
    ...
    addListener(i, e) {
        typeof e == "function" && (this.listeners[i].includes(e) || this.listeners[i].push(e))
    }
    removeListener(i, e) {
...
class Zo {
    ...
    update(i, e) {
        return i != 0 && (!this.hasInput || i != this.target) ? (this.hasInput = !0,
        this.origin = this.current,
        this.target = i,
        this.interval = Math.min(1, Math.abs(this.current - this.target)) * this.baseInterval,
        Math.sign(i) !== Math.sign(this.current) && (this.interval *= 1 / Math.abs(i - this.current)),
        this.timer = 0,
        this.timeLerp = 0) : this.hasInput && i == 0 && (this.timer = 0,
        this.hasInput = !1,
        this.origin = this.current,
        this.target = 0,
        this.interval = Math.abs(this.current - this.target) * this.baseInterval,
        this.timeLerp = 0),
        this.hasInput ? e *= this.sensitivity : e *= this.recenterSensitivity,
        e *= .75,
        this.timeLerp < 1 && (this.timer += e,
        ...
        this.current = this.origin * this.lerp + this.target * (1 - this.lerp)),
        this.current
    }
    smoothLerp(i) {
        return i = Math.min(1, i),
        -1 * (3 - i * 2) * i * i + 1
    }
}
class bi {
    ...
    update(i, e) {
        return this.dir = i < 0 ? -1 : 1,
        this.temper = 1 - Math.abs(this.current),
        (this.dir < 0 && this.current > 0 || this.dir > 0 && this.current < 0) && (this.temper = 1),
        i == 0 ? (this.interval = this.baseInterval,
        this.temper = 1,
        e *= this.recenterSensitivity) : (e *= this.sensitivity * .4,
        this.interval = this.baseInterval),
        this.temper == 0 ? this.a = 0 : this.a = Math.min(1, e * 6 / this.interval) * this.temper,
...
const Ht = {
  ...
  , Ur = "" + new URL("../assets/roll_tarmac_01.946ae363.mp3",import.meta.url).href
  , Hr = "" + new URL("../assets/roll_tarmac_int.e8cc8d26.mp3",import.meta.url).href
  , Ei = "" + new URL("../assets/roll_gravel.81af40f4.mp3",import.meta.url).href
  , Ni = "" + new URL("../assets/roll_gravel_int.c7b362d0.mp3",import.meta.url).href
  , fd = "" + new URL("../assets/roll_ice.e358f630.mp3",import.meta.url).href
  , pd = "" + new URL("../assets/roll_ice_int.66845f3c.mp3",import.meta.url).href
  , zr = "" + new URL("../assets/skid_tarmac.2e809198.mp3",import.meta.url).href
  , Wr = "" + new URL("../assets/skid_tarmac_int.98007200.mp3",import.meta.url).href
  , Gr = "" + new URL("../assets/skid_wet.b41804bd.mp3",import.meta.url).href
  , Vr = "" + new URL("../assets/skid_wet_int.2f3a8990.mp3",import.meta.url).href
  ...
  , qr = "" + new URL("../assets/scrape_metal.417cfe49.mp3",import.meta.url).href
  , Jr = "" + new URL("../assets/scrape_metal_int.76a3645c.mp3",import.meta.url).href
  , Hs = {
    engine: Qo,
    boost: Qo,
    brake: Or,
...
class Xa {
    ...
    updateEngine(i, e) {
        ...
        if (this.vc.powerLerp * .8,
        e.accel < 0 && n.direction > 0,
        this.accelPower = .4 + Math.abs(e.accel) / (this.vc.tuning.speedFactor * this.vc.tuning.accel) * .6,
        n.hasBoost && e.accel != 0 ? this.boostV = this.boostV * .9 + .1 : this.boostV *= .95,
        this.boostA = this.boostV * (1 - this.vc.speedLerp * .5),
        this.speedTarget = Math.min(n.speed, this.vc.tuning.topSpeed + 10) / 15 + 1,
        this.lerpTarget = this.lerpTarget * .95 + this.speedTarget * .05,
        e.accel != 0) {
            this.decel && (this.vol += .2,
            this.decel = !1),
            this.vol += i * 2,
            this.vol = Math.min(1, this.vol, this.accelPower),
            this.engineRate = .15 + this.lerpTarget * .5,
            this.engineRate *= this.vc.tuning.engineRateFactor,
            s.setPlaybackRate(this.engineRate + this.boostA * .1),
            this.t1 = (1 - this.smoothstep(this.vol)) * Xo;
            let t = this.t1 * this.interiorVol * Me.engine + this.boostA * .2;
            t *= this.vc.tuning.engineVolFactor,
            s.setVolume(t * (1 - this.vc.speedLerp * .15)),
            a.setPlaybackRate(this.engineRate * this.vc.tuning.engineBoostFactor + this.boostA * .5),
            a.setVolume(t * (.5 - .4 * this.vc.speedLerp + this.boostA * .2))
        } else if (this.vol > 0) {
            this.decel == !1 && (this.lerpTarget -= .05),
            this.decel = !0,
            this.vol -= i,
            ...
            let t = this.t1 * this.interiorVol * Me.engine + this.boostA * .2;
            s.setVolume(t * (1 - this.vc.speedLerp * .15)),
            a.setPlaybackRate(this.engineRate * this.vc.tuning.engineBoostFactor + this.boostA * .4),
            a.setVolume(t * (.5 - .3 * this.vc.speedLerp + this.boostA * .2))
        } else
            s.setVolume(0),
            a.setVolume(0)
    }
    updateBoost() {
        this.boostV = 0,
        n.hasAccel && n.hasBoost ? (this.boostA = this.boostA * .5 + .5,
        1 - this.vc.powerLerp,
        this.boostT = .5 + this.vc.powerLerp / 2,
        this.boostR = this.boostA * this.sounds.engine.playbackRate * 1.5,
        this.sounds.boost.setPlaybackRate(this.boostA * this.sounds.engine.playbackRate * 1.5)) : (this.boostT *= .95,
        this.boostA = 0),
        this.boostV = this.boostT * md * this.accelPower * this.interiorVol * Me.engine * (1 - this.vc.speedLerp ** 2 * .65),
    ...
    updateBrakes() {
        ...
        this.brakeT = this.brakeT * .9 + .1 * Math.min(i, Math.max(0, (n.speed - 20) / 20)),
        this.sounds.brake.setPlaybackRate(1),
        this.sounds.brake.setVolumeStoppable(this.brakeT * Ad * this.vc.brakeLerp * this.interiorVol * Me.brakes)
    }
    updateWheels(i, e) {
        let s = Math.max(0, Math.min(1, this.vc.speedLerp - .01)) * wd * Me.roll, a;
        for (let t of e) {
            if (t.i >= this.sounds.wheels.length)
                break;
            a = this.sounds.wheels[t.i],
            this.maxAud = 0;
            let r = .05;
            t.slip > r && (this.maxAud = (Math.abs(t.latDirDot) - r) / (1 - r)),
            t.locked && (this.maxAud = Math.max(this.maxAud, Math.min(1, (Math.abs(t.lonDirDot * t.speed) - 2) / 4))),
            t.shockFactor == 0 && (this.maxAud = 0),
            this.tl = this.tls[t.i],
            this.maxAud > 0 ? this.tl = this.tl * .95 + .05 * this.maxAud : this.tl = this.tl * .8,
            t.shockFactor < .25 && (this.tl *= t.shockFactor * 4),
            this.surfaces[t.i] != t.groundState.s && (a.skid[this.surfaces[t.i]].setVolumeStoppable(0),
            a.roll[this.surfaces[t.i]].setVolumeStoppable(0),
            this.surfaces[t.i] = t.groundState.s),
            a.roll[t.groundState.s].isPlaying || (a.roll[t.groundState.s].play(),
            a.skid[t.groundState.s].play()),
            t.shockFactor == 0 ? a.roll[t.groundState.s].setVolume(.01) : a.roll[t.groundState.s].setVolume(s),
            a.roll[t.groundState.s].setPlaybackRate(.6 + this.vc.speedLerp * .4),
            a.skid[t.groundState.s].setVolume(xd * this.tl * Me.skid),
            this.tls[t.i] = this.tl;
            let c = this.tss[t.i]
              , g = -t.shockVel;
            g < 1.5 ? this.tl = 0 : (g = (g - 1.5) ** 2,
            this.tl = Math.max(Math.min(1, g), c)),
            this.tl > c ? c = this.tl : c = c * .8,
            this.tss[t.i] = c,
            t.i < 2 ? a.sus.setVolume(c * vd * this.interiorVol * Me.roll) : a.sus.setVolume(0)
        }
    }
    updateCollisions() {
        this.vc.didCollide && !this.vc.collisionsDisabled ? this.coll ? (this.sounds.scrape.position.copy(this.vc.collisionPos),
        n.speed > 1 ? this.sounds.scrape.setVolumeStoppable(Math.min(1, this.vc.collisionStrength * 2) * Me.collisions) : this.sounds.scrape.setVolumeStoppable(Math.min(1, this.vc.collisionStrength * 2 * n.speed) * Me.collisions),
        this.sounds.scrape.isPlaying || this.sounds.scrape.play(),
        this.lastScrape = mt.appTime) : (this.coll = !0,
        this.hitSound = this.sounds.hits[this.hitIndex],
        this.hitSound.isPlaying || (this.hitSound.position.copy(this.vc.collisionPos),
        this.hitSound.detune = Math.random() * -1200 + 600,
        this.hitSound.setVolume(Math.min(1, this.vc.collisionStrength * .3) * Me.collisions),
        this.hitSound.play()),
        this.hitIndex = (this.hitIndex + 1) % 2) : this.coll && mt.appTime - this.lastScrape > .1 && (this.coll = !1,
    ...
    init() {
        ...
        for (let e = 0; e < this.positions.wheels.length; e++)
            this.loadWheelSounds(e, this.positions.wheels[e], {
                roll: i.roll,
                skid: i.skid,
                sus: i.suspension
    ...
    loadSound(i, e, s) {
        ...
        De.getPositionalAudio(i, t => {
            a === this.loadIndex && (this.sounds[e] && (this.interiorSounds[e].stop(),
            ...
            (e == "engine" || e == "engine2") && (t.setLoop(!0),
            t.setLoopStart(.1),
            t.setLoopEnd(t.buffer.duration - .1),
            t.setRefDistance(this.positions.wheelBase * 2),
            t.setRolloffFactor(Tt),
            t.position.set(this.positions.wheelBase, .4, 0),
            t.setVolume(0),
            t.play()),
            (e == "brake" || e == "boost") && (t.setLoop(!0),
            t.setLoopStart(.1),
            t.setLoopEnd(t.buffer.duration - .1),
            t.setRefDistance(this.positions.wheelBase * 2),
            t.setRolloffFactor(Tt),
            t.position.set(this.positions.wheelBase / 2, .4, 0),
            t.setVolume(0),
            t.play()),
            t.name = e,
    ...
    loadWorldSounds(i, e, s) {
        for (let t = 0; t < i.length; t++)
            this.loadHit(i[t], t, s);
        let a = this.loadIndex;
        this.loadStatus.count++,
        De.getPositionalAudio(e.ext, t => {
            a === this.loadIndex && (this.exteriorSounds.scrape && (this.exteriorSounds.scrape.stop(),
            ...
            t.setRolloffFactor(Tt),
            t.name = "scrape_ext",
            t.position.set(2, .5, 0),
            this.container.add(this.exteriorSounds.scrape),
            this.onSoundLoaded())
        }
        , this.exteriorSounds.scrape, s),
        this.loadStatus.count++,
        De.getPositionalAudio(e.int, t => {
            a === this.loadIndex && (this.interiorSounds.scrape && (this.interiorSounds.scrape.stop(),
        ...
        , this.interiorSounds.scrape, s)
    }
    loadHit(i, e, s) {
        let a = this.loadIndex;
        this.loadStatus.count++,
        De.getPositionalAudio(i.ext, t => {
            a === this.loadIndex && (this.exteriorSounds.hits[e] = t,
            t.setRefDistance(5),
        ...
        , this.exteriorSounds.hits[e], s),
        this.loadStatus.count++,
        De.getPositionalAudio(i.int, t => {
            a === this.loadIndex && (this.interiorSounds.hits[e] = t,
            t.setRefDistance(5),
            t.setRolloffFactor(Tt * 3),
            t.setVolumeStoppable(0),
            this.container.add(t),
        ...
        , this.interiorSounds.hits[e], s)
    }
    loadWheelSounds(i, e, s, a) {
        var f, x, w, S;
        let t = this.loadIndex
          , r = Math.random() * .15 + .2 * i
          , c = this.exteriorSounds.wheels[i] ?? {}
          , g = this.interiorSounds.wheels[i] ?? {};
        for (let D = 0; D < ls.length; D++) {
            let C = ls[D];
            this.loadStatus.count++,
            De.getPositionalAudio(s.roll[C].ext, k => {
                t === this.loadIndex && this.onWheelSoundLoaded(k, c, "roll", D, e, r)
            }
            , (f = c.roll) == null ? void 0 : f[D], a + "_roll_ext_" + C),
            this.loadStatus.count++,
            De.getPositionalAudio(s.roll[C].int, k => {
                t === this.loadIndex && this.onWheelSoundLoaded(k, g, "roll", D, e, r)
            }
            , (x = g.roll) == null ? void 0 : x[D], a + "_roll_int_" + C),
            this.loadStatus.count++,
            De.getPositionalAudio(s.skid[C].ext, k => {
                t === this.loadIndex && this.onWheelSoundLoaded(k, c, "skid", D, e, r)
            }
            , (w = c.roll) == null ? void 0 : w[D], a + "_skid_ext_" + C),
            this.loadStatus.count++,
            De.getPositionalAudio(s.skid[C].int, k => {
                t === this.loadIndex && this.onWheelSoundLoaded(k, g, "skid", D, e, r)
            }
            , (S = g.roll) == null ? void 0 : S[D], a + "_skid_int_" + C)
        }
        this.loadStatus.count++,
        De.getPositionalAudio(s.sus, D => {
            t === this.loadIndex && (c.sus && (c.sus.stop(),
            c.sus.removeFromParent(),
            delete c.sus),
            c.sus = D,
            g.sus = D,
            D.setLoop(!0),
            D.setLoopStart(.1),
            D.setLoopEnd(D.buffer.duration - .1),
            D.setRefDistance(this.positions.axleWidth * .64),
    ...
    onWheelSoundLoaded(i, e, s, a, t, r=0) {
        e[s] || (e[s] = []),
        e[s][a] && (e[s][a].stop(),
        e[s][a].removeFromParent(),
        delete e[s][a]),
        i.setLoop(!0),
        i.setLoopStart(.1),
        i.setLoopEnd(i.buffer.duration - .1),
    ...
    onSoundLoaded() {
        this.ready || (this.loadStatus.loaded++,
        this.loadStatus.loaded >= this.loadStatus.count && (this.ready = !0,
        Je.isInterior ? this.sounds = this.interiorSounds : this.sounds = this.exteriorSounds,
        De.hasInit ? this.update = this.updateLive : De.addInitListener( () => {
            this.update = this.updateLive
        }
        )))
    }
    onInteriorChanged(i) {
        this.interiorVol = i ? .5 : 1,
        this.ready && (this.suspendInteriorExterior(),
        i ? this.sounds = this.interiorSounds : this.sounds = this.exteriorSounds)
    }
    suspend() {
        this.ready && (this.suspendInteriorExterior(),
    ...
    suspendInteriorExterior() {
        for (let i of this.sounds.hits)
            i.setVolumeStoppable(0);
        this.sounds.scrape.setVolumeStoppable(0);
        for (let i of this.sounds.wheels) {
            for (let e in i.roll)
                i.roll[e].setVolumeStoppable(0);
            for (let e in i.skid)
                i.skid[e].setVolumeStoppable(0);
...
const zt = "" + new URL("../assets/motor_01.5c7ff2f7.mp3",import.meta.url).href
  , zi = new ka(0)
  , zs = new ka(null)
  , na = .033
  , Yo = 1 - na;
class Sd {
    ...
    updateLive(i) {
        if (!this.noneQueued)
            if (this.smoothDT = i * na + this.smoothDT * Yo,
            this.smoothDT > 100 && (this.smoothDT = 100),
            this.distribute ? this.queue.length < 2 ? this.maxTime = this.smoothDT / 5 : this.queue.length < 4 ? this.maxTime = this.smoothDT / 4 : this.queue.length < 7 ? this.maxTime = this.smoothDT / 3 : this.queue.length < 18 ? this.maxTime = this.smoothDT / 2 : this.queue.length < 30 ? this.maxTime = this.smoothDT * .75 : this.maxTime = this.smoothDT : (this.maxTime = this.smoothDT / 2,
            ...
            this.urgent.length) {
                ...
                do
                    this.urgent[0].load() && this.urgent.shift();
                while (this.urgent.length && Date.now() - this.startTime < this.smoothMaxTime)
            } else if (this.priority.length) {
                this.startTime = Date.now();
                do
                    this.priority[0].load() && this.priority.shift();
                while (this.priority.length && Date.now() - this.startTime < this.smoothMaxTime)
            } else if (this.queue.length) {
                this.startTime = Date.now(),
                this.testTimer = 0;
                do {
                    if (this.distribute && this.queue[0].deadline <= v.vehicleIndex && this.curTime < this.maxMaxTime && !this.queue[0].didPrint) {
                        let e = this.queue[0];
                        e.didPrint = !0,
                        se.add("LOAD QUEUE: Job exceeded deadline: " + e.label + ", " + e.deadline + " @ " + v.vehicleIndex)
                    }
                    this.hasLoaded = this.queue[0].load(),
                    this.hasLoaded == !0 ? (this.curTime > this.maxMaxTime && console.warn("LOAD QUEUE: Overran with process", this.queue[0].label, "by", this.curTime - this.maxMaxTime, this.testTimer),
                    this.testTimer = 0,
                    this.queue.shift()) : this.hasLoaded == null && this.queue.push(this.queue.shift()),
                    this.testTimer++,
                    this.curTime = Date.now() - this.startTime
                } while (this.queue.length && (this.curTime < this.smoothMaxTime || this.distribute && this.queue[0].deadline <= v.vehicleIndex && this.curTime < this.maxMaxTime))
            } else
                this.noneQueued = !0
    }
    updateInitialise(i) {
        if (this.maxTime = i > 17 ? 17 : i,
        ...
        this.urgent.length) {
            ...
            this.maxUrgent + this.maxPriority > 0 && (this.latestProg = Math.max(this.latestProg, 1 - (this.urgent.length + this.priority.length) / (this.maxUrgent + this.maxPriority)),
            this.latestProg < 1 && zi.set(this.latestProg))
        } else if (this.priority.length) {
            this.startTime = Date.now();
            do
                this.priority[0].load() && this.priority.shift();
            while (this.priority.length && Date.now() - this.startTime < this.maxTime);
            this.priority.length ? zs.set(this.priority[0].stage) : zs.set("Rendering"),
            this.maxUrgent = Math.max(this.urgent.length, this.maxUrgent),
            this.maxPriority = Math.max(this.priority.length, this.maxPriority),
            this.maxUrgent + this.maxPriority > 0 && (this.latestProg = Math.max(this.latestProg, 1 - (this.urgent.length + this.priority.length) / (this.maxUrgent + this.maxPriority)),
            this.latestProg < 1 && zi.set(this.latestProg))
        } else
            se.add("LoadQueue: Initialised in " + (mt.appTime - this.resetTime).toFixed(3)),
    ...
    addJob(i, e=v.tail.i, s="", a="", t=!1, r=!1) {
        t ? r ? (this.urgent.push({
            load: i,
            deadline: e,
            label: s,
            stage: a
        }),
        this.maxUrgent = Math.max(this.urgent.length, this.maxUrgent)) : (this.priority.push({
            load: i,
            deadline: e,
            label: s,
            stage: a
        }),
        this.maxPriority = Math.max(this.priority.length, this.maxPriority)) : this.queue.push({
            load: i,
            deadline: e,
            label: s,
            stage: a
        ...
        this.noneQueued = !1,
        this.hasInit && (this.queue.length > 30 ? this.backedUp || (se.add("LOAD: Queue is backed up: " + this.queue.length),
        this.backedUp = !0) : this.backedUp && this.queue.length < 21 && (se.add("LOAD: Queue clearing: " + this.queue.length),
        this.backedUp = !1))
    }
}
const Ya = new Sd;
class bd {
    constructor(i, e=null, s= (a, t) => t) {
        ...
        for (let t in i)
            this.default[t] = JSON.parse(JSON.stringify(i[t]));
        this.storageKey = e;
        let a = !1;
        if (e && localStorage.getItem(e))
            try {
                ...
                if (i)
                    for (let r in i)
                        r in t ? (this.value[r] = t[r],
                        this[r] = t[r]) : (this.value[r] = i[r],
                        this[r] = i[r]);
                else
                    for (let r in t)
                        this.value[r] = t[r],
    ...
    setMany(i) {
        for (let e in i)
            this.set(e, i[e], !0);
        for (let e in i)
            this.onChanged(e, this.value[e])
    }
    set(i, e, s=!1) {
        !(i in this.value) || this.value[i] === e || (this.value[i] = e,
        this[i] = e,
        s || this.onChanged(i, this.value[i]),
        this.storageKey && localStorage.setItem(this.storageKey, JSON.stringify(this.value)))
    }
    onChanged(i, e) {
        for (let s of this.listeners[i] || [])
            s(e);
        for (let s of this.listeners.any || [])
            s(i)
    }
    addListener(i, e, s=!1) {
        typeof e == "function" && (i in this.listeners || (this.listeners[i] = []),
...
const yd = {
  ...
  , ze = new bd(yd);
function Ka() {
    return Math.floor(Date.now() / (Math.random() + .5)).toString(16).substring(3)
}
class Dd {
    constructor() {
        o(this, "actions", [])
...
function Wi(l) {
    ...
    i %= 60;
    let a = "";
    return s > 0 && (s == 1 ? a += s + " day" : a += s + " days",
    e == 0 && i == 0) || (a += " ",
    e > 0 && (e == 1 ? a += e + " hour" : a += e + " hours",
    i == 0)) || (a += " ",
    i == 1 ? a += i + " min" : a += i + " mins"),
    a
}
const Rd = {
    totalDist: {
        readable: "Total travel distance",
        convert: Ri
    },
    manualDist: {
        readable: " - Driven distance",
        convert: Ri
    },
    autodriveDist: {
        readable: " - Autodrive distance",
        convert: Ri
    },
    totalTime: {
        readable: "Total travel time",
        convert: Wi
    },
    manualTime: {
        readable: " - Drive time",
    ...
    autodriveTime: {
        readable: " - Autodrive time",
        convert: Wi
    },
    longestDrive: {
        readable: "Longest single journey",
        convert: Wi
    },
    furthestDrive: {
        readable: "Furthest single journey",
        convert: Ri
    },
    totalVisits: {
        readable: "Total visits",
        convert: l => l
    }
}
  , $r = () => {
    Rd.sr1Distance = {
        readable: "SR1 distance",
        convert: Ri
    }
}
;
...
const Zp = new Ve("Profile",Ld)
  ...
  , Qp = [{
    ...
    changes: ["Small improvements to steering wheel detail", "Adjusted position of mouse control UI when in interior view", "Fixed pixelly randering of trees on mobile", "Fixed dashboard cruise control indicator being set for kilometres when units are miles", "Fixed boost button not working on gamepad", "Fixed odometer display digits overlapping when the odometer hits a multiple of 10"]
}, {
    version: "2.4.0",
    date: "1st March 2026",
    permalink: "https://efe4a997.slowroads-io.pages.dev",
    quickChanges: ["Improved vehicle interior detail and added dashboards", "Altered vehicle audio", "Various minor fixes"],
    changes: ["Added functional dashboards and improved interiors to all vehicles", "Reduced issues of bushes and grasses intersecting the interior", "Minor alterations to motor audio", "Different vehicles now have slightly different motor sounds", "Mouse input, if enabled, will now override controller input", "Added inputs for switching cruise control mode and autodrive modes", "Increased brake force for all vehicles", "Acceleration input is now linear (was mistakenly quadratic)", "Fixed certain settings not correctly updating when importing a profile", "Fixed an issue preventing some controller settings from properly saving", "Fixed an issue misreading controller trigger input as a button press", "Fixed issue with roadside trees dissolving in from nothing"]
}, {
    version: "2.3.3",
    date: "22nd February 2026",
    permalink: "https://cde852ad.slowroads-io.pages.dev",
    quickChanges: ["Patch: Fixed various loading crashes", "Patch: Fixed asset caching issue"],
    changes: ["Patch: Fixed graphics settings not applying correctly", "Patch: Fixed crash when switching road width setting", "Patch: Fixed caching to avoid reloading textures between sessions"]
}, {
    version: "2.3.2",
    date: "22nd February 2026",
    permalink: "https://276ddbc9.slowroads-io.pages.dev",
    quickChanges: ["Profile system added for saving/loading progress and settings", "Minor bug fixes"],
  ...
  , Ko = l => {
    ...
    s) {
        s = s.split(".");
        let a = s[0];
        a == "alpha" ? i.release = 0 : a == "beta" ? i.release = 1 : i.release = 2,
  ...
  , ys = (l, i) => {
    ...
    let e = Ko(i)
      , s = Ko(l)
      , a = s.major * 1e5 + s.minor * 1e4 + s.patch * 1e3 + s.release * 10 + s.releaseVersion
      , t = e.major * 1e5 + e.minor * 1e4 + e.patch * 1e3 + e.release * 10 + e.releaseVersion;
    return a > t ? 1 : -1
}
;
function Ii(l) {
...
if (Se && Se[0] == "1") {
    ...
    $r(),
    localStorage.setItem("settings_Gameplay", JSON.stringify({
        units: (Ii(localStorage.getItem("Units")) + 1) % 2
    }));
    let e = null;
    try {
        e = JSON.parse(localStorage.getItem("controls_keys")),
        e || (e = null)
    } catch {
        e = null
    }
    ...
    localStorage.setItem("settings_Gamepad", JSON.stringify(c)),
    Se = "2.0.0"
}
if (Se && Se[0] == "2" && ys("2.0.1", Se) > 0) {
    se.add("Upgrading to version 2.0.1 from " + Se);
    try {
        let i = JSON.parse(localStorage.getItem("settings_Gameplay")).steerSpeedFactor
...
if (Se && Se[0] == "2" && ys("2.1.0", Se) > 0) {
    ...
    try {
        ...
        l.accelFactor = 1,
        l.steerSpeed > 1 ? l.steerSpeed = 1 + (l.steerSpeed - 1) / 2 : l.steerSpeed = (l.steerSpeed - .5) * 2 * .8 + .2,
        l.recenterSpeed > 1 ? l.recenterSpeed = 1 + (l.recenterSpeed - 1) / 2 : l.recenterSpeed = (l.recenterSpeed - .5) * 2 * .8 + .2,
        localStorage.setItem("settings_Keys", JSON.stringify(l));
        let i = JSON.parse(localStorage.getItem("settings_Gameplay"));
        l.speedSteerFactor != .75 && (i.steerAssist = l.speedSteerFactor);
        let e = JSON.parse(localStorage.getItem("settings_Vehicle"));
        i.driverSide = e.driverSide,
        e.mode == qe.FWD ? e.mode = qe.RWD : e.mode == qe.RWD && (e.mode = qe.FWD),
        localStorage.setItem("settings_Gameplay", JSON.stringify(i)),
        localStorage.setItem("settings_Vehicle", JSON.stringify(e));
        let s = JSON.parse(localStorage.getItem("settings_Mouse"));
        s.linearity == .35 && (s.linearity = .5),
        localStorage.setItem("settings_Mouse", JSON.stringify(s));
        let a = JSON.parse(localStorage.getItem("settings_Gamepad"));
        a.steerSmoothing /= 2,
        localStorage.setItem("settings_Gamepad", JSON.stringify(a))
...
la.showGhostLine,
E.Boolean;
const Kp = new Ve("Comp",la, (l, i) => !0, (l, i) => l == "username" ? i && i.toString().slice(0, 20) : i);
...
function kd(l) {
    ...
    if (l[0] == "#" && (l = l.slice(1)),
    l.length < 4)
        return console.warn("Failed to load from hash: Invalid", l),
        null;
    let i = Ai.indexOf(l[0].toUpperCase());
    if (i < 0)
        return console.warn("Failed to load from hash: Unrecognised location", i),
        null;
    let e;
    try {
        if (e = parseInt(l[1]),
        ...
        return console.warn("Failed to load from hash: Unrecognised road style", l[1]),
        null
    }
    if (l = l.slice(2),
    l[0] !== "-")
        return console.warn("Failed to load from hash: No seed delimiter", l),
        null;
    l = l.slice(1);
    let s = l.lastIndexOf("@")
      , a = 0
    ...
    if (s > 0 && s < l.length - 1)
        try {
            if (a = l.slice(s + 1),
            a.indexOf("km") > 0 ? a.substring(0, a.indexOf("km")) : a.indexOf("mi") > 0 && (t = ko.MILES,
            a.substring(0, a.indexOf("mi"))),
            a = parseFloat(a),
            isNaN(a))
                throw new Error
        } catch {
            return console.warn("Failed to load from hash: Error parsing start distance"),
            null
        }
    let r = Math.floor(a * 100 / vi[t]);
    if (isNaN(r) || r < 0)
        return console.warn("Failed to load from hash: Invalid start distance", a),
        null;
    ...
    return c.length ? {
        ...
        startNode: r,
        accumulatedDistance: 0
    } : (console.warn("Failed to load from hash: No seed found"),
    null)
}
function Pd() {
    return {}
}
const Le = new Ve("World",_d, (l, i) => l == "seed" ? (i = "" + i,
i.length > 0 && i.length <= 24 && !/\?|\!/.test(i)) : !(l == "startNode" && i < 0), (l, i) => {
    if (l == "seed")
        return i.toString();
    if (l == "scene")
        i %= qo.length,
        ...
        l == "roadStyle" && (i %= ha.length,
        i < 0 && (i = ha.length - 1));
    return i
}
)
  , Jo = new Ve("WorldHistory",{
    history: {}
});
let ss = "";
Le.addListener("any", () => {
...
const oA = (l, i=!1) => {
  ...
  , tr = () => "" + Ai[Le.scene] + Le.roadStyle + "-" + Le.seed + "@" + (Le.startNode / 100).toFixed(2)
  , rA = (l, i, e, s=0) => s > 0 ? Ai[l] + i + "-" + e + "@" + (s / 100).toFixed(2) : Ai[l] + i + "-" + e
  , nA = l => {
    if (l[0] == "#" && (l = l.slice(1)),
    l.length < 3)
        return !1;
    let i = l[0].toUpperCase();
    if (!Ai.includes(i) || !vt(qa) && i == "D")
        return !1;
    let e;
    try {
        e = parseInt(l[1])
  ...
  , lA = () => {
    ...
    s[l] || (s[l] = {}),
    s[l][e] || (s[l][e] = {}),
    s[l][e][i] ? (s[l][e][i].ts = Date.now(),
    s[l][e][i].startNode = Math.max(0, v.vehicleIndex)) : s[l][e][i] = {
        ts: Date.now(),
...
function dA(l, i, e, s, a, t) {
    ...
    {
        t: be.t,
        dSq: (be.x - l) * (be.x - l) + (be.z - i) * (be.z - i)
    })
}
const rt = Math.PI * 2
  , b = {
...
class Ja {
    constructor(i, e) {
        ...
        o(this, "topSpeedFactor", .65);
        o(this, "minTargetDist", 0);
        o(this, "minTargetSpeed", 10);
        ...
        o(this, "updateCautionParametersBound", this.updateCautionParameters.bind(this));
        ...
        this.vc = e,
        this.targetPosShape = new ei(new is(.5,32,16),new Te({
            color: 16711935
        })),
    ...
    onDriveLaneChanged() {
        ze.lanes <= 1 || L.driveLane == Po.CENTER ? this.nominalDriveLaneOffset = 0 : L.driveLane == Po.LEFT ? this.nominalDriveLaneOffset = ze.width / 2 * -1 : this.nominalDriveLaneOffset = ze.width / 2,
    ...
    updateCautionParameters() {
        ...
        this.cautionFactor = Math.max(this.vc.tuning.minCautionFactor, this.cautionFactor),
        isNaN(this.cautionFactor) && (this.cautionFactor = .25),
        i !== this.cautionFactor && se.add("AUTODRIVE: Setting caution factor " + this.cautionFactor.toFixed(2)),
        this.topSpeedFactor = .8 - this.cautionFactor * .3
    }
    initialise() {
    ...
    reset() {
        ...
        this.driveLaneCorrection = Math.min(ze.width, this.midlineLookup.d) * -this.midlineLookup.s - this.nominalDriveLaneOffset,
        this.driveLaneOffset = Math.min(ze.width, this.midlineLookup.d) * -this.midlineLookup.s,
        this.beelineFactor = 0,
        this.updateTarget(!0)
    }
    update(i) {
        if (this.vehicleAccel = (n.speed - this.pVehicleSpeed) / i,
        this.pVehicleSpeed = n.speed,
        this.midlineLookup = Wo(n.position.x, n.position.z, v.vehicleNode),
        this.midlaneOffset = Math.abs(this.midlineLookup.d - this.driveLaneOffset),
        this.offroadFactor = 0,
        this.midlineLookup.d > ze.width && (this.offroadFactor = Math.min(1, (this.midlineLookup.d - ze.width) / 2)),
        this.roadEdgeProximity = this.midlineLookup.d / (ze.width - this.vc.metrics.boxWidth / 2) * this.midlineLookup.s,
        this.roadEdgeProximity < 0 ? this.roadEdgeProximity = Math.max(-1, Math.min(0, (this.roadEdgeProximity + .5) * 2)) : this.roadEdgeProximity = Math.min(1, Math.max(0, (this.roadEdgeProximity - .5) * 2)),
        ...
        if (n.speed < 1 && L.autodriveMode !== q.STEER) {
            ...
            this.stuckTime !== null && (this.stuckTime = null);
        this.updateTarget(),
        this.targetPosShape.position.copy(this.targetPos),
        this.angleDif = n.heading - Math.atan2(n.position.z - this.targetPos.z, this.targetPos.x - n.position.x),
        L.autodriveMode == q.SPEED && (this.angleDif = n.heading - this.targetHeading),
        this.angleDif > Math.PI ? this.angleDif -= rt : this.angleDif < -Math.PI && (this.angleDif += rt),
        this.angleDifAbs = Math.abs(this.angleDif),
        b.dist = Math.sqrt((this.targetPos.x - n.position.x) ** 2 + (this.targetPos.z - n.position.z) ** 2),
        b.steerRadius = b.dist / 2 / Math.sin(this.angleDifAbs),
        this.inputs.steer = Math.atan(this.vc.metrics.wheelBase / b.steerRadius),
        ...
        b.targetArrivalDif > 3 ? b.targetArrivalDif -= rt : b.targetArrivalDif < -3 && (b.targetArrivalDif += rt),
        b.targetArrivalDif = Math.abs(b.targetArrivalDif),
        this.offroadFactor > 0 ? (b.targetArrivalDif > .3 ? this.targetSpeed *= 1 - this.offroadFactor * .8 : this.targetSpeed *= Math.max(.5, 1 - this.offroadFactor * .8 * (b.targetArrivalDif / .3)),
        this.targetSpeed = Math.max(5, this.targetSpeed)) : b.targetArrivalDif > .25 && (this.targetSpeed *= Math.max(.4, 1.25 - b.targetArrivalDif)),
        ...
        b.vnHeadingDif > 3 ? b.vnHeadingDif -= rt : b.vnHeadingDif < -3 && (b.vnHeadingDif += rt),
        ...
        this.beelineFactor = 1 - Math.max(0, Math.min(1, Math.cos(b.beelineAssessment))),
        this.beelineSteer = -this.angleDif,
        this.newSteer = this.inputs.steer * (1 - this.beelineFactor) + this.beelineSteer * this.beelineFactor,
        this.newSteer = Math.min(Math.max(-n.tuning.maxSteer, this.newSteer), n.tuning.maxSteer),
        this.newSteer *= n.direction,
        n.onRoad || (b.maxSteer = 1 - this.offroadFactor,
        this.offroadFactor >= 1 && (b.maxSteer = 0,
        n.speed > this.targetSpeed * 2 ? b.maxSteer = 0 : n.speed > this.targetSpeed ? b.maxSteer = 1 - (n.speed - this.targetSpeed) / this.targetSpeed : b.maxSteer = 1),
        b.maxSteer *= n.tuning.maxSteer,
        this.newSteer = Math.min(Math.max(-b.maxSteer, this.newSteer), b.maxSteer)),
        ...
        b.tAccel = 0,
        b.tBrake = 0,
        n.speed > this.targetSpeed ? (b.tAccel = 0,
        this.brakeThreshold = 1.2 - this.cautionFactor * .1,
        this.inputs.brake > 0 && (this.brakeThreshold *= .95),
        this.brakeFactor = 1,
        n.speed / this.targetSpeed > this.brakeThreshold ? (b.tBrake = n.speed / this.targetSpeed - this.brakeThreshold,
        b.tBrake *= 2,
        n.onRoad ? (b.tBrake *= this.brakeFactor,
        b.tBrake = Math.min(.5, b.tBrake)) : b.tBrake = Math.min(1, b.tBrake)) : b.tBrake = 0) : n.speed > this.targetSpeed * .98 ? (b.tAccel = this.inputs.accel * .9,
        b.tBrake = this.inputs.brake * .9) : (b.speedBlend = .7 + n.speedLerp * .2,
        n.speed > this.targetSpeed * b.speedBlend ? b.tAccel = 1 - Math.max(.1, ((n.speed - this.targetSpeed * b.speedBlend) / (this.targetSpeed * (1 - b.speedBlend))) ** 2) : n.speed < this.targetSpeed * .5 ? b.tAccel = 2 - n.speed / (this.targetSpeed * .5) : b.tAccel = 1,
        b.tBrake = 0),
        b.tAccel = Math.min(1, b.tAccel),
        b.tAccel *= b.tAccel,
        b.tAccel *= n.tuning.accel,
        b.tAccel > this.inputs.accel ? this.inputs.accel = this.inputs.accel * .975 + b.tAccel * .025 : (this.inputs.accel = this.inputs.accel * .95 + b.tAccel * .05,
        this.inputs.accel < .1 && (this.inputs.accel = 0)),
        this.inputs.brake = this.inputs.brake * .8 + b.tBrake * .2,
        b.tBrake < this.inputs.brake && this.inputs.brake < .1 && (this.inputs.brake = 0)
    }
    annotateSpeedLimit(i) {
        let e = -n.tuning.corneringFactor * xe * (1 - this.cautionFactor * .2);
        b.max = n.tuning.topSpeed * this.topSpeedFactor;
        let s = 1.75 - this.cautionFactor * .5
          , a = i.da + i.next.da;
        if (a == 0)
            i.maxSpeed = b.max;
        else {
            let t = Math.abs(a) / 2
              , r = 20 * Math.cos(t) / Math.sin(t);
            b.maxCornerSpeed = Math.sqrt(r * e);
            let c = 1;
            if (i.prev) {
                let x = (i.p.y - i.prev.p.y) / 10;
                x > 0 ? c = 1 + Math.min(.2, x) : c = 1 + Math.max(-.2, x)
            }
            if (i.maxSpeed = Math.min(b.max, b.maxCornerSpeed * c),
    ...
    updateTarget(i=!1) {
        for (i && (this.speedAnnotationNode = this.midlineLookup.n,
        this.bridgeLookaheadNode = this.midlineLookup.n); this.speedAnnotationNode.i < this.midlineLookup.n.i + Nd; )
        ...
        if (b.n = this.midlineLookup.n,
        b.targetDist = this.vc.metrics.wheelBase + 1 + n.speed * (1 - this.cautionFactor) * n.tuning.targetDistFactor,
        n.onRoad || (b.targetDist += this.offroadFactor * 10),
        this.bridgeLookaheadNode.bridge && !this.midlineLookup.n.bridge) {
            this.nextBridgeIndex < this.midlineLookup.n.i && (this.nextBridgeIndex = this.bridgeLookaheadNode.i);
        ...
        b.targetNodeLerp > 1)
            for (; b.targetNodeLerp > 1; )
                b.n = b.n.next,
                b.targetNodeLerp -= 1;
        for (b.fineIndex = Math.floor(b.targetNodeLerp / (1 / b.n.fs)),
        b.fineLerp = (b.targetNodeLerp - b.fineIndex / b.n.fs) * b.n.fs,
        b.nf = b.n; b.fineIndex > 0; )
            b.nf = b.nf.nextFine,
            b.fineIndex--;
        ...
        b.cornerCaution = b.n.next.da * (1 - b.targetNodeLerp) + b.n.next.next.da * b.targetNodeLerp,
        n.speedLerp < .1 && (b.cornerCaution *= n.speedLerp * 10),
        this.driveLaneOffsetTarget = this.nominalDriveLaneOffset + b.cornerCaution * n.tuning.corneringCaution,
        this.driveLaneCorrection = this.driveLaneCorrection * .99,
        this.driveLaneOffsetTarget += this.driveLaneCorrection,
        this.driveLaneOffset = this.driveLaneOffset * .9 + this.driveLaneOffsetTarget * .1,
        ...
        b.targetSpeed *= L.autodriveSpeedFactor,
        this.targetSpeed = this.targetSpeed * .9 + b.targetSpeed * .1
    }
}
const d = {
    vecA: new m,
...
class Oi extends Ke {
    ...
    prepMetrics() {
        ...
        this.layout.wheels = [{
            x: this.metrics.wheelBase,
            z: -this.metrics.axleWidth / 2
        }, {
            x: this.metrics.wheelBase,
            z: this.metrics.axleWidth / 2
        }, {
    ...
    load() {
        return this.elementsToLoad ? !1 : (this.onReady(),
        !0)
    }
    onElementLoaded() {
        this.elementsToLoad--
    ...
    initWheels() {
        let e = Math.PI
          ...
          , t = this.metrics.comHeight / (this.metrics.axleWidth / 2) * .75
          , r = this.prepWheel();
        r.i = 0,
        r.front = !0,
        ...
        r.axlePos.set(this.metrics.wheelBase, this.metrics.wheelRadius, -this.metrics.axleWidth / 2),
    ...
    setPose(e, s, a, t) {
        ...
        d.vecA.set(e + Math.cos(t) * this.metrics.wheelBase, s, a + Math.sin(t) * this.metrics.wheelBase);
        ...
        d.frontGroundHeight = (this.wheelFL.groundHeight + this.wheelFR.groundHeight) / 2,
        d.rearGroundHeight = (this.wheelRL.groundHeight + this.wheelRR.groundHeight) / 2,
        this.groundAngle = Math.asin((d.frontGroundHeight - d.rearGroundHeight) / this.wheelFL.groundPoint.distanceTo(this.wheelRL.groundPoint)),
        ...
        this.contactUp.copy(this.groundUp).multiplyScalar(this.metrics.wheelRadius),
        ...
        n.com.copy(n.forwardDir).multiplyScalar(this.metrics.wheelBase / 2).add(n.position),
        ...
        for (let c of this.wheels)
            this.updateWheelWorldPos(c),
            c.pWorldPos.copy(c.worldPos);
        this.chassisPComPos.copy(n.com),
        this.chassisPRot.copy(this.orientation)
    }
    reset() {
        let e = v.vehicleNode;
        this.setPose(e.p.x + e.n.x * n.driveLaneOffset, e.p.y, e.p.z + e.n.z * n.driveLaneOffset, e.next.a),
    ...
    destroy() {
        ...
        this.autodriver.destroy()
    }
    updateStationed(e) {
        if (I.signal.Handbrake = 1,
        n.hasHandbrake = !0,
        d.debugObj = {},
        this.handleInput(e),
        !Je.isCinecam && I.signal.Backward + I.signal.Forward > 0 || this.autodrive || I.signal.Autodrive || n.hasCruiseTarget) {
            n.hasHandbrake = !1,
    ...
    updateLive(e) {
        ...
        this.handleInput(e);
        let s = e;
        for (; !mt.stepping && s > .012; )
            this.updatePhysics(.01),
            this.pdT = .01,
            s -= .01;
    ...
    updateNew(e) {
        ...
        d.stabilityFactor = 1,
        d.frontSlip > 0 && d.rearSlip > d.frontSlip && (d.frontRearSlipRatio = Math.min(d.rearSlip, Math.min(2, d.rearSlip / d.frontSlip) - 1),
        d.stabilityFactor = 1 + d.frontRearSlipRatio * this.tuning.rearStability),
        d.stabilityFactor *= 1 - this.inputs.brake * .25,
        ...
        for (let t of this.wheels) {
            ...
            r > t.speed && (r - t.speed) / e > 25 && t.velocity.copy(t.velocityDir).multiplyScalar(25 * e + t.speed),
            t.pWorldPos.copy(t.worldPos),
            t.speed = t.velocity.length(),
            t.dS = t.speed * e * Math.abs(t.lonDirDot),
            t.accel.set(0, 0, 0),
            t.shockForce <= 1 ? t.downforce = t.shockForce * .9 : t.downforce = .9 + .1 * Math.sqrt((t.shockForce - 1) / (this.tuning.shockForce - 1)),
            t.groundTraction = (Math.max(0, t.groundNorm.dot(Ws) - .5) * 2) ** 2,
            ...
            t.traction = t.downforce * Math.min(1, t.groundState.f * this.tuning.tyreFriction * t.groundTraction),
            t.front ? (t.steerOrientation.copy(this.orientation),
            t.i == 0 ? t.steerOrientation.y += this.effectiveSteerL : t.steerOrientation.y += this.effectiveSteerR,
            ...
            t.latDirDot = t.velocityDir.dot(d.vecA)) : (d.vecA.set(1, 0, 0).applyEuler(this.orientation),
            t.lonDirDot = t.velocityDir.dot(d.vecA),
            t.direction = t.lonDirDot < 0 ? -1 : 1,
            d.vecA.set(0, 0, 1).applyEuler(this.orientation),
            t.latDirDot = t.velocityDir.dot(d.vecA)),
            t.locked = !t.front && n.hasHandbrake,
            t.locked ? (d.maxLon = this.metrics.wheelMass * t.downforce * t.groundState.f * this.tuning.tyreFriction * t.cosLonGroundAngle,
            d.lon = t.lonDirDot * t.speed / e,
            d.lonAbs = Math.abs(d.lon),
            t.lonSlip = 0,
            d.lonAbs > d.maxLon && (d.maxLon = this.metrics.wheelMass * t.downforce * (t.groundState.f * this.tuning.tyreFriction) * this.tuning.kineticFrictionFactor * t.cosLonGroundAngle * .7,
            d.lon < 0 ? d.lon = Math.max(d.lon, -d.maxLon) : d.lon = Math.min(d.lon, d.maxLon),
            t.lonSlip = Math.abs(t.lonDirDot)),
            t.static = t.speed < .2,
            t.accel.x -= d.lon) : n.hasHandbrake && t.speed < .1 ? t.static = !0 : (t.static = !1,
            t.accel.x -= Math.min(this.tuning.rollResistance, t.speed / e) * t.shockForce * t.lonDirDot),
            d.lat = t.latDirDot * t.speed / e,
            t.pLat = d.lat,
            t.slipAngle = Math.acos(t.lonDirDot),
            t.slipAngleFactor = 0,
            d.slipAngleLerp = Math.max(0, t.slipAngle / this.peakSlipAngle),
            d.slipAngleLerp <= 1 ? t.slipAngleFactor = -((d.slipAngleLerp - 1) ** 2) + 1 : d.slipAngleLerp > 10 ? t.slipAngleFactor = .75 : t.slipAngleFactor = 1 + (1 - d.slipAngleLerp) * .025,
            d.wl = 1,
            t.groundImpact <= 0 ? d.wl = t.cosLatGroundAngle ** 3 : d.wl = t.groundImpactFactor,
            L.gripFactor < 1 ? d.wl *= .8 + L.gripFactor * .2 : d.wl *= L.gripFactor,
            d.maxLat = this.metrics.wheelMass * t.downforce * t.groundState.f * this.tuning.tyreFriction * t.slipAngleFactor * d.wl,
            t.front || (d.maxLat *= d.stabilityFactor),
            d.latAbs = Math.abs(d.lat),
            t.kineticBlend = 0,
            d.latAbs > d.maxLat ? (t.kineticBlend = 1,
            d.kineticForceLimit = t.groundState.f * 50,
            d.latAbs < d.kineticForceLimit && (t.kineticBlend = this.smoothLerp(d.latAbs / d.kineticForceLimit)),
            d.frictionFactor = 1 - t.kineticBlend + t.kineticBlend * this.tuning.kineticFrictionFactor,
            d.maxLat = this.metrics.wheelMass * t.downforce * (t.groundState.f * this.tuning.tyreFriction) * d.frictionFactor * t.slipAngleFactor * d.wl,
            t.front || (d.maxLat *= d.stabilityFactor),
            t.drive > 0 && (this.driveMode == qe.RWD ? d.maxLat *= 1 - t.drive * .08 * t.kineticBlend : d.maxLat *= 1 - t.drive * .04 * t.kineticBlend),
            t.locked && (d.maxLat *= .7),
            d.lat < -d.maxLat ? (t.slip = Math.min(1, -(d.lat - d.maxLat) / (d.maxLat * 100)),
            d.lat = Math.max(d.lat, -d.maxLat)) : d.lat > d.maxLat && (t.slip = Math.min(1, (d.lat - d.maxLat) / (d.maxLat * 100)),
            d.lat = d.maxLat)) : t.slip = 0,
            t.maxLat = d.maxLat,
            t.latForce = d.lat,
            t.accel.z -= t.latForce,
            this.braking && !t.locked && (t.accel.x = -t.lonDirDot * this.brakeForce * t.traction),
            t.drive = 0,
            t.hasDrive && !t.locked && (d.drive = this.drive * this.driveModeFactor * t.traction,
            t.drive = this.drive / this.tuning.accel * this.driveModeFactor,
            t.i == 0 ? (d.drive *= this.steerDifferential,
            t.drive *= this.steerDifferential) : t.i == 1 ? (d.drive /= this.steerDifferential,
            t.drive /= this.steerDifferential) : t.i == 2 ? (d.drive *= this.rearSteerDifferential,
            t.drive *= this.rearSteerDifferential) : (d.drive /= this.rearSteerDifferential,
            ...
            t.accel.y += t.downforce * (this.sinTiltZ * -t.comFactor.x * xe + this.sinTiltX * t.comFactor.z * xe),
            t.accel.y += t.downforce * (this.chassisAccel.x * t.comFactor.x + this.chassisAccel.z * t.comFactor.z),
            L.gripFactor > 1 ? t.accel.y -= n.speed ** 2 * this.tuning.aeroFactor * this.cosTiltZ : t.accel.y -= n.speed ** 2 * this.tuning.aeroFactor * this.cosTiltZ * L.gripFactor,
            t.front ? t.accel.applyEuler(t.steerOrientation) : t.accel.applyEuler(this.orientation),
            t.accel.y += xe,
            d.vecA.copy(t.velocityDir).negate().multiplyScalar(this.tuning.drag * t.speed * t.speed),
            t.contactPoint.y < ce.seaLevel && (d.s = ce.seaLevel - this.metrics.wheelRadius,
            t.contactPoint.y < d.s ? d.vecA.multiplyScalar(100) : d.vecA.multiplyScalar((1 - (t.contactPoint.y - d.s) / this.metrics.wheelRadius) * 100)),
            t.accel.add(d.vecA),
            t.wheelImpact = -t.groundNorm.dot(t.velocityDir) * t.downforce,
            (t.wheelImpact < 0 || t.velocityDir.y < 0) && (t.wheelImpact = 0),
            t.wheelImpact > .01 && (d.vecA.normalize().multiplyScalar(t.wheelImpact * (t.speed / e) * .05 * Math.max(Math.abs(t.lonDirDot / 4), Math.abs(t.latDirDot))),
            t.accel.add(d.vecA),
            d.vecA.copy(t.groundNorm),
            d.vecA.y *= 0,
            d.vecA.multiplyScalar(t.speed / e * t.wheelImpact * .003),
            d.vecA.divideScalar(e),
            t.accel.add(d.vecA)),
            t.accel.multiplyScalar(e),
            t.velocity.add(t.accel),
            t.static && (t.velocity.x = 0,
            t.velocity.z = 0),
            t.worldPos.copy(t.velocity).multiplyScalar(e).add(t.pWorldPos)
        }
        this.resolveChassisTransformNew(e),
        ...
        if (this.fCollision)
            this.resolveCollisions(e) && (this.chassisVel.copy(n.com).sub(this.chassisPComPos).divideScalar(e),
            this.chassisVel.multiplyScalar(.98),
            d.vecA.copy(this.orientation).sub(this.chassisPRot),
            d.vecA.y > Math.PI ? d.vecA.y -= Math.TAU : d.vecA.y < -Math.PI && (d.vecA.y += Math.TAU),
            d.vecA.divideScalar(e),
            Math.abs(d.vecA.x) > this.tuning.maxRotAccel && (d.vecA.x = Math.sign(d.vecA.x) * this.tuning.maxRotAccel),
            Math.abs(d.vecA.z) > this.tuning.maxRotAccel && (d.vecA.z = Math.sign(d.vecA.z) * this.tuning.maxRotAccel),
            Math.abs(d.vecA.y) > this.tuning.maxRotAccel && (d.vecA.y = Math.sign(d.vecA.y) * this.tuning.maxRotAccel),
            ...
            Math.abs(d.vecA.z) > this.tuning.maxRotAccel && (d.vecA.z = Math.sign(d.vecA.z) * this.tuning.maxRotAccel),
            Math.abs(d.vecA.y) > this.tuning.maxRotAccel && (d.vecA.y = Math.sign(d.vecA.y) * this.tuning.maxRotAccel),
            this.chassisRotVel.lerp(d.vecA, (1 - this.tuning.weightFactor) * (this.collidingGround / 4) * r)
        }
        (isNaN(n.position.x) || isNaN(this.orientation.z)) && this.reset()
    }
    resolveChassisTransformNew(e) {
        let s, a = this.vecs.p, t = this.vecs.pw, r = this.vecs.pl, c = this.vecs.wUp, g = this.vecs.wLat, f = this.vecs.wLon, x = this.vecs.wLatNorm, w = this.vecs.wLonNorm, S, D, C, k, T, P = 0, B = this.vecs.cumPos, O = this.vecs.cumRot, z = 0, N = 0, j = this.vecs.cPos, G = this.vecs.cRot;
        B.set(0, 0, 0),
        O.set(0, 0, 0),
        j.set(0, 0, 0),
        G.set(0, 0, 0);
        ...
        for (let Ue = 0; Ue < 4; Ue++)
            s = this.wheels[Ue],
            a.copy(s.worldPos),
            Ue == 0 ? (t.copy(this.wheelFR.worldPos),
            r.copy(this.wheelRL.worldPos),
            g.subVectors(t, a),
            f.subVectors(a, r)) : Ue == 1 ? (t.copy(this.wheelFL.worldPos),
            r.copy(this.wheelRR.worldPos),
            g.subVectors(a, t),
            f.subVectors(a, r)) : Ue == 2 ? (t.copy(this.wheelRR.worldPos),
            r.copy(this.wheelFL.worldPos),
            g.subVectors(t, a),
            f.subVectors(r, a)) : (t.copy(this.wheelRL.worldPos),
            ...
            s.i == 0 ? Be = G.y : G.y - Be < -Math.PI ? G.y += je : G.y - Be > Math.PI && (G.y -= je),
            G.z = Math.asin(f.y),
        ...
        N > 0 && d.vecB.length() > this.tuning.maxLinearAccel && d.vecB.normalize().multiplyScalar(this.tuning.maxLinearAccel),
        d.vecB.multiplyScalar(e),
        this.chassisVel.add(d.vecB),
        d.vecA.copy(this.orientation).sub(this.chassisPRot),
        d.vecA.y > Math.PI ? d.vecA.y -= Math.TAU : d.vecA.y < -Math.PI && (d.vecA.y += Math.TAU),
        d.vecA.divideScalar(this.pdT),
        N > 0 && (Math.abs(d.vecA.x) > this.tuning.maxRotAccel && (d.vecA.x = Math.sign(d.vecA.x) * this.tuning.maxRotAccel),
        Math.abs(d.vecA.z) > this.tuning.maxRotAccel && (d.vecA.z = Math.sign(d.vecA.z) * this.tuning.maxRotAccel),
        Math.abs(d.vecA.y) > this.tuning.maxRotAccel && (d.vecA.y = Math.sign(d.vecA.y) * this.tuning.maxRotAccel)),
        d.vecB.copy(d.vecA).sub(this.chassisRotVel),
        this.chassisRotVel.add(d.vecB),
        this.chassisRotVel.y < -Math.PI ? this.chassisRotVel.y += je : this.chassisRotVel.y > Math.PI && (this.chassisRotVel.y -= je),
        this.chassisPComPos.copy(n.com),
        this.chassisPRot.copy(this.orientation);
        let ue = N / 4 * this.tuning.shockForce
          , Vt = 1 - Math.min(1, ue)
          , $ = .25 * e;
        this.chassisRotVel.x > $ ? this.chassisRotVel.x -= $ : this.chassisRotVel.x < -$ && (this.chassisRotVel.x += $),
        this.chassisRotVel.z > $ ? this.chassisRotVel.z -= $ : this.chassisRotVel.z < -$ && (this.chassisRotVel.z += $),
        $ = .2 * e,
        this.chassisRotVel.y > $ ? this.chassisRotVel.y -= $ : this.chassisRotVel.y < -$ && (this.chassisRotVel.y += $),
        ...
        wi < -Math.PI ? this.chassisCandidateRot.y += je : wi > Math.PI && (this.chassisCandidateRot.y -= je),
        this.chassisCandidateComPos.copy(this.chassisVel).multiplyScalar(e).add(n.com),
        d.vecA.set(-this.metrics.wheelBase / 2, -this.metrics.comHeight, 0).applyEuler(this.chassisCandidateRot),
        ...
        ue > 1 ? ne *= Math.max(1 - this.tuning.weightFactor, 2 - ue) : (ue == 0 && (ne = 1),
        ne = this.tuning.weightFactor + (1 - ue) * (1 - this.tuning.weightFactor)),
        ...
        n.forwardPosition.copy(n.forwardDir).multiplyScalar(this.metrics.wheelBase).add(n.position),
        n.midPosition.set((n.position.x + n.forwardPosition.x) / 2, (n.position.y + n.forwardPosition.y) / 2, (n.position.z + n.forwardPosition.z) / 2),
        n.cockPosition.copy(n.midPosition).lerp(n.forwardPosition, this.layout.cockpitLerp)
    }
    resolveChassisTransform() {
        d.inertia = 0,
        d.authMin = .2,
        d.authRange = (.5 - d.authMin) * 2,
        d.fCollDenom = this.wheelFL.downforce + this.wheelFL.collisionFactor + this.wheelFR.downforce + this.wheelFR.collisionFactor,
        d.fCollDenom > 0 ? d.fRightAuthority = (this.wheelFR.downforce + this.wheelFR.collisionFactor) / d.fCollDenom : d.fRightAuthority = .5,
        d.fCollisionFactor = this.wheelFL.collisionFactor + this.wheelFR.collisionFactor,
        d.fCollisionFactor == 0 && (d.fRightAuthority = d.authMin + d.authRange * d.fRightAuthority),
        d.fRightAuthorityS = d.fRightAuthorityS * d.inertia + (1 - d.inertia) * d.fRightAuthority,
        d.vecA.copy(this.wheelFR.worldPos).sub(this.wheelFL.worldPos),
        d.offset = d.vecA.length() - this.metrics.axleWidth,
        d.vecB.copy(d.vecA).normalize().multiplyScalar(d.offset * d.fRightAuthorityS),
        ...
        d.rCollDenom = this.wheelRL.downforce + this.wheelRL.collisionFactor + this.wheelRR.downforce + this.wheelRR.collisionFactor,
        d.rCollDenom > 0 ? d.rRightAuthority = (this.wheelRR.downforce + this.wheelRR.collisionFactor) / d.rCollDenom : d.rRightAuthority = .5,
        d.rCollisionFactor = this.wheelRL.collisionFactor + this.wheelRR.collisionFactor,
        d.rCollisionFactor == 0 && (d.rRightAuthority = d.authMin + d.authRange * d.rRightAuthority),
        d.rRightAuthorityS = d.rRightAuthorityS * d.inertia + (1 - d.inertia) * d.rRightAuthority,
        d.vecA.copy(this.wheelRR.worldPos).sub(this.wheelRL.worldPos),
        d.offset = d.vecA.length() - this.metrics.axleWidth,
        d.vecB.copy(d.vecA).normalize().multiplyScalar(d.offset * d.rRightAuthorityS),
        this.wheelRL.worldPos.add(d.vecB),
        d.vecA.normalize().multiplyScalar(this.metrics.axleWidth),
        this.wheelRR.worldPos.copy(d.vecA).add(this.wheelRL.worldPos),
        d.axleFPos.addVectors(this.wheelFL.worldPos, this.wheelFR.worldPos).multiplyScalar(.5),
        d.axleRPos.addVectors(this.wheelRL.worldPos, this.wheelRR.worldPos).multiplyScalar(.5),
        d.collDenom = d.fCollDenom + d.rCollDenom,
        d.collDenom > 0 ? d.frontAuthority = d.fCollDenom / d.collDenom : d.frontAuthority = .5,
        d.fCollisionFactor == 0 && d.rCollisionFactor == 0 && (d.frontAuthority = d.authMin + d.authRange * d.frontAuthority),
        d.frontAuthorityS = d.frontAuthorityS * d.inertia + (1 - d.inertia) * d.frontAuthority,
        d.vecA.copy(d.axleFPos).sub(d.axleRPos),
        d.offset = d.vecA.length() - this.metrics.wheelBase,
        d.vecB.copy(d.vecA).normalize().multiplyScalar(d.offset * d.frontAuthorityS),
        ...
        this.orientation.y > Math.PI ? this.orientation.y -= Math.TAU : this.orientation.y < -Math.PI && (this.orientation.y += Math.TAU),
        n.heading = this.orientation.y,
        n.direction = Math.min(this.wheelRL.direction, this.wheelRR.direction),
        this.wheelRR.speed + this.wheelRL.speed < .1 && (n.direction = 0),
        d.d1 = this.wheelFL.worldPos.distanceTo(this.wheelRL.worldPos),
        d.d2 = this.wheelFR.worldPos.distanceTo(this.wheelRR.worldPos),
        d.r1 = Math.asin((this.wheelFL.worldPos.y - this.wheelRL.worldPos.y) / d.d1),
        d.r2 = Math.asin((this.wheelFR.worldPos.y - this.wheelRR.worldPos.y) / d.d2),
        d.tiltLerpDenom = this.wheelFL.downforce + this.wheelRL.downforce + this.wheelFR.downforce + this.wheelRR.downforce,
        d.tiltLerpDenom > 0 ? d.tiltLerp = (this.wheelFL.downforce + this.wheelRL.downforce) / d.tiltLerpDenom : d.tiltLerp = .5,
        d.tiltZ = d.r1 * d.tiltLerp + d.r2 * (1 - d.tiltLerp),
        isNaN(d.tiltZ) && (d.tiltZ = 0),
        d.dTiltZ = d.tiltZ - this.tiltZ,
        d.tiltZ > this.tiltZ && this.tiltZ > 1 ? d.dTiltZ *= 1 - (this.tiltZ - 1) / .4 : d.tiltZ < this.tiltZ && this.tiltZ < -1 && (d.dTiltZ *= (1 + this.tiltZ) / -.4),
        this.tiltZ += d.dTiltZ,
        ...
        d.d2 = this.wheelFR.worldPos.distanceTo(this.wheelFL.worldPos) * this.cosTiltZ,
        d.d1 = this.wheelFL.worldPos.y - this.wheelFR.worldPos.y,
        d.r1 = Math.asin(d.d1 / d.d2),
        d.d2 = this.wheelRR.worldPos.distanceTo(this.wheelRL.worldPos) * this.cosTiltZ,
        d.d1 = this.wheelRL.worldPos.y - this.wheelRR.worldPos.y,
        d.r2 = Math.asin(d.d1 / d.d2),
        d.tiltLerpDenom > 0 ? d.tiltLerp = (this.wheelFL.downforce + this.wheelFR.downforce) / d.tiltLerpDenom : d.tiltLerp = .5,
        d.tiltX = d.r1 * d.tiltLerp + d.r2 * (1 - d.tiltLerp),
        d.dTiltX = d.tiltX - this.tiltX,
        d.tiltX > this.tiltX && this.tiltX > 1 ? d.dTiltX *= 1 - (this.tiltX - 1) / .4 : d.tiltX < this.tiltX && this.tiltX < -1 && (d.dTiltX *= (1 + this.tiltX) / -.4),
        this.tiltX += d.dTiltX,
    ...
    updateWheelsPost(e) {
        ...
        d.r = 0,
        this.wheelFL.shockFactor == 0 ? (this.wheelFL.rollVelocity *= .995,
        d.r = this.wheelFL.rollVelocity * e) : (d.r = this.wheelFL.dS / d.wheelCirc * je * this.wheelFL.direction,
        ...
        this.wheelFR.shockFactor == 0 ? (this.wheelFR.rollVelocity *= .995,
        d.r = this.wheelFR.rollVelocity * e) : (d.r = this.wheelFR.dS / d.wheelCirc * je * this.wheelFR.direction,
        ...
        n.hasHandbrake || (this.wheelRL.shockFactor == 0 ? (this.wheelRL.rollVelocity *= .995,
        d.r = this.wheelRL.rollVelocity * e) : (d.r = this.wheelRL.dS / d.wheelCirc * je * this.wheelRL.direction,
        this.wheelRL.rollVelocity = d.r / e),
        this.wheelRL.rotation.z = this.wheelRL.rotation.z + d.r,
        this.wheelRR.shockFactor == 0 ? (this.wheelRR.rollVelocity *= .995,
        d.r = this.wheelRR.rollVelocity * e) : (d.r = this.wheelRR.dS / d.wheelCirc * je * this.wheelRR.direction,
        this.wheelRR.rollVelocity = d.r / e),
        this.wheelRR.rotation.z = this.wheelRR.rotation.z - d.r)
    }
    updateChassisState(e) {
        d.vecA.copy(n.accel),
        d.vecA.applyAxisAngle(Ws, -this.orientation.y);
        let s = e * 2e3;
        d.vecA.x = Math.min(Math.max(-s, d.vecA.x), s),
        d.vecA.z = Math.min(Math.max(-s, d.vecA.z), s),
        this.chassisAccel.copy(d.vecA),
        L.speedFactor > 1 ? this.speedLerp = Math.min(1, n.speed / (this.tuning.topSpeed * Math.sqrt(L.speedFactor))) : this.speedLerp = Math.min(1, n.speed / this.tuning.topSpeed),
        n.speedLerp = this.speedLerp
    }
    updateAudio(e) {
        this.audioController.update(e),
        this.collisionStrength *= .9,
        this.didCollide = !1
    }
    ...
    updateWheelContact(e) {
        e.contactPoint.copy(this.up).multiplyScalar(e.shockCompression + this.metrics.wheelRadius).add(this.contactDown).add(e.worldPos),
        ce.getGroundState(e.contactPoint.x, e.contactPoint.z, v.vehicleNode, e.groundState, !0),
        ...
        d.vecA.normalize(),
        d.sideFactor = 1,
        e.i % 2 == 0 && (d.vecA.negate(),
        d.sideFactor = -1),
        e.groundHeightLateral = ce.getRoadsideHeight(e.contactPoint.x + this.metrics.wheelWidth * d.vecA.x, e.contactPoint.z + this.metrics.wheelWidth * d.vecA.z, v.vehicleNode),
        e.onRoad && v.vehicleNode.bridge && e.groundHeightLateral < e.groundHeight - .1 && (e.groundHeightLateral = e.groundHeight),
        e.latGroundAngle = Math.atan((e.groundHeight - e.groundHeightLateral) / this.metrics.wheelWidth),
        ...
        d.vecA.y = 0,
        d.vecA.normalize(),
        e.groundHeightLongitudinal = ce.getRoadsideHeight(e.contactPoint.x + this.metrics.wheelWidth * d.vecA.x, e.contactPoint.z + this.metrics.wheelWidth * d.vecA.z, v.vehicleNode),
        e.onRoad && v.vehicleNode.bridge && e.groundHeightLongitudinal < e.groundHeight - .1 && (e.groundHeightLongitudinal = e.groundHeight),
        e.lonGroundAngle = Math.atan((e.groundHeightLongitudinal - e.groundHeight) / this.metrics.wheelWidth),
        ...
        e.shockExcess = 0,
        e.collisionFactor = 0,
        e.shockCompression < 0 ? e.shockCompression = 0 : e.shockCompression > e.travel && (e.shockExcess = e.shockCompression - e.travel,
        e.shockCompression = e.travel,
        this.collidingGround++,
        this.collidingGroundBounce += e.groundState.b,
        d.vecA.copy(e.groundNorm).multiplyScalar(e.shockExcess * e.groundNorm.dot(this.up)),
        ...
        n.isAirborne = n.isAirborne && e.contactPoint.y > e.groundHeight + .1,
        e.shockFactor = e.shockCompression / e.travel,
        e.shockForce = e.shockFactor * this.tuning.shockForce,
        d.ground.w ? (e.wd = d.ground.wd,
        e.wn = d.ground.wn,
        e.ws = d.ground.ws,
        e.wasInsideWall = e.insideWall,
        e.insideWall = e.wd < 0,
        this.collisionsDisabled && (e.wasInsideWall = e.insideWall),
        e.wi == null || e.wi !== d.ground.wi || e.collidingWallEnd ? (e.wi = d.ground.wi,
        e.mayCollide = !0,
        this.wheelsInside[d.ground.wi] == null && (this.wheelsInside[d.ground.wi] = e.insideWall),
        this.wheelsInside[e.wi] !== e.insideWall || e.wd > -this.metrics.collisionMargin && e.wd < this.metrics.collisionMargin ? this.collideWallEnd(e) : e.collidingWallEnd = !1) : (this.wheelsInside[d.ground.wi] == null && (this.wheelsInside[d.ground.wi] = e.insideWall),
        e.collidingWallEnd = !1,
        this.wheelsInside[e.wi] !== e.insideWall && (this.collidingWall = !0,
        this.collideWallEnd(e)),
        e.collidingWallEnd || (e.wasInsideWall == !1 ? e.insideWall = e.wd - this.metrics.collisionMargin < 0 : e.insideWall = e.wd + this.metrics.collisionMargin < 0,
        e.insideWall !== e.wasInsideWall && (this.collisionsDisabled || (e.insideWall = e.wasInsideWall),
        e.insideWall ? (e.wcd = e.wd + this.metrics.collisionMargin,
        e.wcd > 0 && (this.collidingWall = !0,
        this.collidingWallSide = e.ws,
        this.collideWallEdge(e))) : (e.wcd = e.wd - this.metrics.collisionMargin,
        e.wcd < 0 && (this.collidingWall = !0,
        this.collidingWallSide = -e.ws,
        this.collideWallEdge(e))))),
        e.collidingWallEnd = !1,
        e.insideWall = e.wasInsideWall),
        e.wi = d.ground.wi) : (e.wi = null,
        e.insideWall = null,
        e.collidingWallEnd = !1)
    }
    resolveCollisions(e) {
        if (this.didCollidePoint) {
            ...
            if (this.collisionPos.copy(s.pWorldPos).lerp(a.pWorldPos, t),
            ...
            this.reboundVec.multiplyScalar(1.5 - this.speedLerp * .5),
            this.reboundVec.length() < e && this.reboundVec.copy(this.reboundDir).multiplyScalar(e),
            n.position.copy(this.posDir).multiplyScalar(this.posVec.length()).add(this.collisionPos).add(this.reboundVec),
            this.orientation.y -= g,
            this.collisionPos.copy(s.relPos).lerp(a.relPos, t),
            this.applyChassisUpdate(e);
            for (let f of this.wheels)
                this.updateWheelWorldPos(f);
            return !0
        }
        if (this.collidingWheels.length == 1) {
            let s = this.collidingWheels[0];
            this.comVec.copy(s.worldPos).sub(s.collisionVector).sub(n.com).normalize(),
            ...
            n.position.copy(s.relPos).negate().applyEuler(this.orientation).add(s.worldPos),
            this.applyChassisUpdate(e);
            for (let r of this.wheels)
                this.updateWheelWorldPos(r);
            return !0
            ...
            let t = this.preVecDir.dot(this.postVecDir)
              , r = Math.acos(t)
              , c = 1;
            s.comPos.z < 0 && a.comPos.z < 0 ? c *= -1 : s.comPos.z > 0 && a.comPos.z > 0 || s.comPos.x < 0 && a.comPos.x < 0 && (c *= -1);
            let g = (.5 + s.downforce) / (1 + s.downforce + a.downforce)
            ...
            this.collisionPos.copy(s.relPos),
            this.applyChassisUpdate(e);
            for (let x of this.wheels)
                this.updateWheelWorldPos(x);
            return !0
        } else
            return console.warn(this.collidingWheels.length + " colliding wheels"),
            this.reset(),
            !1
    }
    ...
    handleInput(e) {
        if (n.hasBoost = n.hasBoost && (n.hasAccel || n.hasCruiseTarget) && !this.autodrive,
        this.inputs.accel = 0,
        this.inputs.drive = 0,
        this.isDriven = this.autodrive && L.autodriveMode !== q.STEER || n.hasCruiseTarget,
        ...
        Je.isCinecam)
            ...
            if (n.hasBoost = !1,
            I.signal.Forward && this.allowDrive ? (n.hasBoost = !!I.signal.Boost,
            this.isDriven = !0,
            this.hasManualAccel = !0,
            n.direction >= 0 && (this.hasForwardDrive = !0),
            n.hasAccel = !0,
            !n.hasBoost && n.direction < 0 && !this.hasForwardDrive && !I.hasScreenAccel ? (this.setBrake(!0, I.signal.Forward),
            this.hasManualBrake = !0) : (this.inputs.accel = I.signal.Forward * this.tuning.accel,
            this.setBrake(!1),
            this.prevDriveDir = 1),
            this.holdHandbrake = !1) : this.hasForwardDrive = !1,
            I.signal.Backward && this.allowDrive ? (n.hasAccel = !1,
            n.direction <= 0 && !this.braking && (this.hasRearDrive = !0),
            this.isDriven = !0,
            (n.direction > 0 || this.braking && n.speed > 1) && !this.hasRearDrive ? (this.setBrake(!0, I.signal.Backward),
            this.hasManualBrake = !0) : (this.setBrake(!1),
            this.inputs.accel = I.signal.Backward * -this.tuning.accel,
            this.prevDriveDir = -1),
            this.holdHandbrake = !1) : this.hasRearDrive = !1,
            this.isDriven ? this.softBraking && this.setSoftBrake(!1) : (n.hasAccel = !1,
            this.setBrake(!1),
            this.setSoftBrake(!0)),
            this.inputs.stickySteer = I.signal.StickySteer > 0 ? 1 : 0,
            this.inputs.stickySteer && I.signal.Handbrake && !this.inputs.handbrake && (this.holdHandbrake = !0),
            this.inputs.handbrake = I.signal.Handbrake > 0,
            n.hasHandbrake = this.inputs.handbrake || this.holdHandbrake,
            n.hasBoost ? (this.boostFactor = Math.max(0, 1 - this.speedLerp) * 2,
            this.inputs.accel += this.tuning.accel * this.tuning.boostFactor * this.boostFactor) : this.inputs.accel > 0 && this.speedLerp < .5 && (this.inputs.accel += this.tuning.accel * Math.max(0, 1 - this.speedLerp * 2)),
            ...
            n.speed < 1 ? d.slipAngle *= 0 : n.speed < 2 && (d.slipAngle *= n.speed - 1),
            !te.directSteer || !I.hasGamepadInput) {
                d.sl = this.speedLerp * Math.sqrt(L.steerAssist);
                let s = this.slip * Math.abs(I.signal.Left - I.signal.Right) * L.steerAssist
                  , a = Math.max(this.tuning.peakSlipAngle, this.tuning.maxSteer * (1 - d.sl) * (1 + s));
                d.maxSteer = d.maxSteer * .5 + .5 * a,
                d.counterSteerFactor = 0,
                L.steerAssist > .8 && (d.counterSteerFactor = Math.min(1, Math.abs(d.slipAngle) / this.peakSlipAngle) * ((L.steerAssist - .8) / .2) * (.5 + this.spin * .5)),
                d.steerFactor = 1,
                d.vecB.set(0, 0, 1).applyEuler(this.orientation),
                d.steer = d.steerFactor * I.filtered.steer * d.maxSteer - d.slipAngle * Math.sign(n.motionDir.dot(d.vecB)) * d.counterSteerFactor,
                I.hasScreenSteer && (d.steer *= .5),
                this.inputs.steer = Math.min(Math.max(-this.tuning.maxSteer, d.steer), this.tuning.maxSteer)
            } else
                this.inputs.steer = I.filtered.steer * this.tuning.maxSteer;
            this.inputs.accel > 0 && (this.inputs.accel *= L.speedFactor)
        }
        this.autoSteer = 0,
        this.autodrive && (this.autodriver.update(e),
        L.autodriveMode != q.SPEED && (this.autoSteer = this.autodriver.inputs.steer),
        L.autodriveMode != q.STEER && !this.hasManualAccel && !this.hasManualBrake && (this.inputs.accel = this.autodriver.inputs.accel,
        this.inputs.boost = this.autodriver.inputs.boost,
        this.isDriven = !0,
        n.hasBoost = !!this.autodriver.hasBoost,
        n.hasBoost ? this.inputs.accel += this.tuning.accel * Math.max(0, (1 - this.speedLerp) * 2) : this.inputs.accel > 0 && n.speedLerp < .5 && (this.inputs.accel += this.tuning.accel * Math.max(0, (1 - this.speedLerp * 2) * 2)),
        this.prevDriveDir = 1,
        this.autodriver.inputs.brake > 0 ? this.setBrake(!0, this.autodriver.inputs.brake) : this.setBrake(!1))),
        n.hasCruiseTarget && I.signal.Backward == 0 && n.direction > 0 && !n.hasHandbrake && (!this.hasManualAccel || this.useMouse) && (this.prevDriveDir = 1,
        this.inputs.accel = Math.min(this.tuning.accel, Math.max(-this.tuning.reverse, (n.speedControlTarget - n.speed) / e)),
        this.useMouse && this.hasBoost && (this.inputs.accel = this.tuning.accel),
        this.holdHandbrake = !1),
        n.hasSpeedLimit && (this.hasAccel = this.inputs.accel > 0,
        this.inputs.accel = Math.max(-this.tuning.reverse, Math.min(this.inputs.accel, (n.speedControlTarget - n.speed) / e))),
        !n.hasCruiseTarget && (!this.autodrive || L.autodriveMode == q.STEER) && !this.isDriven && n.direction != this.prevDriveDir && n.speed < .1 && (this.holdHandbrake = !0),
    ...
    setBrake(e, s=0) {
        e ? (this.braking || (this.brakeLerp = 0),
        this.braking = !0) : this.braking = !1,
        this.inputs.brake = s
    }
    setGripFactor(e) {
        this.updatePeakSlipAngle()
    ...
    updatePeakSlipAngle() {
        L.gripFactor < 0 ? this.peakSlipAngle = this.tuning.peakSlipAngle / L.gripFactor ** 2 : this.peakSlipAngle = this.tuning.peakSlipAngle / L.gripFactor
    }
    setDriveMode(e) {
        switch (this.driveModeFactor = .5,
    ...
    setAutodrive(e) {
        this.autodrive = e,
        e && (this.autodriver.initialise(),
        this.holdHandbrake = !1,
        n.hasHandbrake = !1)
    }
    collideWallEnd(e) {
        this.collisionsDisabled || (this.didCollide = !0,
        this.fCollision = !0,
    ...
    collideWallEdge(e) {
        ...
        this.collisionStrength = Math.min(1, Math.max(this.collisionStrength, Math.min(1, (1 - Math.abs(d.collDot)) * 5) * e.collisionFactor / 50)),
        this.collidingWheels.push(e),
        e.collisionVector.sub(e.worldPos).negate()
    }
    updateSteerState(e) {
        if (this.steer = this.inputs.steer + this.autoSteer,
        this.steer = Math.min(Math.max(-n.tuning.maxSteer, this.steer), n.tuning.maxSteer),
        d.ts = Math.exp(-e / .1) * (1 - this.tuning.tyreStiffness),
        this.effectiveSteer = this.effectiveSteer * d.ts + this.steer * (1 - d.ts),
        d.sa = Math.sin(this.steer),
        d.ca = Math.cos(this.steer) * this.metrics.wheelBase * 2,
        d.tl = this.metrics.wheelBase * 2 * d.sa / (d.ca - this.metrics.axleWidth * d.sa),
        d.tr = this.metrics.wheelBase * 2 * d.sa / (d.ca + this.metrics.axleWidth * d.sa),
        ...
        this.effectiveSteerL = this.effectiveSteerL * d.ts + d.steerL * (1 - d.ts),
        this.effectiveSteerR = this.effectiveSteerR * d.ts + d.steerR * (1 - d.ts),
        this.steerDifferential = this.metrics.wheelBase / Math.sin(this.effectiveSteerL) / (this.metrics.wheelBase / Math.sin(this.effectiveSteerR)) || 1,
        this.rearSteerDifferential = this.metrics.wheelBase / d.tl / (this.metrics.wheelBase / d.tr) || 1,
        this.tuning.lockDiff && this.slip > 0)
            if (this.slip > .2)
                this.lockDiffOnlyRear || (this.steerDifferential = 1),
                this.rearSteerDifferential = 1;
            else {
                let s = this.smoothLerp(this.slip / .2);
                this.lockDiffOnlyRear || (this.steerDifferential = this.steerDifferential * (1 - s) + s),
                this.rearSteerDifferential = this.rearSteerDifferential * (1 - s) + s
            }
    }
    updateAccelState(e) {
        this.inputs.accel > 0 ? this.drive < this.inputs.accel ? (this.drive += this.tuning.jerk * e,
        this.drive > this.inputs.accel && (this.drive = this.inputs.accel)) : this.drive = this.inputs.accel : this.drive > this.inputs.accel ? (this.drive -= this.tuning.jerk * e * 2,
        this.drive < this.inputs.accel && (this.drive = this.inputs.accel)) : this.drive = this.inputs.accel,
        this.braking && (this.brakeLerp += e / this.tuning.brakeResponse,
        this.brakeLerp > 1 && (this.brakeLerp = 1),
        this.inputs.brake == 0 && this.softBraking && (this.inputs.brake = L.softBrakeForce),
        this.brakeForce = this.inputs.brake * this.tuning.brake * this.brakeLerp),
        this.powerLerp = Math.min(1, n.speed / (this.tuning.topSpeed * L.speedFactor))
    }
    halfLerp(e) {
        return e = e / 2 + .5,
        ((3 - e * 2) * e * e - .5) * 2
...
const Bd = Math.PI * .75
  ...
  , ut = class ut extends Oi {
    constructor() {
        ...
        o(this, "scMode", 0);
        o(this, "scTarget", 20);
        o(this, "scTargetProp", .5);
        o(this, "handleSpeedControl", () => {
            this.scActive = V.speedControl,
            this.scActive && (this.scMode = V.speedControlMode == bs.Cruise ? "CRUISE" : "LIMIT",
            this.scTargetProp = V.speedControlTargetMS / (n.tuning.topSpeed * 1.1))
        }
        );
        o(this, "autodriveLabel", "DRIVE");
        o(this, "onAutodriveMode", e => {
            e == q.FULL ? this.autodriveLabel = "AUTODRIVE" : e == q.SPEED ? this.autodriveLabel = "AUTOSPEED" : e == q.STEER && (this.autodriveLabel = "AUTOSTEER")
        }
        );
    ...
    async init() {
        this.elementsToLoad > 0 && se.add("VEHICLE: Attempting to load new vehicle before prev initialisation has completed");
        for (let s in this.maps)
            W.setMapForMaterial(s, this.maps[s]);
        W.windscreen.color.setHex(5596791),
        W.metal.color.setHex(16777215),
        W.metal.specular.setHex(16777215);
        const e = new Oa;
        pe.body ? (n.container.add(pe.body),
        this.exteriorObjects.body = pe.body) : (this.elementsToLoad++,
        e.load(this.geometry.body, s => {
            let a = s.scene;
            a.traverse(t => {
                t.isMesh && (t.material = W.getMaterialByName(t.name),
        ...
        pe.wheel ? this.wheelObj = pe.wheel : (this.elementsToLoad++,
        e.load(this.geometry.wheel, s => {
            ...
            a.traverse(t => {
                ...
                t.scale.set(this.metrics.wheelRadius, this.metrics.wheelRadius, this.metrics.wheelRadius))
            }
            ),
            this.wheelObj = a,
            a.frustumCulled = !1,
        ...
        pe.interior ? (n.container.add(pe.interior),
        this.interiorObjects.interior = pe.interior) : (this.elementsToLoad++,
        ...
        pe.dash ? (n.container.add(pe.dash),
        ...
        this.powerGradient = Ie.powerGradient) : (this.elementsToLoad++,
            ...
            a.traverse(t => {
                if (t.isMesh)
                    if (t.name == "coach_dashboard_screen") {
                        ...
                        this.wormGradient.addColorStop(.2, "#f4f2edff"),
                        this.wormGradient.addColorStop(1, "#f4f2ed00"),
                        this.speedGradient = c.createConicGradient(Bd - .01, It, ht),
                        this.speedGradient.addColorStop(0, "rgb(10, 105, 164)"),
                        this.speedGradient.addColorStop(.3, "rgb(55, 192, 255)"),
                        this.speedGradient.addColorStop(.5, "rgb(230, 205, 107)"),
                        this.speedGradient.addColorStop(.6, "rgb(225, 120, 45)"),
                        this.powerGradient = c.createConicGradient(Gs - .01, Qt, ht),
                        this.powerGradient.addColorStop(0, "rgb(23, 161, 60)"),
                        this.powerGradient.addColorStop(.25, "rgb(90, 197, 88)"),
                        this.powerGradient.addColorStop(.5, "rgb(245, 207, 55)"),
                        this.powerGradient.addColorStop(.6, "rgb(225, 51, 45)");
                        let f = new K({
                            map: g,
                            emissiveMap: g,
                            emissive: 16777215,
        ...
        pe.steer ? (n.container.add(pe.steer),
        this.interiorObjects.steeringWheel = pe.steer) : (this.elementsToLoad++,
    ...
    setDriverSide(e) {
        this.ready && (e == Na.LEFT ? (this.interiorObjects.interior.scale.z = -1,
        this.interiorObjects.steeringWheel.position.z = -this.layout.steeringWheelPos.z,
        this.interiorObjects.dash.position.z = -this.layout.dashPos.z) : (this.interiorObjects.interior.scale.z = 1,
        this.interiorObjects.steeringWheel.position.z = this.layout.steeringWheelPos.z,
    ...
    updateInteriorVisibility() {
        if (this.ready) {
            ...
            this.interiorObjects.steeringWheel.visible = this.interiorObjects.steeringWheel.visible && n.showSteeringWheel;
            for (let e in this.exteriorObjects)
                this.exteriorObjects[e].visible = !n.isInterior
        }
    }
    updateVisuals() {
        this.ready && (n.isInterior && this.updateDashScreen(),
        n.inAutodrive ? this.interiorObjects.steeringWheel.rotation.x = this.interiorObjects.steeringWheel.rotation.x * .9 + L.wheelRotation / 2 * Math.D2R * (-this.steer / this.tuning.maxSteer) * .1 : this.interiorObjects.steeringWheel.rotation.x = L.wheelRotation / 2 * Math.D2R * (-this.steer / this.tuning.maxSteer),
    ...
    updateWormPoints() {
        ...
        this.wormPoints.length = 0,
        this.wormPointsRight.length = 0;
        let f = s.a - s.da * e;
        if (this.wormTargetAngle == null)
            this.wormTargetAngle = -(f + Math.HALFPI);
        else {
            let S = -(s.a + Math.HALFPI);
            S - this.wormTargetAngle < -Math.PI ? this.wormTargetAngle -= Math.TAU : S - this.wormTargetAngle > Math.PI && (this.wormTargetAngle += Math.TAU),
            this.wormTargetAngle = this.wormTargetAngle * .9 + .1 * -(f + Math.HALFPI)
        }
        ...
        for (; s.i !== g; ) {
            ...
            let T = C * x - k * w
              , P = C * w + k * x
              , B = 40 + -P / 90 * 30;
            if (Math.abs(T) > B || P < -66)
                break;
            this.wormPoints.push([T + c.x, P + c.y]),
            s = s.next
        }
        this.seenIndex = v.vehicleIndex
    }
    updateDashScreen() {
        if (this.doUpdateScreen = !this.doUpdateScreen,
        !this.doUpdateScreen)
            return;
        let e = this.dashCanvasCtx;
        if (e.clearRect(0, 0, 512, 200),
        ...
        e.beginPath(),
        e.lineWidth = 8;
        let t = this.autodrive && L.autodriveMode !== q.STEER ? this.autodriver.inputs.accel / n.tuning.accel : 0
          , r = 0;
        n.direction > 0 ? r = Math.max(0, I.signal.Forward - I.signal.Backward) : r = Math.max(0, I.signal.Backward - I.signal.Forward) * .33;
        let c = 0;
        n.hasCruiseTarget && (c = this.inputs.accel / this.tuning.accel);
        let g = Math.min(1, Math.max(t, r, c));
        if (I.signal.Forward > this.dashPower ? this.dashPower = this.dashPower * .8 + .2 * g : this.dashPower = this.dashPower * .9 + .1 * g,
        this.dashPower < .01 && (this.dashPower = 0),
        e.arc(Qt, ht, Vs, Gs, Gs + this.dashPower * sr),
        e.strokeStyle = n.hasBoost ? "rgb(225, 51, 45)" : this.powerGradient,
        e.stroke(),
        n.hasBoost ? e.drawImage(Ee.boost, Qt - 18, ht - 18, 36, 36) : e.drawImage(Ee.boostLine, Qt - 18, ht - 18, 36, 36),
        this.scActive) {
            e.globalAlpha = ar,
            e.font = "12px Sono",
            e.fillStyle = ai,
            ...
            e.arc(It, ht, Vs, N - .025, N + .025),
            e.strokeStyle = ai,
            e.stroke()
        }
        this.hasAutodrive && (e.globalAlpha = ar,
        e.font = "12px Sono",
        e.fillStyle = ai,
        e.textAlign = "center",
        e.textBaseline = "middle",
...
o(ut, "cameras", {
    ...
    FirstPerson: {
        ...
        posOffset: [6.25, 1.52, .683],
        seatOffsets: [[1.9, 2.1, .85], [-1.4, 2.1, 0], [5.5, 2.1, -.85]],
        pitch: {
            near: .02,
            far: .02
        },
...
let da = ut;
const zd = "" + new URL("../assets/coupe_main.46096b3a.glb",import.meta.url).href
  , Wd = "" + new URL("../assets/coupe_interior.60e5599c.glb",import.meta.url).href
  , Gd = "" + new URL("../assets/coupe_dash.34d225ab.glb",import.meta.url).href
  , Vd = "" + new URL("../assets/coach_dash_map.74f3bfb1.webp",import.meta.url).href
  ...
  , Xd = "" + new URL("../assets/coupe_interior_map.8845aaf1.webp",import.meta.url).href
  , Yd = "" + new URL("../assets/coupe_window.2879fa2c.webp",import.meta.url).href
  , Ae = {}
  , Fe = {}
  , ji = {
    steerAssist: .8,
...
const qd = Math.PI * .75
  ...
  , Dt = class Dt extends Oi {
    ...
    async init() {
        ...
        W.metal.specular.setHex(16777215);
        const e = new Oa;
        Ae.body ? (n.container.add(Ae.body),
        this.exteriorObjects.body = Ae.body) : (this.elementsToLoad++,
        e.load(this.geometry.body, s => {
            let a = s.scene;
            a.traverse(t => {
                t.isMesh && (t.material = W.getMaterialByName(t.name),
        ...
        Ae.wheel ? this.wheelObj = Ae.wheel : (this.elementsToLoad++,
        e.load(this.geometry.wheel, s => {
            let a = s.scene;
            a.traverse(t => {
                t.isMesh && (t.material = W.getMaterialByName(t.name),
        ...
        Ae.interior ? (n.container.add(Ae.interior),
        this.interiorObjects.interior = Ae.interior) : (this.elementsToLoad++,
        e.load(this.geometry.interior, s => {
            let a = s.scene;
            W.setOnObject(a),
            n.container.add(a),
        ...
        Ae.dash ? (n.container.add(Ae.dash),
        ...
        this.powerGradient = Fe.powerGradient) : (this.elementsToLoad++,
        e.load(this.geometry.dash, s => {
            let a = s.scene;
            a.traverse(t => {
                if (t.isMesh)
                    if (t.name == "coupe_dashboard_screen") {
                        ...
                        this.wormGradient.addColorStop(.2, "#f4f2edff"),
                        this.wormGradient.addColorStop(1, "#f4f2ed00"),
                        this.speedGradient = c.createConicGradient(qd - .01, _t, dt),
                        this.speedGradient.addColorStop(0, "rgb(10, 105, 164)"),
                        this.speedGradient.addColorStop(.3, "rgb(55, 192, 255)"),
                        this.speedGradient.addColorStop(.5, "rgb(230, 205, 107)"),
                        this.speedGradient.addColorStop(.6, "rgb(225, 120, 45)"),
                        this.powerGradient = c.createConicGradient(Zs - .01, Yt, dt),
                        this.powerGradient.addColorStop(0, "rgb(23, 161, 60)"),
                        this.powerGradient.addColorStop(.25, "rgb(90, 197, 88)"),
                        this.powerGradient.addColorStop(.5, "rgb(245, 207, 55)"),
                        this.powerGradient.addColorStop(.6, "rgb(225, 51, 45)");
        ...
        Ae.steer ? (n.container.add(Ae.steer),
        this.interiorObjects.steeringWheel = Ae.steer) : (this.elementsToLoad++,
        e.load(this.geometry.steer, s => {
            let a = s.scene;
            W.setOnObject(a),
            a.rotation.order = "YZX",
    ...
    updateInteriorVisibility() {
        if (this.ready) {
            for (let e in this.interiorObjects)
                this.interiorObjects[e].visible = n.isInterior;
            this.interiorObjects.steeringWheel.visible = this.interiorObjects.steeringWheel.visible && L.showWheel;
            for (let e in this.exteriorObjects)
                this.exteriorObjects[e].visible = !n.isInterior
        }
    }
    updateVisuals() {
        this.ready && (n.isInterior && this.updateDashScreen(),
        n.inAutodrive ? this.interiorObjects.steeringWheel.rotation.x = this.interiorObjects.steeringWheel.rotation.x * .8 + L.wheelRotation / 2 * Math.D2R * (-this.steer / this.tuning.maxSteer) * .2 : this.interiorObjects.steeringWheel.rotation.x = L.wheelRotation / 2 * Math.D2R * (-this.steer / this.tuning.maxSteer),
        W.setBrakeLights(this.braking, this.softBraking))
    }
    updateWormPoints() {
        let e = ja(n.position.x, n.position.z, v.vehicleNode)
    ...
    updateDashScreen() {
        ...
        let g = Math.min(1, Math.max(t, r, c));
        if (I.signal.Forward > this.dashPower ? this.dashPower = this.dashPower * .8 + .2 * g : this.dashPower = this.dashPower * .9 + .1 * g,
        this.dashPower < .01 && g < .01 && (this.dashPower = 0),
        e.arc(Yt, dt, Qs, Zs, Zs + this.dashPower * rr),
        e.strokeStyle = n.hasBoost ? "rgb(225, 51, 45)" : this.powerGradient,
        e.stroke(),
        n.hasBoost ? e.drawImage(Ne.boost, Yt - 18, dt - 18, 36, 36) : e.drawImage(Ne.boostLine, Yt - 18, dt - 18, 36, 36),
        this.scActive) {
            e.globalAlpha = nr,
            e.font = "12px Sono",
            e.fillStyle = oi,
            ...
            e.lineWidth = 18;
            let N = s + this.scTargetProp * Math.PI * 1.25;
            e.arc(_t, dt, Qs, N - .025, N + .025),
            e.strokeStyle = oi,
            e.stroke()
        }
        this.hasAutodrive && (e.globalAlpha = nr,
        e.font = "12px Sono",
        e.fillStyle = oi,
        e.textAlign = "center",
        e.textBaseline = "middle",
...
class nc extends Xa {
        ...
        for (let s of this.interiorSounds.wheels)
            for (let a in s)
                if (s[a].length)
                    ...
                    s[a].removeFromParent();
        this.interiorSounds.wheels.length = 0,
        this.loadWheelSounds(new m(this.vc.metrics.wheelBase,this.vc.metrics.wheelRadius,0), {
            roll: e.roll,
            skid: e.skid,
            sus: e.suspension
        }, this.vc.name + "_wheel"),
    ...
    updateEngine(e, s) {
        ...
        this.accelPower = .4 + Math.abs(s.accel) / (this.vc.tuning.speedFactor * this.vc.tuning.accel) * .6,
        n.hasBoost && s.accel != 0 ? this.boostV = this.boostV * .9 + .1 : this.boostV *= .95,
        this.boostA = this.boostV * (1 - this.vc.speedLerp * .5),
        this.speedTarget = Math.min(n.speed, this.vc.tuning.topSpeed + 10) / 15 + 1.5,
        this.lerpTarget = this.lerpTarget * .95 + this.speedTarget * .05,
        s.accel != 0 && Math.sign(s.accel) == n.direction) {
            ...
            this.vol += e * 2,
            this.vol = Math.min(1, this.vol, this.accelPower),
            this.engineRate = .1 + this.lerpTarget * .7,
            a.setPlaybackRate(this.engineRate + this.boostA * .2),
            this.t1 = (1 - this.smoothstep(this.vol)) * hr;
            let r = this.t1 * this.interiorVol * Me.engine + this.boostA * .2;
            a.setVolume(r * (1 - this.vc.speedLerp * .5)),
            t.setPlaybackRate(this.engineRate * 1.4 + this.boostA * .5),
            t.setVolume(r * (.5 - .3 * this.vc.speedLerp + this.boostA * .2))
        } else if (this.vol > 0) {
            this.decel == !1 && (this.lerpTarget -= .05),
            this.decel = !0,
            this.vol -= e,
            ...
            let r = this.t1 * this.interiorVol * Me.engine + this.boostA * .2;
            a.setVolume(r * (1 - this.vc.speedLerp * .5)),
            t.setPlaybackRate(this.engineRate * 1.4 + this.boostA * .4),
            t.setVolume(r * (.5 - .3 * this.vc.speedLerp + this.boostA * .2))
        } else
            a.setVolume(0),
            t.setVolume(0)
    ...
    updateWheels(e) {
        let s = Math.max(0, Math.min(1, this.vc.speedLerp - .01)) * oc * Me.roll
          , a = this.sounds.wheels[0];
        ie.lat = Math.max(Math.abs(this.wR.latDirDot), Math.abs(this.wF.latDirDot)),
        ie.speed = Math.max(this.wR.speed, this.wF.speed),
        ie.wheelVol = Math.max(0, Math.min(1, ((Math.abs(ie.lat) - .05) * ie.speed - 2) / 4)),
        this.wR.locked && this.wR.shockFactor > .1 && (ie.wheelVol = Math.max(ie.wheelVol, Math.min(1, (Math.abs(this.wR.lonDirDot * this.wR.speed) - 2) / 4))),
        ie.wheelVol > 0 ? this.wheelSoundFactor = this.wheelSoundFactor * .95 + .05 * ie.wheelVol : this.wheelSoundFactor = this.wheelSoundFactor * .8,
        ie.contact = Math.min(1, Math.max(this.wR.shockFactor, this.wR.shockFactor) * 4),
        this.wheelSoundFactor *= ie.contact,
        ie.surface = this.wR.groundState.s,
        this.wheelSurface != ie.surface && (a.skid[this.wheelSurface].setVolumeStoppable(0),
        a.roll[this.wheelSurface].setVolumeStoppable(0),
        this.wheelSurface = ie.surface),
        a.roll[ie.surface].isPlaying || (a.roll[ie.surface].play(),
        a.skid[ie.surface].play()),
        ie.contact == 0 ? a.roll[ie.surface].setVolume(.01) : a.roll[ie.surface].setVolume(s),
        ...
        if (t < .5)
            ...
            let r = Math.min(1, (t - .5) * 2);
            r > ie.sus && (ie.sus = ie.sus * .5 + .5 * r)
        }
        a.sus.setVolume(ie.sus * ac * this.interiorVol * Me.roll)
    }
    updateBoost() {
        if (this.boostV = 0,
        !n.isAirborne && n.hasAccel && n.hasBoost) {
            let e = 1 - this.vc.accelLerp;
            this.boostV = .3 + e * .7,
            this.boostT = this.boostT * .9 + .1 * e,
            e = 1 + (1 - e) / 2,
            this.sounds.boost.setPlaybackRate(1 + e * 5)
        } else
            this.boostT *= .95;
        this.boostV = this.boostV * sc * this.accelPower * this.interiorVol * Me.engine,
        this.boostV > 1 && (this.boostV = 1),
        this.sounds.boost.setVolumeStoppable(this.boostV)
    }
    updateBrakes() {
        ...
        this.brakeT = this.brakeT * .9 + .1 * Math.min(1, Math.max(0, (n.speed - 30) / 40)),
        this.sounds.brake.setPlaybackRate(1),
        this.sounds.brake.setVolumeStoppable(this.brakeT * ic * this.vc.brakeLerp * this.interiorVol * Me.brakes)
    }
    loadWheelSounds(e, s, a) {
        ...
        for (let S = 0; S < ls.length; S++) {
            let D = ls[S];
            this.loadStatus.count++,
            De.getPositionalAudio(s.roll[D].ext, C => {
                t === this.loadIndex && this.onWheelSoundLoaded(C, r, "roll", S, e)
            }
            , (g = r.roll) == null ? void 0 : g[S], a + "_roll_ext_" + D),
            this.loadStatus.count++,
            De.getPositionalAudio(s.roll[D].int, C => {
                t === this.loadIndex && this.onWheelSoundLoaded(C, c, "roll", S, e)
            }
            , (f = c.roll) == null ? void 0 : f[S], a + "_roll_int_" + D),
            this.loadStatus.count++,
            De.getPositionalAudio(s.skid[D].ext, C => {
                t === this.loadIndex && this.onWheelSoundLoaded(C, r, "skid", S, e)
            }
            , (x = r.roll) == null ? void 0 : x[S], a + "_skid_ext_" + D),
            this.loadStatus.count++,
            De.getPositionalAudio(s.skid[D].int, C => {
                t === this.loadIndex && this.onWheelSoundLoaded(C, c, "skid", S, e)
            }
            , (w = c.roll) == null ? void 0 : w[S], a + "_skid_int_" + D)
        }
        this.loadStatus.count++,
        De.getPositionalAudio(s.sus, S => {
            t === this.loadIndex && (r.sus && (r.sus.stop(),
            r.sus.removeFromParent(),
            delete r.sus),
            r.sus = S,
            c.sus = S,
            S.setLoop(!0),
            S.setLoopStart(.1),
            S.setLoopEnd(S.buffer.duration - .1),
            S.setRefDistance(.5),
...
class Fi extends Ke {
    ...
    setPose(e, s, a, t) {
        ...
        this.orientation.z = 0,
        s = ce.getRoadsideHeight(e, a, v.vehicleNode),
        M.vecA.set(e + Math.cos(t) * this.metrics.wheelBase, s, a + Math.sin(t) * this.metrics.wheelBase);
        ...
        this.wheelF.contactPoint.copy(this.forward).multiplyScalar(this.metrics.wheelBase).add(this.wheelR.contactPoint),
        ...
        this.groundAngle = Math.asin((this.wheelF.groundPoint.y - this.wheelR.groundPoint.y) / this.wheelF.groundPoint.distanceTo(this.wheelR.groundPoint)),
        this.groundOrientation.x = 0,
        this.groundOrientation.y = this.orientation.y,
        this.groundOrientation.z = this.groundAngle,
        this.groundUp.set(0, 1, 0).applyEuler(this.groundOrientation),
        ...
        this.contactUp.copy(this.groundUp).multiplyScalar(this.metrics.wheelRadius),
        this.contactDown.copy(this.contactUp).negate(),
        this.wheelR.worldPos.copy(this.down).multiplyScalar(this.wheelR.shockCompression).add(this.wheelR.contactPoint),
        this.wheelR.pWorldPos.copy(this.wheelR.worldPos),
        this.wheelF.worldPos.copy(this.down).multiplyScalar(this.wheelF.shockCompression).add(this.wheelF.contactPoint),
        this.wheelF.pWorldPos.copy(this.wheelF.worldPos),
        this.orientation.z = Math.tan((this.wheelF.worldPos.y - this.wheelR.worldPos.y) / this.metrics.wheelBase),
        this.tiltZ = this.orientation.z,
        n.pitch = this.tiltZ,
        this.sinTiltZ = Math.sin(this.tiltZ),
        this.cosTiltZ = Math.cos(this.tiltZ),
    ...
    updateKinematics(e) {
        ...
        for (let t of this.wheels)
            ...
            t.speed = t.velocity.length(),
            t.dS = t.speed * e * Math.abs(t.lonDirDot),
            t.shockFactor < .1 ? t.tDownforce = t.shockFactor / .1 * .95 : t.tDownforce = .95 + (t.shockFactor - .1) / .9 * .05,
            t.dDownforce = t.tDownforce - t.downforce,
            t.dDownforce < 0 && (t.dDownforce = Math.max(t.dDownforce / e, -lc) * e),
            t.downforce += t.dDownforce,
            t.gforce = t.shockForce * Math.cos(t.latGroundAngle - this.tiltX),
            M.latForce = 0,
            t.accel.set(0, 0, 0),
            t.front ? (M.vecA.set(1, 0, 0).applyEuler(this.steerOrientation),
            t.lonDirDot = t.velocityDir.dot(M.vecA),
            t.direction = t.lonDirDot < 0 ? -1 : 1,
            t.latDirDot = t.velocityDir.dot(t.flatRight)) : (M.vecA.set(1, 0, 0).applyEuler(this.orientation),
            t.lonDirDot = t.velocityDir.dot(M.vecA),
            t.direction = t.lonDirDot < 0 ? -1 : 1,
            t.latDirDot = t.velocityDir.dot(t.flatRight)),
            t.traction = t.downforce * Math.min(1, t.groundState.f * this.tuning.tyreFriction) * t.cosLonGroundAngle,
            t.locked = !t.front && n.hasHandbrake,
            t.locked ? (M.maxLon = this.metrics.wheelMass * t.downforce * t.groundState.f * this.tuning.tyreFriction * this.tuning.lonFrictionFactor,
            M.lon = t.lonDirDot * t.speed / e,
            M.lonAbs = Math.abs(M.lon),
            t.lonSlip = 0,
            M.lonAbs > M.maxLon && (M.maxLon = this.metrics.wheelMass * t.downforce * (t.groundState.f * this.tuning.tyreFriction) * this.tuning.kineticFrictionFactor * this.tuning.lonFrictionFactor,
            M.lon < 0 ? M.lon = Math.max(M.lon, -M.maxLon) : M.lon = Math.min(M.lon, M.maxLon),
            t.lonSlip = Math.abs(t.lonDirDot)),
            t.static = t.lonSlip == 0,
            t.accel.x -= M.lon) : (t.static = !1,
            t.accel.x -= Math.min(this.tuning.rollResistance, t.speed / e) * t.traction * t.lonDirDot),
            M.lat = t.latDirDot * t.speed / e * t.downforce,
            M.maxLat = this.metrics.wheelMass * t.downforce * t.groundState.f * this.tuning.tyreFriction,
            M.latAbs = Math.abs(M.lat),
            M.latAbs > M.maxLat ? (M.maxLat = this.metrics.wheelMass * t.downforce * (t.groundState.f * this.tuning.tyreFriction) * this.tuning.kineticFrictionFactor,
            t.slip = Math.abs(t.latDirDot) * t.downforce,
            M.lat < 0 ? M.lat = Math.max(M.lat, -M.maxLat) : M.lat = Math.min(M.lat, M.maxLat)) : t.slip = 0,
            t.latForce = -M.lat,
            t.traction *= 1 - t.slip,
            this.braking && (t.accel.x = -t.lonDirDot * this.brakeForce * t.traction);
        ...
        this.wheelR.shockVel = (this.wheelR.shockCompression - this.wheelR.pShockCompression) / this.pdT,
        this.wheelR.pShockCompression = this.wheelR.shockCompression,
        this.wheelR.accel.y += this.tuning.damping * this.wheelR.shockVel,
        this.wheelR.accel.y -= this.chassisAccel.x / e * (this.chassisAccel.x > 0 ? this.tuning.rockFactorRear * this.wheelR.traction : this.tuning.rockFactorFront * this.wheelF.traction),
        this.wheelR.accel.y -= n.speed ** 2 * this.tuning.aeroFactor * this.cosTiltZ,
        ...
        M.vecA.copy(this.wheelR.velocityDir).negate().multiplyScalar(this.tuning.drag * this.wheelR.speed * this.wheelR.speed),
        this.wheelR.contactPoint.y < ce.seaLevel - .05 && M.vecA.multiplyScalar(.5 / this.tuning.drag),
        this.wheelR.accel.add(M.vecA),
        this.wheelR.accel.multiplyScalar(e),
        this.wheelR.velocity.add(this.wheelR.accel),
        this.wheelR.static && (this.wheelR.velocity.x = 0,
        this.wheelR.velocity.z = 0),
        this.wheelR.worldPos.copy(this.wheelR.velocity).multiplyScalar(e).add(this.wheelR.pWorldPos),
        this.wheelR.tPos.copy(this.up).multiplyScalar(this.metrics.wheelRadius + this.wheelR.shockCompression).add(this.wheelR.worldPos),
        this.drive > 0 || n.direction < 0 ? this.wheelF.accel.x += this.drive * this.wheelR.traction : this.wheelF.accel.x += this.drive * this.wheelF.traction,
        this.wheelF.accel.y -= this.wheelF.shockForce * xe,
        this.wheelF.shockVel = (this.wheelF.shockCompression - this.wheelF.pShockCompression) / this.pdT,
        this.wheelF.pShockCompression = this.wheelF.shockCompression,
        this.wheelF.accel.y += this.tuning.damping * this.wheelF.shockVel,
        this.wheelF.accel.y += this.chassisAccel.x / e * (this.chassisAccel.x > 0 ? this.tuning.rockFactorFront * this.wheelR.traction : this.tuning.rockFactorRear * this.wheelF.traction),
        this.wheelF.accel.y -= n.speed ** 2 * this.tuning.aeroFactor * this.cosTiltZ,
        this.wheelF.accel.y > 0 && this.wheelF.downforce < .2 && this.wheelR.downforce > .5 && this.wheelR.direction > 0 && this.drive > 0 && (this.wheelF.accel.y -= xe * this.speed * Math.abs(this.wheelR.lonDirDot) * .001 * this.drive * this.wheelR.traction),
        this.wheelF.accel.applyEuler(this.steerOrientation),
        this.wheelF.accel.y += xe,
        M.vecA.copy(this.wheelF.velocityDir).negate().multiplyScalar(this.tuning.drag * this.wheelF.speed * this.wheelF.speed),
        this.wheelF.contactPoint.y < ce.seaLevel - .05 && M.vecA.multiplyScalar(.5 / this.tuning.drag),
        ...
        this.wheelR.static && (this.wheelF.velocity.x = 0,
        this.wheelF.velocity.z = 0),
        this.wheelF.worldPos.copy(this.wheelF.velocity).multiplyScalar(e).add(this.wheelF.pWorldPos),
        this.wheelF.tPos.copy(this.up).multiplyScalar(this.metrics.wheelRadius + this.wheelF.shockCompression).add(this.wheelF.worldPos),
        M.collDenom = this.wheelR.traction + this.wheelR.collisionFactor + this.wheelF.traction + this.wheelF.collisionFactor,
        M.frontAuthority = 0,
        M.collDenom > 0 && (M.frontAuthority = (this.wheelF.traction + this.wheelF.collisionFactor) / M.collDenom),
        this.wheelR.traction + this.wheelF.traction == 0 && (M.frontAuthority = .5),
        this.wheelR.collisionFactor == 0 && this.wheelF.collisionFactor == 0 && (M.frontAuthority = .4 + .2 * M.frontAuthority),
        ...
        M.vecB.copy(M.vecA).normalize().multiplyScalar(M.offset * M.frontAuthority),
        ...
        M.heading = Math.atan2(this.wheelR.worldPos.z - this.wheelF.worldPos.z, this.wheelF.worldPos.x - this.wheelR.worldPos.x),
        this.dHeading = M.heading - this.orientation.y,
        this.dHeading < -Math.PI ? (this.dHeading += ri,
        this.orientation.y -= ri) : this.dHeading > Math.PI && (this.dHeading -= ri,
        this.orientation.y += ri),
        ...
        this.targetLean = s;
        let a = 1 - Math.exp(-e / ((1 - Math.max(.01, this.speedLerp)) * .15));
        this.tiltX = this.tiltX * (1 - a) + this.targetLean * a,
        this.orientation.x = this.tiltX * .8,
        n.roll = this.orientation.x,
        this.sinTiltX = Math.sin(this.tiltX),
        this.cosTiltX = Math.cos(this.tiltX),
        M.tiltZ = Math.asin((this.wheelF.worldPos.y - this.wheelR.worldPos.y) / M.d),
        M.dTiltZ = M.tiltZ - this.tiltZ,
        M.tiltZ > this.tiltZ && this.tiltZ > 1 ? M.dTiltZ *= 1 - (this.tiltZ - 1) / .5 : M.tiltZ < this.tiltZ && this.tiltZ < -1 && (M.dTiltZ *= (1 + this.tiltZ) / -.5),
        this.tiltZ += M.dTiltZ,
        ...
        this.down.copy(this.up).negate(),
        this.forward.set(1, 0, 0).applyEuler(this.orientation),
        this.orientationFlat.set(this.wheelR.latGroundAngle, this.orientation.y, this.orientation.z),
        this.steerOrientationFlat.set(this.wheelF.latGroundAngle, this.steerOrientation.y, this.steerOrientation.z),
        this.wheelR.flatRight.set(0, 0, 1).applyEuler(this.orientationFlat),
        this.wheelF.flatRight.set(0, 0, 1).applyEuler(this.steerOrientationFlat),
        ...
        n.forwardDir.copy(this.forward),
        n.midPosition.set((n.position.x + n.forwardPosition.x) / 2, (n.position.y + n.forwardPosition.y) / 2, (n.position.z + n.forwardPosition.z) / 2),
        n.cockPosition.copy(n.midPosition).lerp(n.forwardPosition, .4),
        n.setRotationFromEuler(this.orientation);
        try {
            n.updateMatrix(),
            n.updateMatrixWorld()
        ...
        this.updateWheelWorldPos(this.wheelR),
        this.updateWheelWorldPos(this.wheelF),
        this.straddlingWall = this.wheelR.insideWall == !1 && this.wheelF.insideWall == !0 || this.wheelR.insideWall == !0 && this.wheelF.insideWall == !1,
        this.collisionsDisabled = this.collisionsDisabled && (this.collidingWall || this.straddlingWall),
        this.collidingWall = !1,
        n.isAirborne = !0,
        this.collidingGround = 0,
        this.collidingGroundBounce = 0,
    ...
    updateWheelContact(e, s) {
        ...
        e.onRoad = M.ground.r,
        e.groundHeightLateral = ce.getRoadsideHeight(e.contactPoint.x + this.metrics.wheelContactWidth * e.flatRight.x, e.contactPoint.z + this.metrics.wheelContactWidth * e.flatRight.z, v.vehicleNode),
        e.onRoad && v.vehicleNode.bridge && e.groundHeightLateral < e.groundHeight - .1 && (e.groundHeightLateral = e.groundHeight),
        e.latGroundAngle = Math.atan((e.groundHeight - e.groundHeightLateral) / this.metrics.wheelContactWidth),
        e.sinLatGroundAngle = Math.sin(e.latGroundAngle),
        e.cosLatGroundAngle = Math.cos(e.latGroundAngle),
        M.vecA.copy(this.forward),
        M.vecA.y = 0,
        M.vecA.normalize(),
        e.groundHeightLongitudinal = ce.getRoadsideHeight(e.contactPoint.x + this.metrics.wheelContactWidth * M.vecA.x, e.contactPoint.z + this.metrics.wheelContactWidth * M.vecA.z, v.vehicleNode),
        e.onRoad && v.vehicleNode.bridge && e.groundHeightLongitudinal < e.groundHeight - .1 && (e.groundHeightLongitudinal = e.groundHeight),
        e.lonGroundAngle = Math.atan((e.groundHeightLongitudinal - e.groundHeight) / this.metrics.wheelContactWidth),
        e.cosLonGroundAngle = Math.cos(e.lonGroundAngle),
        e.groundOrientation.x = e.latGroundAngle,
        e.groundOrientation.y = this.orientation.y,
        e.groundOrientation.z = e.lonGroundAngle,
        ...
        this.collidingGroundBounce += e.groundState.b,
        e.collisionFactor = 1,
        M.vecA.copy(e.groundNorm).multiplyScalar(e.shockExcess * e.groundNorm.dot(this.up)),
        ...
        M.ground.w ? (e.wd = M.ground.wd,
        e.wn = M.ground.wn,
        e.ws = M.ground.ws,
        (e.wi == null || e.wi !== M.ground.wi || e.collidingWallEnd) && (Math.abs(e.wd) < this.metrics.collisionMargin || e.wd > 0 && e.insideWall) ? this.collideWallEnd(e) : e.insideWall !== null && !e.collidingWallEnd ? e.insideWall ? (e.wcd = e.wd + this.metrics.collisionMargin,
        e.wcd > 0 && (this.collidingWall = !0,
        this.collidingWallSide = e.ws,
        this.collideWallEdge(e))) : (e.wcd = e.wd - this.metrics.collisionMargin,
        e.wcd < 0 && (this.collidingWall = !0,
        this.collidingWallSide = -e.ws,
        this.collideWallEdge(e))) : e.collidingWallEnd = !1,
        e.wi = M.ground.wi,
        e.insideWall = e.wd < 0) : (e.wi = null,
        e.insideWall = null,
        e.collidingWallEnd = !1),
        e.position.y = e.axlePos.y + e.shockCompression,
        e.front ? e.position.x = e.axlePos.x - e.shockCompression * this.metrics.frontWheelTilt : e.position.x = e.axlePos.x + e.shockCompression * this.metrics.rearWheelTilt
    }
    updateVisuals(e) {}
    updateLoad() {}
    updateWheelsPost(e) {
        ...
        this.inputs.handbrake || (this.wheelR.rotation.z = this.wheelR.rotation.z - M.r)
    }
    updateChassisState(e) {
    ...
    handleInput(e) {
        n.hasBoost = n.hasBoost && (n.hasAccel || n.hasCruiseTarget) && !this.autodrive,
        this.inputs.accel = 0,
        this.inputs.drive = 0,
        ...
        this.hasManualBrake = !1,
        this.steer = 0,
        Je.isCinecam ? (this.inputs.handbrake = I.signal.Handbrake > 0,
        n.hasHandbrake = this.inputs.handbrake || this.holdHandbrake) : (n.hasBoost = !1,
        I.signal.Forward && this.allowDrive && (n.hasBoost = !!I.signal.Boost,
        this.isDriven = !0,
        this.hasManualAccel = !0,
        n.hasAccel = !0,
        !n.hasBoost && n.direction < 0 && n.speed > 1 && !I.hasScreenAccel ? (this.setBrake(!0, I.signal.Forward),
        this.hasManualBrake = !0,
        this.inputs.accel = I.signal.Forward * this.tuning.brake) : (this.inputs.accel = I.signal.Forward * this.tuning.accel,
        this.accelLerp = Math.min(1, this.speed / this.tuning.accelEaseSpeed),
        this.inputs.accel = this.inputs.accel * this.tuning.accelEaseFactor + this.inputs.accel * this.accelLerp * (1 - this.tuning.accelEaseFactor),
        this.setBrake(!1),
        this.prevDriveDir = 1),
        this.holdHandbrake = !1),
        I.signal.Backward && this.allowDrive && (n.hasAccel = !1,
        this.isDriven = !0,
        n.direction > 0 && n.speed > .25 ? (this.setBrake(!0, I.signal.Backward),
        this.hasManualBrake = !0,
        this.inputs.accel = -I.signal.Backward * this.tuning.brake) : (this.setBrake(!1),
        this.inputs.accel = I.signal.Backward * -this.tuning.reverse,
        this.prevDriveDir = -1),
        this.holdHandbrake = !1),
        this.isDriven ? this.softBraking && this.setSoftBrake(!1) : (n.hasAccel = !1,
        this.setBrake(!1),
        this.setSoftBrake(n.speed > .01)),
        this.inputs.stickySteer = I.signal.StickySteer > 0 ? 1 : 0,
        this.inputs.stickySteer && I.signal.Handbrake && !this.inputs.handbrake && (this.holdHandbrake = !0),
        this.inputs.handbrake = I.signal.Handbrake > 0,
        n.hasHandbrake = this.inputs.handbrake || this.holdHandbrake,
        ...
        n.speedLerp = this.speedLerp,
        n.hasBoost && (this.boostFactor = Math.max(0, 1 - this.speedLerp),
        this.inputs.accel += this.tuning.accel * this.tuning.boostFactor * this.boostFactor),
        this.inputs.accel > 0 && (this.inputs.accel *= Math.min(1, L.speedFactor)),
        this.manualSteer = I.filtered.steer,
        I.hasGamepadInput && te.directSteer && (this.manualSteer = Math.min(Math.max(-1, this.manualSteer * 5), 1))),
        this.autodrive && (this.autodriver.update(e),
        L.autodriveMode != q.SPEED && (this.autoSteer = this.autodriver.inputs.steer),
        L.autodriveMode != q.STEER && !this.hasManualAccel && !this.hasManualBrake && (this.inputs.accel = this.autodriver.inputs.accel,
        this.isDriven = !0,
        n.hasBoost ? this.inputs.accel += this.tuning.accel * Math.max(0, 1 - this.speedLerp) : this.inputs.accel > 0 && n.speedLerp < .5 && (this.inputs.accel += this.tuning.accel * Math.max(0, (1 - this.speedLerp * 2) * .5)),
        this.prevDriveDir = 1,
        this.autodriver.inputs.brake > 0 ? this.setBrake(!0, this.autodriver.inputs.brake) : this.setBrake(!1))),
        n.hasCruiseTarget && !this.braking && !n.hasHandbrake && (!this.hasManualAccel || this.useMouse) && (this.prevDriveDir = 1,
        this.inputs.accel = Math.min(this.tuning.accel, Math.max(-this.tuning.reverse, (n.speedControlTarget - n.direction * n.speed) / e)),
        this.useMouse && this.hasBoost && (this.inputs.accel = this.tuning.accel)),
        n.hasSpeedLimit && (this.hasAccel = this.inputs.accel > 0,
        this.inputs.accel = Math.max(-this.tuning.reverse, Math.min(this.inputs.accel, (n.speedControlTarget - n.speed) / e))),
        !n.hasCruiseTarget && (!this.autodrive || L.autodriveMode == q.STEER) && !this.isDriven && n.direction != this.prevDriveDir && n.speed < .1 && (this.holdHandbrake = !0),
    ...
    collideWallEnd(e) {
        ...
        e.collisionFactor = 1 + n.speed / 2,
        this.collisionStrength = Math.min(1, Math.max(this.collisionStrength, n.speed / 30)))
    }
    collideWallEdge(e) {
        if (this.collisionsDisabled)
            return;
        this.didCollide = !0,
        M.vecA.set(e.wn.x, .01, e.wn.z),
        e.worldPos.add(M.vecA.multiplyScalar(e.wcd * e.ws)),
        this.collisionPos.copy(e.axlePos),
        this.collisionPos.z += this.metrics.collisionMargin * (e.insideWall ? -e.ws : e.ws);
        let s = e.velocityDir.x * e.wn.z + e.velocityDir.z * -e.wn.x;
        M.collTemp = (e.velocityDir.x * -e.wn.z + e.velocityDir.z * e.wn.x) * Math.abs(e.wcd) * .75,
        M.vecA.set(-e.wn.z, 0, e.wn.x).multiplyScalar(M.collTemp),
        e.worldPos.sub(M.vecA),
        e.collisionFactor = 1 + n.speed / 4,
        this.collisionStrength = Math.min(1, Math.max(this.collisionStrength, .1 + Math.min(1, (1 - Math.abs(s)) * 5 * (n.speed / 30))))
    }
    updateSteerState(e) {
        this.inputs.steer = this.manualSteer,
        this.steerSpeed = this.wheelR.speed * Math.abs(this.wheelR.lonDirDot) * .8;
        let s = this.steerSpeed ** 2 / (Math.tan(this.metrics.maxLean) * -xe)
          , a = .5;
        this.tiltX != 0 && (a = Math.atan(this.metrics.wheelBase / s)),
        this.steerSpeed < 16 && (this.steerSpeed < 8 ? a *= .5 : a *= this.steerSpeed / 16),
        a *= this.wheelF.downforce,
        a *= 1 - this.wheelR.slip,
        a = Math.min(a, this.tuning.maxSteer);
        let t = this.inputs.steer;
        this.wheelF.latGroundAngle < 0 ? t = Math.max(t, -1 - this.wheelF.latGroundAngle * 2) : t = Math.min(t, 1 - this.wheelF.latGroundAngle * 2),
        this.wheelR.latDirDot > 0 ? t = Math.min(1, Math.max(-1 + this.wheelR.latDirDot * 4, t)) : t = Math.max(-1, Math.min(1 + this.wheelR.latDirDot * 4, t));
        let r = t * a;
        this.autodrive && L.autodriveMode !== q.SPEED && (r += this.autoSteer),
        this.collidingWall && (this.collidingWallSide < 0 ? r = Math.max(r, -.05) : r = Math.min(r, .05));
        let c = .1;
        a > 0 && (c = .1 + Math.abs(this.pSteer - r) / a * .4);
        ...
        this.steerDifferential = this.metrics.wheelBase / Math.sin(this.steer) / (this.metrics.wheelBase / Math.tan(this.steer)) || 1
    }
    updateAccelState(e) {
        this.inputs.accel > 0 ? this.drive < this.inputs.accel ? (this.drive += this.tuning.jerk * e,
        this.drive > this.inputs.accel && (this.drive = this.inputs.accel)) : this.drive = this.inputs.accel : this.drive > this.inputs.accel ? (this.drive -= this.tuning.jerk * e,
        this.drive < this.inputs.accel && (this.drive = this.inputs.accel)) : this.drive = this.inputs.accel,
        this.braking && (this.brakeLerp += e / this.tuning.brakeResponse,
        this.brakeLerp > 1 && (this.brakeLerp = 1),
        this.inputs.brake == 0 && this.softBraking && (this.inputs.brake = L.softBrakeForce),
...
const $e = {
  ...
  , Ot = class Ot extends Oi {
    ...
    init() {
        ...
        n.container.add(new Qe(new gt().setFromPoints([new m(this.metrics.wheelBase,0,this.metrics.axleWidth / 2 - .1), new m(this.metrics.wheelBase,0,this.metrics.axleWidth / 2), new m(this.metrics.wheelBase,this.metrics.wheelRadius + this.tuning.shockTravel,this.metrics.axleWidth / 2), new m(this.metrics.wheelBase,this.metrics.wheelRadius + this.tuning.shockTravel,-this.metrics.axleWidth / 2), new m(this.metrics.wheelBase,0,-this.metrics.axleWidth / 2), new m(this.metrics.wheelBase,0,-this.metrics.axleWidth / 2 + .1)]),e)),
        n.container.add(new Qe(new gt().setFromPoints([new m(0,0,this.metrics.axleWidth / 2 - .1), new m(0,0,this.metrics.axleWidth / 2), new m(0,this.metrics.wheelRadius + this.tuning.shockTravel,this.metrics.axleWidth / 2), new m(0,this.metrics.wheelRadius + this.tuning.shockTravel,-this.metrics.axleWidth / 2), new m(0,0,-this.metrics.axleWidth / 2), new m(0,0,-this.metrics.axleWidth / 2 + .1)]),e)),
        n.container.add(new Qe(new gt().setFromPoints([new m(0,this.metrics.wheelRadius + this.tuning.shockTravel,0), new m(0,this.metrics.wheelRadius + this.tuning.shockTravel + .1,0), new m(this.metrics.wheelBase,this.metrics.wheelRadius + this.tuning.shockTravel + .1,0), new m(this.metrics.wheelBase,this.metrics.wheelRadius + this.tuning.shockTravel,0)]),e)),
        this.wheelObj = new we;
        let s = new Eo(this.metrics.wheelRadius,this.metrics.wheelRadius,this.metrics.wheelWidth,11)
          , a = new Qe(new Es(s),e);
        a.rotation.x = Math.PI / 2,
        a.position.z += this.metrics.wheelWidth / 2,
        this.wheelObj.add(a);
        let t = new Eo(this.metrics.wheelRadius,this.metrics.wheelRadius,.2)
          , r = new ei(t,W.shadow);
    ...
    initDebug() {
        ...
        this.debugUp = new Qe(new gt().setFromPoints([new m(0,0,0), new m(0,1,0)]),new $t({
            color: 255,
            fog: !1
        })),
        this.debugUp.scale.set(.25, .25, .25),
        this.debugContainer.add(this.debugUp),
        this.debugUpPositions = this.debugUp.geometry.attributes.position,
        this.debugContact = new Qe(new gt().setFromPoints([new m(0,0,0), new m(0,1,0)]),new $t({
            color: 65280,
            fog: !1
        })),
        this.debugContact.scale.set(.5, .5, .5),
        this.debugContainer.add(this.debugContact),
        this.debugContactPositions = this.debugContact.geometry.attributes.position,
        this.debugWheels = [];
        for (let c = 0; c < 4; c++) {
            let g = {
                vel: new Qe(new gt().setFromPoints([new m(0,0,0), new m(0,1,0)]),e),
                accel: new Qe(new gt().setFromPoints([new m(0,0,0), new m(0,1,0)]),s),
                contact: new ei(new is(.05,8,4),a),
                tPos: new ei(new is(.05,8,4),t),
    ...
    updateVisuals(e) {
        ...
        for (let s = 0; s < 4; s++) {
            ...
            a.velPositions.array[1] = this.wheels[s].worldPos.y + this.metrics.wheelRadius,
            a.velPositions.array[2] = this.wheels[s].worldPos.z,
            a.velPositions.array[3] = this.wheels[s].worldPos.x + $e.vecA.x,
            a.velPositions.array[4] = this.wheels[s].worldPos.y + $e.vecA.y + this.metrics.wheelRadius,
            ...
            a.accelPositions.array[1] = this.wheels[s].worldPos.y + this.metrics.wheelRadius,
            a.accelPositions.array[2] = this.wheels[s].worldPos.z,
            a.accelPositions.array[3] = this.wheels[s].worldPos.x + $e.vecA.x,
            a.accelPositions.array[4] = this.wheels[s].worldPos.y + $e.vecA.y + this.metrics.wheelRadius,
            a.accelPositions.array[5] = this.wheels[s].worldPos.z + $e.vecA.z,
            a.accelPositions.needsUpdate = !0,
            this.trailUpdateTimer > this.trailUpdateInterval && this.wheels[s].speed > .5 && ($e.a = .5 + .5 * (-this.wheels[s].latForce / e) / 1e3,
            a.trailColors.array[a.trailIndex] = $e.a,
            a.trailPositions.array[a.trailIndex++] = this.wheels[s].worldPos.x,
            a.trailColors.array[a.trailIndex] = 1 - $e.a,
            a.trailPositions.array[a.trailIndex++] = this.wheels[s].worldPos.y + this.metrics.wheelRadius + Math.floor(s / 2) * .25,
            a.trailColors.array[a.trailIndex] = 0,
            a.trailPositions.array[a.trailIndex++] = this.wheels[s].worldPos.z,
        ...
        this.trailUpdateTimer > this.trailUpdateInterval && (this.trailUpdateTimer = 0),
        this.autodrive && this.targetPosShape.position.copy(this.autodriver.targetPos),
...
let ga = Ot;
const hc = "" + new URL("../assets/bike_wheel.7f70e3e5.glb",import.meta.url).href
  , dc = "" + new URL("../assets/bike_main.4646b282.glb",import.meta.url).href
  , cc = "" + new URL("../assets/bike_interior.2d798407.glb",import.meta.url).href
  , gc = "" + new URL("../assets/bike_interior_bars.a17b1ae7.glb",import.meta.url).href
  , uc = "" + new URL("../assets/bike_window.5cc59586.webp",import.meta.url).href
  , fc = "" + new URL("../assets/bike_interior_map.a5657c67.webp",import.meta.url).href;
new m,
new m;
const Ce = {}
  , _e = {}
...
class di extends Fi {
    ...
    async init() {
        ...
        W.metal.specular.setHex(16777215);
        const e = new Oa;
        Ce.body ? (n.container.add(Ce.body),
        this.exteriorObjects.body = Ce.body) : (this.elementsToLoad++,
        e.load(this.geometry.body, s => {
            let a = s.scene;
            a.traverse(t => {
                t.isMesh && (t.material = W.getMaterialByName(t.name),
        ...
        Ce.wheel ? (this.frontWheelObj = Ce.wheel,
        this.rearWheelObj = this.frontWheelObj.clone(),
        this.exteriorObjects.frontWheel = this.frontWheelObj,
        this.exteriorObjects.rearWheel = this.rearWheelObj) : (this.elementsToLoad++,
        e.load(this.geometry.wheel, s => {
            let a = s.scene;
            a.traverse(t => {
                t.isMesh && (t.material = W.getMaterialByName(t.name),
        ...
        Ce.interior ? (n.container.add(Ce.interior),
        ...
        this.powerGradient = _e.powerGradient) : (this.elementsToLoad++,
        e.load(this.geometry.interior, s => {
            let a = s.scene;
            W.setOnObject(a),
            a.traverse(t => {
                if (t.name == "bike-dashboard-screen") {
                    ...
                    this.wormGradient.addColorStop(.2, "#f4f2edff"),
                    this.wormGradient.addColorStop(1, "#f4f2ed00"),
                    this.speedGradient = c.createConicGradient(Ac - .01, kt, ct),
                    this.speedGradient.addColorStop(0, "rgb(10, 105, 164)"),
                    this.speedGradient.addColorStop(.3, "rgb(55, 192, 255)"),
                    this.speedGradient.addColorStop(.5, "rgb(230, 205, 107)"),
                    this.speedGradient.addColorStop(.6, "rgb(225, 120, 45)"),
                    this.powerGradient = c.createConicGradient(Ys - .01, qt, ct),
                    this.powerGradient.addColorStop(0, "rgb(23, 161, 60)"),
                    this.powerGradient.addColorStop(.25, "rgb(90, 197, 88)"),
                    this.powerGradient.addColorStop(.5, "rgb(245, 207, 55)"),
                    this.powerGradient.addColorStop(.6, "rgb(225, 51, 45)");
        ...
        Ce.steer ? (n.container.add(Ce.steer),
        this.interiorObjects.steeringWheel = Ce.steer) : (this.elementsToLoad++,
        e.load(this.geometry.steer, s => {
            let a = s.scene;
            W.setOnObject(a),
    ...
    updateVisuals(e) {
        this.ready && (n.isInterior && this.updateDashScreen(),
        W.setBrakeLights(this.braking, this.softBraking),
        n.inAutodrive ? this.interiorObjects.steeringWheel.rotation.y = this.interiorObjects.steeringWheel.rotation.y * .8 + .6 * this.steer / this.tuning.maxSteer * .2 : this.interiorObjects.steeringWheel.rotation.y = .6 * this.steer / this.tuning.maxSteer)
    }
    updateWormPoints() {
        let e = ja(n.position.x, n.position.z, v.vehicleNode)
          , s = v.vehicleNode.next
    ...
    updateDashScreen() {
        ...
        e.strokeStyle = n.hasBoost ? "rgb(225, 51, 45)" : this.powerGradient,
        e.stroke(),
        n.hasBoost ? e.drawImage(Oe.boost, qt - 18, ct - 18, 36, 36) : e.drawImage(Oe.boostLine, qt - 18, ct - 18, 36, 36),
        this.scActive) {
            e.globalAlpha = cr,
            e.font = "12px Sono",
            e.fillStyle = yi,
            ...
            e.lineWidth = 18;
            let N = s + this.scTargetProp * Math.PI * 1.25;
            e.arc(kt, ct, Ks, N - .025, N + .025),
            e.strokeStyle = yi,
            e.stroke()
        }
        this.hasAutodrive && (e.globalAlpha = cr,
        e.font = "12px Sono",
        e.fillStyle = yi,
        e.textAlign = "center",
        e.textBaseline = "middle",
...
const wc = "" + new URL("../assets/coupe_wheel.c6147816.obj",import.meta.url).href
  , xc = "" + new URL("../assets/drift_coupe_main.e5ad1282.obj",import.meta.url).href
  , Sc = "" + new URL("../assets/coupe_interior.09a042a6.obj",import.meta.url).href
  , bc = "" + new URL("../assets/coupe_dash.c2d78df2.obj",import.meta.url).href
  , yc = "" + new URL("../assets/coupe_steering.4443a960.obj",import.meta.url).href
  , Dc = "" + new URL("../assets/coupe_map.a8b5765d.webp",import.meta.url).href
  , Mc = "" + new URL("../assets/coupe_wheel.9c1b070c.webp",import.meta.url).href
  , Lc = "" + new URL("../assets/coupe_window.c8de7db5.webp",import.meta.url).href
  , h = {
    vecA: new m,
    vecB: new m,
    vecC: new m,
...
class ua extends Ke {
    ...
    setPose(e, s, a, t) {
        ...
        this.orientation.z = 0,
        s = ce.getRoadsideHeight(e, a, v.vehicleNode),
        h.vecA.set(e + Math.cos(t) * this.metrics.wheelBase, s, a + Math.sin(t) * this.metrics.wheelBase);
        ...
        for (let c of this.wheels)
            ...
            c.lonGroundAngle = this.tiltZ,
            c.cosLonGroundAngle = Math.cos(this.tiltZ);
        h.frontGroundHeight = (this.wheelFL.groundHeight + this.wheelFR.groundHeight) / 2,
        h.rearGroundHeight = (this.wheelRL.groundHeight + this.wheelRR.groundHeight) / 2,
        this.groundAngle = Math.asin((h.frontGroundHeight - h.rearGroundHeight) / this.wheelFL.groundPoint.distanceTo(this.wheelRL.groundPoint)),
        this.groundOrientation.x = 0,
        this.groundOrientation.y = this.orientation.y,
        this.groundOrientation.z = this.groundAngle,
        this.groundUp.set(0, 1, 0).applyEuler(this.groundOrientation),
    ...
    updateLive(e) {
        ...
        this.handleInput(e);
        let s = e;
        for (; !mt.stepping && s > .042; )
            this.updatePhysics(.04),
            this.pdT = .04,
            s -= .04;
        this.updatePhysics(s),
        this.updateAudio(e),
    ...
    updateNew(e) {
        ...
        h.stabilityFactor = 1,
        h.frontSlip > 0 && h.rearSlip > h.frontSlip && (h.frontRearSlipRatio = Math.min(h.rearSlip, Math.min(2, h.rearSlip / h.frontSlip) - 1),
        h.stabilityFactor = 1 + h.frontRearSlipRatio * this.tuning.rearStability),
        ...
        for (let t of this.wheels) {
            ...
            t.accel.set(0, 0, 0),
            t.shockForce <= 1 ? t.downforce = t.shockForce * .9 : t.downforce = .9 + .1 * Math.sqrt((t.shockForce - 1) / (this.tuning.shockForce - 1)),
            t.groundTraction = (Math.max(0, t.groundNorm.dot(Js) - .5) * 2) ** 2,
            t.groundTraction *= t.groundNorm.dot(this.up) ** 2,
            t.groundImpact = -t.groundNorm.dot(n.motionDir) * t.downforce,
            (t.groundImpact < 0 || t.velocityDir.y < 0) && (t.groundImpact = 0),
            t.groundImpactFactor = 1 + t.groundImpact,
            ...
            t.latDirDot = t.velocityDir.dot(h.vecA)) : (h.vecA.set(1, 0, 0).applyEuler(this.orientation),
            t.lonDirDot = t.velocityDir.dot(h.vecA),
            t.direction = t.lonDirDot < 0 ? -1 : 1,
            h.vecA.set(0, 0, 1).applyEuler(this.orientation),
            t.latDirDot = t.velocityDir.dot(h.vecA)),
            t.locked = !t.front && n.hasHandbrake,
            t.locked ? (h.maxLon = this.metrics.wheelMass * t.downforce * t.groundState.f * this.tuning.tyreFriction * t.cosLonGroundAngle,
            h.lon = t.lonDirDot * t.speed / e,
            h.lonAbs = Math.abs(h.lon),
            t.lonSlip = 0,
            h.lonAbs > h.maxLon && (h.maxLon = this.metrics.wheelMass * t.downforce * (t.groundState.f * this.tuning.tyreFriction) * this.tuning.kineticFrictionFactor * t.cosLonGroundAngle * .75,
            h.lon < 0 ? h.lon = Math.max(h.lon, -h.maxLon) : h.lon = Math.min(h.lon, h.maxLon),
            t.lonSlip = Math.abs(t.lonDirDot)),
            t.static = t.speed < .2,
            t.accel.x -= h.lon) : n.hasHandbrake && t.speed < .1 ? t.static = !0 : (t.static = !1,
            t.accel.x -= Math.min(this.tuning.rollResistance, t.speed / e) * t.shockForce * t.lonDirDot),
            h.lat = t.latDirDot * t.speed / e,
            t.pLat = h.lat,
            t.slipAngle = Math.acos(t.lonDirDot),
            t.slipAngleFactor = 0,
            h.slipAngleLerp = Math.max(0, t.slipAngle / (this.peakSlipAngle / t.groundState.f)),
            h.slipAngleLerp <= 1 ? t.slipAngleFactor = -((h.slipAngleLerp - 1) ** 2) + 1 : h.slipAngleLerp > 10 ? t.slipAngleFactor = .75 : t.slipAngleFactor = 1 + (1 - h.slipAngleLerp) * .025,
            h.wl = 1,
            t.groundImpact <= 0 ? h.wl = t.cosLatGroundAngle ** 3 : h.wl = t.groundImpactFactor,
            L.gripFactor < 1 ? h.wl *= .8 + L.gripFactor * .2 : h.wl *= L.gripFactor,
            h.maxLat = this.metrics.wheelMass * t.downforce * t.groundState.f * this.tuning.tyreFriction * t.slipAngleFactor * h.wl,
            t.front || (h.maxLat *= h.stabilityFactor),
            h.latAbs = Math.abs(h.lat),
            t.kineticBlend = 0,
            h.latAbs > h.maxLat ? (t.kineticBlend = 1,
            h.kineticForceLimit = t.groundState.f * 50,
            h.latAbs < h.kineticForceLimit && (t.kineticBlend = this.smoothLerp(h.latAbs / h.kineticForceLimit)),
            h.frictionFactor = 1 - t.kineticBlend + t.kineticBlend * this.tuning.kineticFrictionFactor,
            h.maxLat = this.metrics.wheelMass * t.downforce * (t.groundState.f * this.tuning.tyreFriction) * h.frictionFactor * t.slipAngleFactor * h.wl,
            t.front || (h.maxLat *= h.stabilityFactor),
            t.drive > 0 && (this.driveMode == qe.RWD ? h.maxLat *= 1 - t.drive * .08 * t.kineticBlend : h.maxLat *= 1 - t.drive * .04 * t.kineticBlend),
            t.locked && (h.maxLat *= .7),
            h.lat < -h.maxLat ? (t.slip = Math.min(1, -(h.lat - h.maxLat) / (h.maxLat * 50)),
            h.lat = Math.max(h.lat, -h.maxLat)) : h.lat > h.maxLat && (t.slip = Math.min(1, (h.lat - h.maxLat) / (h.maxLat * 50)),
            h.lat = h.maxLat)) : t.slip = 0,
            t.maxLat = h.maxLat,
            t.latForce = h.lat,
            t.accel.z -= t.latForce,
            this.braking && !t.locked && (t.accel.x = -t.lonDirDot * this.brakeForce * t.traction),
            t.drive = 0,
            t.hasDrive && !t.locked && (h.drive = this.drive * t.driveModeFactor * t.traction,
            t.drive = this.drive / this.tuning.accel * this.driveModeFactor,
            t.i == 0 ? (h.drive *= this.steerDifferential,
            t.drive *= this.steerDifferential) : t.i == 1 ? (h.drive /= this.steerDifferential,
            t.drive /= this.steerDifferential) : t.i == 2 ? (h.drive *= this.rearSteerDifferential,
            t.drive *= this.rearSteerDifferential) : (h.drive /= this.rearSteerDifferential,
            t.drive /= this.rearSteerDifferential),
            t.accel.x += h.drive),
            t.accel.y -= t.shockForce * xe,
            t.shockVel = (t.shockCompression - t.pShockCompresion) / e,
            ...
            t.front ? t.accel.applyEuler(t.steerOrientation) : t.accel.applyEuler(this.orientation),
            t.accel.y += xe,
            this.collisionStrength > .01 && (t.snowDrag += 2e3 * this.collisionStrength ** 2 * (Math.min(28, n.speed) / 28) ** 2),
            h.vecA.copy(t.velocityDir).negate().multiplyScalar(this.tuning.drag * t.speed * t.speed * t.snowDrag),
            t.contactPoint.y < ce.seaLevel && (h.s = ce.seaLevel - this.metrics.wheelRadius,
            t.contactPoint.y < h.s ? h.vecA.multiplyScalar(100) : h.vecA.multiplyScalar((1 - (t.contactPoint.y - h.s) / this.metrics.wheelRadius) * 100)),
            t.accel.add(h.vecA),
            t.wheelImpact = -t.groundNorm.dot(t.velocityDir) * t.downforce,
            (t.wheelImpact < 0 || t.velocityDir.y < 0) && (t.wheelImpact = 0),
            t.wheelImpact > .01 && (h.vecA.normalize().multiplyScalar(t.wheelImpact * (t.speed / e) * .05 * Math.max(Math.abs(t.lonDirDot / 4), Math.abs(t.latDirDot))),
            t.accel.add(h.vecA),
            h.vecA.copy(t.groundNorm),
            h.vecA.y *= 0,
            h.vecA.multiplyScalar(t.speed / e * t.wheelImpact * .003),
        ...
        if (this.fCollision)
            ...
            h.vecA.y > Math.PI ? h.vecA.y -= Math.TAU : h.vecA.y < -Math.PI && (h.vecA.y += Math.TAU),
            h.vecA.divideScalar(e),
            Math.abs(h.vecA.x) > this.tuning.maxRotAccel && (h.vecA.x = Math.sign(h.vecA.x) * this.tuning.maxRotAccel),
            Math.abs(h.vecA.z) > this.tuning.maxRotAccel && (h.vecA.z = Math.sign(h.vecA.z) * this.tuning.maxRotAccel),
            Math.abs(h.vecA.y) > this.tuning.maxRotAccel && (h.vecA.y = Math.sign(h.vecA.y) * this.tuning.maxRotAccel),
            ...
            Math.abs(h.vecA.z) > this.tuning.maxRotAccel && (h.vecA.z = Math.sign(h.vecA.z) * this.tuning.maxRotAccel),
            Math.abs(h.vecA.y) > this.tuning.maxRotAccel && (h.vecA.y = Math.sign(h.vecA.y) * this.tuning.maxRotAccel),
            this.chassisRotVel.lerp(h.vecA, (1 - this.tuning.weightFactor) * (this.collidingGround / 4) * r)
        }
        (isNaN(n.position.x) || isNaN(this.orientation.z)) && this.reset()
    }
    resolveChassisTransformNew(e) {
        ...
        for (let Ue = 0; Ue < 4; Ue++)
            ...
            g.normalize(),
            G.y = -Math.atan2(f.z, f.x),
            s.i == 0 ? Be = G.y : G.y - Be < -Math.PI ? G.y += Ze : G.y - Be > Math.PI && (G.y -= Ze),
            G.z = Math.asin(f.y),
            G.x = -Math.asin(g.y / Math.cos(G.z)),
            f.multiplyScalar(-s.relPos.x),
            g.multiplyScalar(-s.relPos.z),
        ...
        N > 0 && h.vecB.length() > this.tuning.maxLinearAccel && h.vecB.normalize().multiplyScalar(this.tuning.maxLinearAccel),
        h.vecB.multiplyScalar(e),
        this.chassisVel.add(h.vecB),
        h.vecA.copy(this.orientation).sub(this.chassisPRot),
        h.vecA.y > Math.PI ? h.vecA.y -= Math.TAU : h.vecA.y < -Math.PI && (h.vecA.y += Math.TAU),
        h.vecA.divideScalar(this.pdT),
        N > 0 && (Math.abs(h.vecA.x) > this.tuning.maxRotAccel && (h.vecA.x = Math.sign(h.vecA.x) * this.tuning.maxRotAccel),
        Math.abs(h.vecA.z) > this.tuning.maxRotAccel && (h.vecA.z = Math.sign(h.vecA.z) * this.tuning.maxRotAccel),
        Math.abs(h.vecA.y) > this.tuning.maxRotAccel && (h.vecA.y = Math.sign(h.vecA.y) * this.tuning.maxRotAccel)),
        h.vecB.copy(h.vecA).sub(this.chassisRotVel),
        this.chassisRotVel.add(h.vecB),
        this.chassisRotVel.y < -Math.PI ? this.chassisRotVel.y += Ze : this.chassisRotVel.y > Math.PI && (this.chassisRotVel.y -= Ze),
        this.chassisPComPos.copy(n.com),
        this.chassisPRot.copy(this.orientation);
        let ue = N / 4 * this.tuning.shockForce
          , Vt = 1 - Math.min(1, ue)
        ...
        this.chassisCandidateRot.z += this.chassisRotVel.z * e;
        let wi = this.chassisCandidateRot.y - O.y;
        wi < -Math.PI ? this.chassisCandidateRot.y += Ze : wi > Math.PI && (this.chassisCandidateRot.y -= Ze),
        this.chassisCandidateComPos.copy(this.chassisVel).multiplyScalar(e).add(n.com),
        h.vecA.set(-this.metrics.wheelBase / 2, -this.metrics.comHeight, 0).applyEuler(this.chassisCandidateRot),
    ...
    resolveChassisTransform() {
        h.inertia = 0,
        h.authMin = .2,
        h.authRange = (.5 - h.authMin) * 2,
        h.fCollDenom = this.wheelFL.downforce + this.wheelFL.collisionFactor + this.wheelFR.downforce + this.wheelFR.collisionFactor,
        h.fCollDenom > 0 ? h.fRightAuthority = (this.wheelFR.downforce + this.wheelFR.collisionFactor) / h.fCollDenom : h.fRightAuthority = .5,
        h.fCollisionFactor = this.wheelFL.collisionFactor + this.wheelFR.collisionFactor,
        h.fCollisionFactor == 0 && (h.fRightAuthority = h.authMin + h.authRange * h.fRightAuthority),
        h.fRightAuthorityS = h.fRightAuthorityS * h.inertia + (1 - h.inertia) * h.fRightAuthority,
        h.vecA.copy(this.wheelFR.worldPos).sub(this.wheelFL.worldPos),
        h.offset = h.vecA.length() - this.metrics.axleWidth,
        h.vecB.copy(h.vecA).normalize().multiplyScalar(h.offset * h.fRightAuthorityS),
        ...
        h.rCollDenom = this.wheelRL.downforce + this.wheelRL.collisionFactor + this.wheelRR.downforce + this.wheelRR.collisionFactor,
        h.rCollDenom > 0 ? h.rRightAuthority = (this.wheelRR.downforce + this.wheelRR.collisionFactor) / h.rCollDenom : h.rRightAuthority = .5,
        h.rCollisionFactor = this.wheelRL.collisionFactor + this.wheelRR.collisionFactor,
        h.rCollisionFactor == 0 && (h.rRightAuthority = h.authMin + h.authRange * h.rRightAuthority),
        h.rRightAuthorityS = h.rRightAuthorityS * h.inertia + (1 - h.inertia) * h.rRightAuthority,
        h.vecA.copy(this.wheelRR.worldPos).sub(this.wheelRL.worldPos),
        h.offset = h.vecA.length() - this.metrics.axleWidth,
        h.vecB.copy(h.vecA).normalize().multiplyScalar(h.offset * h.rRightAuthorityS),
        this.wheelRL.worldPos.add(h.vecB),
        h.vecA.normalize().multiplyScalar(this.metrics.axleWidth),
        this.wheelRR.worldPos.copy(h.vecA).add(this.wheelRL.worldPos),
        h.axleFPos.addVectors(this.wheelFL.worldPos, this.wheelFR.worldPos).multiplyScalar(.5),
        h.axleRPos.addVectors(this.wheelRL.worldPos, this.wheelRR.worldPos).multiplyScalar(.5),
        h.collDenom = h.fCollDenom + h.rCollDenom,
        h.collDenom > 0 ? h.frontAuthority = h.fCollDenom / h.collDenom : h.frontAuthority = .5,
        h.fCollisionFactor == 0 && h.rCollisionFactor == 0 && (h.frontAuthority = h.authMin + h.authRange * h.frontAuthority),
        h.frontAuthorityS = h.frontAuthorityS * h.inertia + (1 - h.inertia) * h.frontAuthority,
        h.vecA.copy(h.axleFPos).sub(h.axleRPos),
        h.offset = h.vecA.length() - this.metrics.wheelBase,
        h.vecB.copy(h.vecA).normalize().multiplyScalar(h.offset * h.frontAuthorityS),
        ...
        h.r1 = Math.asin((this.wheelFL.worldPos.y - this.wheelRL.worldPos.y) / h.d1),
        h.r2 = Math.asin((this.wheelFR.worldPos.y - this.wheelRR.worldPos.y) / h.d2),
        h.tiltLerpDenom = this.wheelFL.downforce + this.wheelRL.downforce + this.wheelFR.downforce + this.wheelRR.downforce,
        h.tiltLerpDenom > 0 ? h.tiltLerp = (this.wheelFL.downforce + this.wheelRL.downforce) / h.tiltLerpDenom : h.tiltLerp = .5,
        h.tiltZ = h.r1 * h.tiltLerp + h.r2 * (1 - h.tiltLerp),
        isNaN(h.tiltZ) && (h.tiltZ = 0),
        h.dTiltZ = h.tiltZ - this.tiltZ,
        h.tiltZ > this.tiltZ && this.tiltZ > 1 ? h.dTiltZ *= 1 - (this.tiltZ - 1) / .4 : h.tiltZ < this.tiltZ && this.tiltZ < -1 && (h.dTiltZ *= (1 + this.tiltZ) / -.4),
        this.tiltZ += h.dTiltZ,
        this.tiltZ = Math.min(Math.max(-1.4, this.tiltZ), 1.4),
        this.sinTiltZ = Math.sin(this.tiltZ),
        this.cosTiltZ = Math.cos(this.tiltZ),
        n.pitch = this.tiltZ,
        this.orientation.z = this.tiltZ,
        h.d2 = this.wheelFR.worldPos.distanceTo(this.wheelFL.worldPos) * this.cosTiltZ,
        h.d1 = this.wheelFL.worldPos.y - this.wheelFR.worldPos.y,
        h.r1 = Math.asin(h.d1 / h.d2),
        h.d2 = this.wheelRR.worldPos.distanceTo(this.wheelRL.worldPos) * this.cosTiltZ,
        h.d1 = this.wheelRL.worldPos.y - this.wheelRR.worldPos.y,
        h.r2 = Math.asin(h.d1 / h.d2),
        h.tiltLerpDenom > 0 ? h.tiltLerp = (this.wheelFL.downforce + this.wheelFR.downforce) / h.tiltLerpDenom : h.tiltLerp = .5,
        h.tiltX = h.r1 * h.tiltLerp + h.r2 * (1 - h.tiltLerp),
        h.dTiltX = h.tiltX - this.tiltX,
        h.tiltX > this.tiltX && this.tiltX > 1 ? h.dTiltX *= 1 - (this.tiltX - 1) / .4 : h.tiltX < this.tiltX && this.tiltX < -1 && (h.dTiltX *= (1 + this.tiltX) / -.4),
        this.tiltX += h.dTiltX,
        this.tiltX = Math.min(Math.max(-1.4, this.tiltX), 1.4),
        this.sinTiltX = Math.sin(this.tiltX),
        this.cosTiltX = Math.cos(this.tiltX),
    ...
    updateWheelsPost(e) {
        ...
        h.r = 0,
        this.wheelFL.shockFactor == 0 ? (this.wheelFL.rollVelocity *= .995,
        h.r = this.wheelFL.rollVelocity * e) : (h.r = this.wheelFL.dS / h.wheelCirc * Ze * this.wheelFL.direction,
        this.wheelFL.rollVelocity = h.r / e),
        this.wheelFL.euler.z += h.r,
        this.wheelFL.euler.y = this.steerL + Math.PI,
        this.wheelFL.setRotationFromEuler(this.wheelFL.euler),
        this.wheelFR.shockFactor == 0 ? (this.wheelFR.rollVelocity *= .995,
        h.r = this.wheelFR.rollVelocity * e) : (h.r = this.wheelFR.dS / h.wheelCirc * Ze * this.wheelFR.direction,
        this.wheelFR.rollVelocity = h.r / e),
        this.wheelFR.euler.z -= h.r,
        this.wheelFR.euler.y = this.steerR,
        this.wheelFR.setRotationFromEuler(this.wheelFR.euler),
        n.hasHandbrake || (this.wheelRL.shockFactor == 0 ? (this.wheelRL.rollVelocity *= .995,
        h.r = this.wheelRL.rollVelocity * e) : (h.r = this.wheelRL.dS / h.wheelCirc * Ze * this.wheelRL.direction,
        this.wheelRL.rollVelocity = h.r / e),
        this.wheelRL.rotation.z = this.wheelRL.rotation.z + h.r,
        this.wheelRR.shockFactor == 0 ? (this.wheelRR.rollVelocity *= .995,
        h.r = this.wheelRR.rollVelocity * e) : (h.r = this.wheelRR.dS / h.wheelCirc * Ze * this.wheelRR.direction,
        this.wheelRR.rollVelocity = h.r / e),
        this.wheelRR.rotation.z = this.wheelRR.rotation.z - h.r)
    }
    updateChassisState(e) {
        h.vecA.copy(n.accel),
        h.vecA.applyAxisAngle(Js, -this.orientation.y);
        let s = e * 2e3;
    ...
    updateWheelContact(e) {
        ...
        h.sideFactor = 1,
        e.i % 2 == 0 && (h.vecA.negate(),
        h.sideFactor = -1);
        let s = Math.max(0, h.vecA.dot(e.velocityDir));
        h.vecA.y = 0,
        h.vecA.normalize(),
        e.groundHeightLateral = ce.getGroundState(e.contactPoint.x + this.metrics.wheelWidth * h.vecA.x, e.contactPoint.z + this.metrics.wheelWidth * h.vecA.z, v.vehicleNode, {
            n: {}
        }, !1, !0, 1 + s * 1).h,
        e.latGroundAngle = Math.atan((e.groundHeight - e.groundHeightLateral) / this.metrics.wheelWidth),
        ...
        h.vecA.y = 0,
        h.vecA.normalize(),
        e.groundHeightLongitudinal = ce.getGroundState(e.contactPoint.x + this.metrics.wheelWidth * h.vecA.x, e.contactPoint.z + this.metrics.wheelWidth * h.vecA.z, v.vehicleNode, {
            n: {}
        }, !1, !0).h,
        e.lonGroundAngle = Math.atan((e.groundHeightLongitudinal - e.groundHeight) / this.metrics.wheelWidth),
        e.lonGroundAngle > .5 && a > 0 && (e.snowDrag += (e.lonGroundAngle - .5) * 500),
        e.cosLonGroundAngle = Math.cos(e.lonGroundAngle),
        e.sinLonGroundAngle = Math.sin(e.lonGroundAngle),
        e.groundOrientation.x = e.latGroundAngle,
        e.groundOrientation.y = this.orientation.y,
        ...
        this.collidingGround++,
        this.collidingGroundBounce += e.groundState.b,
        h.vecA.copy(e.groundNorm).multiplyScalar(e.shockExcess * e.groundNorm.dot(this.up)),
        e.shockExcess < e.travel && h.vecA.multiplyScalar(e.groundState.b),
        e.worldPos.add(h.vecA)),
        e.contactPoint.y + e.snowDepth > e.groundHeight + 1 && (this.collisionsDisabled = !0),
        n.isAirborne = n.isAirborne && e.contactPoint.y > e.groundHeight + .1,
        e.shockFactor = e.shockCompression / e.travel,
        e.shockForce = e.shockFactor * this.tuning.shockForce,
        h.ground.w ? (e.wd = h.ground.wd,
        e.wn = h.ground.wn,
        e.ws = h.ground.ws,
        e.wasInsideWall = e.insideWall,
        e.insideWall = e.wd < 0,
        this.collisionsDisabled && (e.wasInsideWall = e.insideWall),
        e.wi == null || e.wi !== h.ground.wi || e.collidingWallEnd ? (e.wi = h.ground.wi,
        e.mayCollide = !0,
        this.wheelsInside[h.ground.wi] == null && (this.wheelsInside[h.ground.wi] = e.insideWall),
        this.wheelsInside[e.wi] !== e.insideWall || e.wd > -this.metrics.collisionMargin && e.wd < this.metrics.collisionMargin ? this.collideWallEnd(e) : e.collidingWallEnd = !1) : (this.wheelsInside[h.ground.wi] == null && (this.wheelsInside[h.ground.wi] = e.insideWall),
        e.collidingWallEnd = !1,
        this.wheelsInside[e.wi] !== e.insideWall && (this.collidingWall = !0,
        this.collideWallEnd(e)),
        e.collidingWallEnd || (e.wasInsideWall == !1 ? e.insideWall = e.wd - this.metrics.collisionMargin < 0 : e.insideWall = e.wd + this.metrics.collisionMargin < 0,
    ...
    handleInput(e) {
        ...
        Je.isCinecam)
            ...
            if (n.hasBoost = !1,
            I.signal.Forward ? (n.hasBoost = !!I.signal.Boost,
            this.isDriven = !0,
            this.hasManualAccel = !0,
            n.direction >= 0 && (this.hasForwardDrive = !0),
            n.hasAccel = !0,
            ...
            this.prevDriveDir = 1),
            this.holdHandbrake = !1) : this.hasForwardDrive = !1,
            I.signal.Backward ? (n.hasAccel = !1,
            n.direction <= 0 && !this.braking && (this.hasRearDrive = !0),
            this.isDriven = !0,
            (n.direction > 0 || this.braking && n.speed > 1) && !this.hasRearDrive ? (this.setBrake(!0, I.signal.Backward),
            this.hasManualBrake = !0) : (this.setBrake(!1),
            ...
            n.speed < 1 ? h.slipAngle *= 0 : n.speed < 2 && (h.slipAngle *= n.speed - 1),
            !te.directSteer || !I.hasGamepadInput) {
                h.sl = this.speedLerp * Math.sqrt(L.steerAssist);
                let s = this.slip ** 2 * Math.abs(I.signal.Left - I.signal.Right) * L.steerAssist
                  , a = Math.max(this.tuning.peakSlipAngle, this.tuning.maxSteer * (1 - h.sl) * (1 + s));
                h.maxSteer = h.maxSteer * .5 + .5 * a,
                h.counterSteerFactor = 0,
                L.steerAssist > .8 && (h.counterSteerFactor = Math.min(1, Math.abs(h.slipAngle) / this.peakSlipAngle) * ((L.steerAssist - .8) / .2) * (.5 + this.spin * .5)),
                h.steerFactor = 1,
                h.vecB.set(0, 0, 1).applyEuler(this.orientation),
                h.steer = h.steerFactor * I.filtered.steer * h.maxSteer - h.slipAngle * Math.sign(n.motionDir.dot(h.vecB)) * h.counterSteerFactor,
                I.hasScreenSteer && (h.steer *= .5),
                this.inputs.steer = Math.min(Math.max(-this.tuning.maxSteer, h.steer), this.tuning.maxSteer)
            } else
                this.inputs.steer = I.filtered.steer * this.tuning.maxSteer;
    ...
    setDriveMode(e) {
        ...
        this.wheels[2].hasDrive = !0,
        this.wheels[3].hasDrive = !0,
        this.wheels[0].driveModeFactor = .5,
        this.wheels[1].driveModeFactor = .5,
        this.wheels[2].driveModeFactor = .5,
        this.wheels[3].driveModeFactor = .5,
        this.driveMode = e,
        e) {
        case qe.FWD:
            this.driveModeFactor = 1,
    ...
    collideWallEdge(e) {
        ...
        e.collisionFactor = 5 + n.speed * 5,
        this.collisionStrength = Math.min(1, Math.max(this.collisionStrength, Math.min(1, (1 - Math.abs(h.collDot)) * 5) * e.collisionFactor / 50)),
        this.collidingWheels.push(e),
        e.collisionVector.sub(e.worldPos).negate()
    }
    updateSteerState(e) {
        if (this.steer = this.inputs.steer + this.autoSteer,
        this.steer = Math.min(Math.max(-n.tuning.maxSteer, this.steer), n.tuning.maxSteer),
        h.ts = Math.exp(-e / .1) * (1 - this.tuning.tyreStiffness),
        this.effectiveSteer = this.effectiveSteer * h.ts + this.steer * (1 - h.ts),
        h.sa = Math.sin(this.steer),
        h.ca = Math.cos(this.steer) * this.metrics.wheelBase * 2,
        h.tl = this.metrics.wheelBase * 2 * h.sa / (h.ca - this.metrics.axleWidth * h.sa),
        h.tr = this.metrics.wheelBase * 2 * h.sa / (h.ca + this.metrics.axleWidth * h.sa),
        ...
        this.effectiveSteerL = this.effectiveSteerL * h.ts + h.steerL * (1 - h.ts),
        this.effectiveSteerR = this.effectiveSteerR * h.ts + h.steerR * (1 - h.ts),
        this.steerDifferential = this.metrics.wheelBase / Math.sin(this.effectiveSteerL) / (this.metrics.wheelBase / Math.sin(this.effectiveSteerR)) || 1,
        this.rearSteerDifferential = this.metrics.wheelBase / h.tl / (this.metrics.wheelBase / h.tr) || 1,
        this.tuning.lockDiff && this.slip > 0)
            if (this.slip > .2)
                this.lockDiffOnlyRear || (this.steerDifferential = 1),
                this.rearSteerDifferential = 1;
...
const me = {}
  ...
  , ft = class ft extends ua {
    ...
    init() {
        this.elementsToLoad > 0 && se.add("VEHICLE: Attempting to load new vehicle before prev initialisation has completed");
        for (let s in this.maps)
            W.setMapForMaterial(s, this.maps[s], !0);
        ...
        const e = new _r;
        me.body ? (n.container.add(me.body),
        this.exteriorObjects.body = me.body) : (this.elementsToLoad++,
        e.load(this.geometry.body, s => {
            s.traverse(a => {
                a.isMesh && (a.material = W.getMaterialByName(a.name),
                a.material.shouldCastShadow && (a.castShadow = !0,
                this.exteriorObjects.shadow = a))
            }
            ),
        ...
        me.wheel ? this.wheelObj = me.wheel : (this.elementsToLoad++,
        e.load(this.geometry.wheel, s => {
            s.traverse(a => {
                a.isMesh && (a.material = W.getMaterialByName(a.name),
                a.material.shouldCastShadow && (a.castShadow = !0),
                a.position.z -= this.metrics.wheelWidth / 2,
                a.scale.set(this.metrics.wheelRadius, this.metrics.wheelRadius, this.metrics.wheelRadius))
            }
            ),
            this.wheelObj = s,
            s.frustumCulled = !1,
        ...
        me.interior ? (n.container.add(me.interior),
        this.interiorObjects.interior = me.interior) : (this.elementsToLoad++,
        e.load(this.geometry.interior, s => {
            W.setOnObject(s),
            n.container.add(s),
        ...
        me.dash ? (n.container.add(me.dash),
        this.interiorObjects.dash = me.dash) : (this.elementsToLoad++,
        e.load(this.geometry.dash, s => {
            W.setOnObject(s),
        ...
        me.steer ? (n.container.add(me.steer),
        this.interiorObjects.steeringWheel = me.steer) : (this.elementsToLoad++,
        e.load(this.geometry.steer, s => {
            W.setOnObject(s),
    ...
    setDriverSide(e) {
        this.ready && (e == Na.LEFT ? (this.interiorObjects.interior.scale.z = -1,
        this.interiorObjects.steeringWheel.position.z = -this.layout.steeringPos.z,
        this.interiorObjects.dash.position.z = -this.layout.steeringPos.z) : (this.interiorObjects.interior.scale.z = 1,
        this.interiorObjects.steeringWheel.position.z = this.layout.steeringPos.z,
    ...
    updateVisuals() {
        this.ready && (n.inAutodrive ? this.interiorObjects.steeringWheel.rotation.x = this.interiorObjects.steeringWheel.rotation.x * .8 + L.wheelRotation / 2 * Math.D2R * (-this.steer / this.tuning.maxSteer) * .2 : this.interiorObjects.steeringWheel.rotation.x = L.wheelRotation / 2 * Math.D2R * (-this.steer / this.tuning.maxSteer),
        W.setBrakeLights(this.braking, this.softBraking))
    }
}
;
...
class Fc extends we {
    constructor() {
        ...
        o(this, "listeners", {});
        o(this, "onCameraInteriorChangedBound", this.onCameraInteriorChanged.bind(this));
    ...
    setVehicle(e) {
        (e < 0 || e >= Bi.length) && (console.warn("VEHICLE: Unrecognised vehicle index", e),
        e = 0,
        V.set("type", 0));
        let s = Bi[e].key;
        if (Le.scene == 2 && (s = "drift"),
        s == this.type)
            return;
        if (!(s in fa)) {
        ...
        V.set("speedControlTarget", Math.min(V.speedControlTarget, this.tuning.topSpeed * 3.6)),
        V.setMany({
    ...
    setHeadlights(e, s) {
        !e && !s && this.headlights && this.headlightsManual || (this.headlightsManual = (this.headlightsManual || s) && e,
        this.headlights = e,
    ...
    setDriverSide(e) {
        this.driverSide = e,
        this.controller.setDriverSide(e)
    }
    setShowWheel(e) {
        this.showSteeringWheel = e,
        this.controller.setShowWheel(e)
    }
    setDriveLane(e) {
    ...
    setShadow(e) {
        W.setShadow(e),
        this.controller.setShadow(e)
    }
    setAutodrive(e) {
        this.inAutodrive = e,
        this.controller.setAutodrive(e)
    }
    setGripFactor(e) {
...
const n = new Fc
  ...
  , nn = "" + new URL("../assets/road_single_base.d5dbc374.webp",import.meta.url).href
  , ln = "" + new URL("../assets/gravel.0ee4475c.webp",import.meta.url).href
  , hn = "" + new URL("../assets/summer_rock.674f8c5a.webp",import.meta.url).href
  , Kc = "" + new URL("../assets/summer_bushes.943c4258.webp",import.meta.url).href
  , qc = "" + new URL("../assets/forest_01.b82a9e7e.webp",import.meta.url).href
  , Jc = "" + new URL("../assets/summer_imposters_0_d.6a3261f4.webp",import.meta.url).href
  , $c = "" + new URL("../assets/summer_imposters_0_n.99abbc99.webp",import.meta.url).href
  , eg = "" + new URL("../assets/summer_imposters_1_d.a1e60bf5.webp",import.meta.url).href
  , tg = "" + new URL("../assets/autumn_imposters_1_n.2a7e8cf6.webp",import.meta.url).href
  , ig = "" + new URL("../assets/summer_trees_0.d5cc9742.webp",import.meta.url).href
  , sg = "" + new URL("../assets/summer_trees_0_n.011e666e.webp",import.meta.url).href
  , ag = "" + new URL("../assets/summer_trees_1_m.866c5db4.webp",import.meta.url).href
  , og = "" + new URL("../assets/summer_trees_1_a.c88ed1f2.webp",import.meta.url).href
  , dn = "" + new URL("../assets/wall_barrier_wood.a34ab34c.webp",import.meta.url).href
  , cn = "" + new URL("../assets/wall_drystone.c5584f29.webp",import.meta.url).href
  , as = "" + new URL("../assets/ambiance_summer_low_01.6d623f8c.mp3",import.meta.url).href
  , rg = {
    grass: io,
    bushes: Kc,
    forest: qc,
  ...
  , gg = "" + new URL("../assets/autumn_bushes.b82ca395.webp",import.meta.url).href
  , ug = "" + new URL("../assets/forest_autumn.55ca08bd.webp",import.meta.url).href
  , fg = "" + new URL("../assets/autumn_heather.d890b430.webp",import.meta.url).href
  , pg = "" + new URL("../assets/road_overlay_autumn.68f523cb.webp",import.meta.url).href
  , Ag = "" + new URL("../assets/road_single_overlay_autumn.59ecdb8e.webp",import.meta.url).href
  , mg = "" + new URL("../assets/autumn_imposters_0_d.4c4b38fd.webp",import.meta.url).href
  , vg = "" + new URL("../assets/autumn_imposters_0_n.d10ccd46.webp",import.meta.url).href
  , wg = "" + new URL("../assets/autumn_imposters_1_d.0160320a.webp",import.meta.url).href
  , xg = "" + new URL("../assets/autumn_imposters_1_n.2a7e8cf6.webp",import.meta.url).href
  , Sg = "" + new URL("../assets/autumn_trees_0.2fe560b0.webp",import.meta.url).href
  , bg = "" + new URL("../assets/autumn_trees_0_n.a664e3e1.webp",import.meta.url).href
  , yg = "" + new URL("../assets/autumn_trees_1_m.2cd39e32.webp",import.meta.url).href
  , Dg = "" + new URL("../assets/autumn_trees_1_a.2aa926cb.webp",import.meta.url).href
  , Mg = {
    grass: io,
    bushes: gg,
    forest: ug,
  ...
  , fr = "" + new URL("../assets/winter_grass.2126ead2.webp",import.meta.url).href
  , Tg = "" + new URL("../assets/winter_grasses.fbb53d0d.webp",import.meta.url).href
  , Ig = "" + new URL("../assets/winter_bushes.8e9f3165.webp",import.meta.url).href
  , Fg = "" + new URL("../assets/forest_winter.0710a850.webp",import.meta.url).href
  , _g = "" + new URL("../assets/winter_rock.674a5de1.webp",import.meta.url).href
  , pr = "" + new URL("../assets/winter_gravel.03b9e4e9.webp",import.meta.url).href
  , kg = "" + new URL("../assets/winter_heather.b9aeb76f.webp",import.meta.url).href
  , Pg = "" + new URL("../assets/ground_detail_far_winter.003963d8.webp",import.meta.url).href
  , Eg = "" + new URL("../assets/winter_road.e19b36b8.webp",import.meta.url).href
  , Ng = "" + new URL("../assets/winter_road_single.7e3852c1.webp",import.meta.url).href
  , Og = "" + new URL("../assets/winter_imposters_0_d.ce1a9b7d.webp",import.meta.url).href
  , Bg = "" + new URL("../assets/winter_imposters_0_n.8293f6b6.webp",import.meta.url).href
  , Ug = "" + new URL("../assets/winter_imposters_1_d.2882c5c9.webp",import.meta.url).href
  , Hg = "" + new URL("../assets/autumn_imposters_1_n.2a7e8cf6.webp",import.meta.url).href
  , zg = "" + new URL("../assets/winter_trees_0.99189e5d.webp",import.meta.url).href
  , Wg = "" + new URL("../assets/winter_trees_0_n.24c5f705.webp",import.meta.url).href
  , Gg = "" + new URL("../assets/winter_trees_1_m.7ee3e863.webp",import.meta.url).href
  , Vg = "" + new URL("../assets/winter_trees_1_a.142fe383.webp",import.meta.url).href
  , jg = "" + new URL("../assets/winter_wall_barrier.2f3faaf6.webp",import.meta.url).href
  , Zg = "" + new URL("../assets/winter_wall_concrete.edcd548c.webp",import.meta.url).href
  , Qg = "" + new URL("../assets/winter_wall_barrier_wood.058b9fbc.webp",import.meta.url).href
  , Xg = "" + new URL("../assets/winter_wall_drystone.ef024453.webp",import.meta.url).href
  , Yg = {
    grass: fr,
    bushes: Ig,
    forest: Fg,
  ...
  , mi = {
    ...
    roadStyle: [{
        midline: {
            ...
            minFineSegs: 4,
            solidLineThreshold: .1,
            solidLineCrestThreshold: -.02,
            markingsMargin: 12
        },
        heightmap: {
            scale: 80,
        ...
        midline: {
            ...
            maxTurnDelta: .1,
            minFineSegs: 3,
            solidLineThreshold: .08,
            solidLineCrestThreshold: -.3,
            markingsMargin: 8
        },
        heightmap: {
            scale: 110,
...
function Is(l) {
    return i => {
        ...
        i.vertexShader = i.vertexShader.replace("#include <displacementmap_pars_vertex>", `#include <displacementmap_pars_vertex>
` + un),
        i.vertexShader = i.vertexShader.replace("#include <displacementmap_vertex>", `#include <displacementmap_vertex>
` + fn),
        i.fragmentShader = i.fragmentShader.replace("#include <map_pars_fragment>", `#include <map_pars_fragment>
` + pn),
        i.fragmentShader = i.fragmentShader.replace("#include <lights_fragment_begin>", "#include <lights_fragment_begin_shadow>")
    }
}
const Xu = `
...
`;
let qu = 0, xt, nt = 7, St = 0, Ji, mr = .02;
const R = {
    normVec: new m,
    vecA: new m
}
  , Pe = class Pe {
    constructor(i) {
        ...
        this.geo.setAttribute("position", new Ye(new Float32Array(this.vertCount * 3),3)),
        this.geo.attributes.position.setUsage(At),
        this.geo.setAttribute("normal", new Ye(new Float32Array(this.vertCount * 3),3)),
        this.geo.attributes.normal.setUsage(At),
        this.geo.computeVertexNormals = () => {}
        ,
        this.geo.setAttribute("uv", new Ye(new Float32Array(this.vertCount * 2),2)),
        this.geo.attributes.uv.setUsage(At),
        this.geo.boundingSphere = new Rr;
        let e = (xt - 1) * 2 * 3
          , s = (xt * 10 + 1) * 2 * 3;
        if (this.lod1IndexStart = e + 6,
    ...
    static reset() {
        console.log("Hitting the road segment reset"),
        delete Pe.indexTemplate
    }
    getMaterial() {
        return new K
    }
    ...
    initGeneration(i) {
        ...
        let e = mr;
        this.posArr[this.genIndex] = this.node.p.x - this.node.n.x * nt - this.o.x,
        this.normArr[this.genIndex++] = R.normVec.x,
        this.posArr[this.genIndex] = this.node.p.y + e,
        this.normArr[this.genIndex++] = R.normVec.y,
        this.posArr[this.genIndex] = this.node.p.z - this.node.n.z * nt - this.o.z,
    ...
    genNext() {
        ...
        R.roadNodeCount = 0; R.na.nextFine && R.na.i !== R.nb.i && (R.na = R.na.nextFine,
        !!R.na.nextFine); ) {
        ...
        for (R.i = 0; R.i < R.roadNodeCount; R.i++)
            ...
            this.uvArr[this.uvIndex++] = 1,
            this.uvArr[this.uvIndex++] = St,
            this.customGenFine(this.node, this.node.next, i, i + Ji, R.i / R.roadNodeCount, (R.i + 1) / R.roadNodeCount);
        return this.curUV = St,
        ...
        this.node.p.x < this.bounds.minX ? this.bounds.minX = this.node.p.x : this.node.p.x > this.bounds.maxX && (this.bounds.maxX = this.node.p.x),
        this.node.p.y < this.bounds.minY ? this.bounds.minY = this.node.p.y : this.node.p.y > this.bounds.maxY && (this.bounds.maxY = this.node.p.y),
        this.node.p.z < this.bounds.minZ ? this.bounds.minZ = this.node.p.z : this.node.p.z > this.bounds.maxZ && (this.bounds.maxZ = this.node.p.z),
    ...
    finalise() {
        ...
        this.geo.boundingSphere.center.set((this.bounds.maxX + this.bounds.minX) / 2 - this.mesh.position.x, (this.bounds.maxY + this.bounds.minY) / 2 - this.mesh.position.y, (this.bounds.maxZ + this.bounds.minZ) / 2 - this.mesh.position.z),
        this.geo.boundingSphere.radius = Math.sqrt((this.bounds.maxX - this.bounds.minX) * (this.bounds.maxX - this.bounds.minX) + (this.bounds.maxY - this.bounds.minY) * (this.bounds.maxY - this.bounds.minY) + (this.bounds.maxZ - this.bounds.minZ) * (this.bounds.maxZ - this.bounds.minZ)) / 2 + 5,
        this.mesh.updateMatrix(),
        v.vehicleIndex >= this.headIndex - xt / 2 ? this.upgrade() : this.geo.setDrawRange(0, this.lod0LiveIndex)
    }
    upgrade() {
        this.curLod != 1 && (this.curLod = 1,
        this.geo.setDrawRange(this.lod1IndexStart, this.lod1LiveIndex - this.lod1IndexStart))
    }
    downgrade() {
        this.curLod != 0 && (this.curLod = 0,
...
class pA extends cs {
    ...
    getPaintWeight(e, s, a, t, r, c, g, f=!1) {
        let x = this.lerpConstraints[e], w;
        if (s == a)
            x !== null ? (w = x,
            this.lerpConstraints[e] = null) : w = s ? 1 : 0;
        else {
            let S = Math.ceil(t)
              , D = Math.ceil(r);
            if (S == D)
                ...
                let C = r - t
                  , k = (S - t) / C;
                if (f && a && D - S >= 2 && (k += (D - S - 1) / C),
                w = x,
                this.lerpConstraints[e] = null,
                w == null && (w = c < k ? s ? 1 : 0 : a ? 1 : 0),
                c < k && g > k) {
                    let T = (k - c) / (g - c);
                    this.lerpConstraints[e] = w + (.5 - w) / T
                }
            }
        }
        return w
    ...
    customGenFine(e, s, a, t, r, c) {
        ...
        this.bridgeArr[this.bridgeIndex++] = g * (1 - r) + f * r,
        e.paintSolid = e.paintSolidLeftWeight > .5 && e.paintSolidRightWeight > .5,
        s.paintSolid = s.paintSolidLeftWeight > .5 && s.paintSolidRightWeight > .5;
        let x = this.getPaintWeight("paintSolid", e.paintSolid, s.paintSolid, a, t, r, c);
        this.solidArr[this.solidIndex++] = x,
        this.solidArr[this.solidIndex++] = x,
        e.paintSolidLeft = e.paintSolidLeftWeight > .5,
        s.paintSolidLeft = s.paintSolidLeftWeight > .5;
        let w = this.getPaintWeight("paintSolidLeft", e.paintSolidLeft, s.paintSolidLeft, a, t, r, c);
        this.solidLeftArr[this.solidLeftIndex++] = w,
        this.solidLeftArr[this.solidLeftIndex++] = w,
        e.paintSolidRight = e.paintSolidRightWeight > .5,
        s.paintSolidRight = s.paintSolidRightWeight > .5,
        w = this.getPaintWeight("paintSolidRight", e.paintSolidRight, s.paintSolidRight, a, t, r, c),
        this.solidRightArr[this.solidRightIndex++] = w,
        this.solidRightArr[this.solidRightIndex++] = w,
        w = this.getPaintWeight("paintMergeLeft", !!e.paintMergeLeft, !!s.paintMergeLeft, a, t, r, c, !0),
        this.mergeLeftArr[this.mergeLeftIndex++] = w,
        this.mergeLeftArr[this.mergeLeftIndex++] = w,
        w = this.getPaintWeight("paintMergeRight", !!e.paintMergeRight, !!s.paintMergeRight, a, t, r, c, !0),
        this.mergeRightArr[this.mergeRightIndex++] = w,
        this.mergeRightArr[this.mergeRightIndex++] = w
    }
    finalise() {
        super.finalise(),
        this.customGenFine(this.node, this.node.next, this.curUV, this.curUV + cs.uvStep, 0, 1),
    ...
    regenerateShadows() {
        for (this.shadowIndex = 0,
        this.node = this.headNode; this.node.next.prev.i <= this.tailIndex; )
            this.shadowArr[this.shadowIndex++] = this.node.shadowLeft ?? 0,
            this.shadowArr[this.shadowIndex++] = this.node.shadowRight ?? 0,
...
function of(l, i) {
    var t;
    Ar.length == 2 && l == "winter" ? F.userData.seasonIndex.value = 3 : F.userData.seasonIndex.value = Ar.indexOf(l),
    ...
    oe.discolourationFactor.value = i.effects.treeDiscolouration ? i.effects.treeDiscolouration : 1,
    ...
    for (let r = 0; r < 2; r++) {
        ...
        r == 0 ? $s[r].normalMap = U(i.maps.trees[r].n, 4, c, We) : $s[r].alphaMap = U(i.maps.trees[r].n, 4, c)
    }
    ...
    So.emissiveIntensity = Math.min(i.lights.sun.intensity / 20, .5),
...
function nf(l) {
    ...
    oe.dissolveInterval.value = Math.floor(l.lod1Horizon * 10 * .3),
    oe.dissolveNear.value = oe.dissolveFar.value - oe.dissolveInterval.value,
    ae.userData.dissolveFar.value = oe.dissolveNear.value + oe.dissolveInterval.value * .6,
    ae.userData.dissolveInterval.value = oe.dissolveInterval.value,
    ae.userData.dissolveNear.value = ae.userData.dissolveFar.value - ae.userData.dissolveInterval.value,
    ge.userData.sproutFar.value = (l.lod1Horizon * 12.5) ** 2,
    ge.userData.sproutNear.value = (l.lod1Horizon * 12.5 * .5) ** 2,
...
F.userData.rockMapBump = {
    value: null
};
F.userData.gravelMap = {
    value: null
};
F.userData.heatherMap = {
    value: null
};
F.userData.forestMap = {
    value: null
};
F.userData.detailNearMap = {
    value: null
};
F.userData.detailFarMap = {
    value: null
};
F.userData.grassVariationMap = {
    value: null
};
F.userData.fadeFine = {
    value: Ui
...
F.userData.fresnelIntensity = {
    value: .5
};
F.userData.radiance = {
    value: 0
};
F.userData.grassColA = {
    value: []
};
F.userData.grassColB = {
    value: []
};
F.userData.peakColA = {
    value: []
...
F.userData.fieldDiscolouration = {
    value: []
};
F.userData.vehicleIndex = {
    value: 0
};
F.userData.sinkDist = {
    value: 400
};
F.userData.seasonIndex = {
    value: 1
};
F.onBeforeCompile = l => (l.uniforms.grassMap = F.userData.grassMap,
...
l.vertexShader = l.vertexShader.replace("#include <displacementmap_pars_vertex>", hu + vo),
l.vertexShader = l.vertexShader.replace("#include <displacementmap_vertex>", du),
l.vertexShader = l.vertexShader.replace("#include <project_vertex>", ""),
l.fragmentShader = l.fragmentShader.replace("#include <lights_fragment_begin>", "#include <lights_fragment_begin_shadow>"),
l.fragmentShader = l.fragmentShader.replace("#include <map_pars_fragment>", cu + wo),
l.fragmentShader = l.fragmentShader.replace("#include <map_fragment>", gu + uu),
l.fragmentShader = l.fragmentShader.replace("vec3 outgoingLight = reflectedLight.directDiffuse + reflectedLight.indirectDiffuse + totalEmissiveRadiance;", "vec3 outgoingLight = reflectedLight.directDiffuse + reflectedLight.indirectDiffuse + reflectedLight.directDiffuse * totalEmissiveRadiance;"),
l);
const Y = new K({
    map: U(Wt),
    alphaTest: .75
...
Y.userData.dashedMap = {
    value: de
};
Y.userData.solidMap = {
    value: de
};
Y.userData.solidLeftMap = {
    value: de
};
Y.userData.solidRightMap = {
    value: de
};
Y.userData.mergeLeftMap = {
    value: de
};
Y.userData.mergeRightMap = {
    value: de
};
Y.userData.textureStretch = {
    value: 1
};
Y.userData.overlayMap = {
    value: de
};
Y.userData.hasOverlay = {
    value: !1
};
Y.onBeforeCompile = l => (l.uniforms.fresnelIntensity = F.userData.fresnelIntensity,
l.uniforms.radiance = F.userData.radiance,
...
l.uniforms.shadowFactor = Lt,
l.vertexShader = l.vertexShader.replace("#include <displacementmap_pars_vertex>", `#include <displacementmap_pars_vertex>
` + $i.pars_vert + un + vo),
l.vertexShader = l.vertexShader.replace("#include <displacementmap_vertex>", `#include <displacementmap_vertex>
` + fn + $i.vert + Yu),
l.fragmentShader = l.fragmentShader.replace("#include <map_pars_fragment>", `#include <map_pars_fragment>
uniform float radiance;
` + $i.pars_frag + pn + wo),
l.fragmentShader = l.fragmentShader.replace("#include <map_fragment>", $i.frag + Ku),
l.fragmentShader = l.fragmentShader.replace("#include <lights_fragment_begin>", "#include <lights_fragment_begin_shadow>"),
l.fragmentShader = l.fragmentShader.replace("vec3 outgoingLight = reflectedLight.directDiffuse + reflectedLight.indirectDiffuse + totalEmissiveRadiance;", "vec3 outgoingLight = reflectedLight.directDiffuse + reflectedLight.indirectDiffuse + reflectedLight.directDiffuse * totalEmissiveRadiance;"),
l);
const lf = new Te({
...
X.userData.highlight = {
    value: new st(16777215)
};
X.userData.lowlight = {
    value: new st(15658734)
};
X.userData.hasClouds = {
    value: !0
};
X.userData.camPos = {
    value: new m
...
X.userData.shelfHeight0 = {
    value: 1e3
};
X.userData.shelfHeight1 = {
    value: 1200
};
X.userData.skyScale0 = {
    value: 6e3
};
X.userData.skyScale1 = {
    value: 3e3
};
X.userData.mode = {
    value: 0
...
X.onBeforeCompile = l => (l.uniforms.highlight = X.userData.highlight,
...
l.vertexShader = l.vertexShader.replace("#include <uv_pars_vertex>", `#include <uv_pars_vertex>
` + iu),
l.vertexShader = l.vertexShader.replace("#include <uv_vertex>", `#include <uv_vertex>
` + su),
...
l.fragmentShader = l.fragmentShader.replace("#include <uv_pars_fragment>", `#include <uv_pars_fragment>
` + nu),
l.fragmentShader = l.fragmentShader.replace("#include <fog_fragment>", `#include <fog_fragment>
` + lu),
l);
let ve = new Te({});
ve.userData.camPos = {
...
ve.userData.waves = {
    value: U(ef, 4, void 0, ih)
};
ve.userData.body = {
    value: new st
};
ve.userData.highlight = {
    value: new st
};
ve.userData.time = {
    value: 0
...
function hf(l=!1, i=!1) {
    ...
    ve.onBeforeCompile = e => (e.uniforms.body = ve.userData.body,
    ...
    e.vertexShader = e.vertexShader.replace("#include <color_pars_vertex>", `#include <color_pars_vertex>
` + fu),
...
function wr(l=!1) {
    ...
    return i.needsCameraPosition = !0,
    l ? i.onBeforeCompile = e => (e.uniforms.noiseMap = {
        value: Ui
    },
...
` + sh),
    e.vertexShader = e.vertexShader.replace("#include <project_vertex>", ah),
    e.fragmentShader = e.fragmentShader.replace("#include <normal_fragment_begin>", oh),
    e.fragmentShader = e.fragmentShader.replace("#include <uv_pars_fragment>", `#include <uv_pars_fragment>
` + rh),
    e.fragmentShader = e.fragmentShader.replace("#include <map_fragment>", `#include <map_fragment>
` + nh),
    e.fragmentShader = e.fragmentShader.replace("#include <lights_lambert_pars_fragment>", lh),
    e.fragmentShader = e.fragmentShader.replace("#include <lights_fragment_begin>", hh),
    e.fragmentShader = e.fragmentShader.replace("vec3 outgoingLight = reflectedLight.directDiffuse + reflectedLight.indirectDiffuse + totalEmissiveRadiance;", "vec3 outgoingLight = reflectedLight.directDiffuse + reflectedLight.indirectDiffuse + reflectedLight.directDiffuse * totalEmissiveRadiance;"),
    e) : i.onBeforeCompile = e => (e.uniforms.noiseMap = {
        value: Ui
    },
    e.uniforms.dissolveNear = oe.dissolveNear,
    e.uniforms.dissolveFar = oe.dissolveFar,
    ...
    e.vertexShader = e.vertexShader.replace("#include <uv_pars_vertex>", `#include <uv_pars_vertex>
` + vu),
    e.vertexShader = e.vertexShader.replace("#include <project_vertex>", xu),
    e.fragmentShader = e.fragmentShader.replace("#include <normal_fragment_begin>", kr),
    e.fragmentShader = e.fragmentShader.replace("#include <alphatest_fragment>", yu),
    e.fragmentShader = e.fragmentShader.replace("#include <uv_pars_fragment>", `#include <uv_pars_fragment>
` + Su),
    e.fragmentShader = e.fragmentShader.replace("#include <map_fragment>", `#include <map_fragment>
` + bu),
...
` + Du),
    e.fragmentShader = e.fragmentShader.replace("#include <lights_lambert_pars_fragment>", Ru),
    e.fragmentShader = e.fragmentShader.replace("#include <lights_fragment_begin>", Lu),
    e.fragmentShader = e.fragmentShader.replace("vec3 outgoingLight = reflectedLight.directDiffuse + reflectedLight.indirectDiffuse + totalEmissiveRadiance;", "vec3 outgoingLight = reflectedLight.directDiffuse + reflectedLight.indirectDiffuse + reflectedLight.directDiffuse * totalEmissiveRadiance;"),
    e),
    i
}
...
ae.userData.noiseMap = {
    value: Ui
};
ae.userData.mapB = {
    value: U(Wt)
};
ae.userData.normalMapB = {
    value: U(Wt)
};
ae.userData.dissolveNear = {
    value: 100
};
ae.userData.dissolveFar = {
    value: 200
};
ae.userData.dissolveInterval = {
    value: 100
};
ae.onBeforeCompile = l => {
    ...
    l.uniforms.shadowFactor = Lt,
    l.vertexShader = l.vertexShader.replace("#define LAMBERT", `#define LAMBERT
` + Cu),
    l.vertexShader = l.vertexShader.replace("#include <begin_vertex>", `#include <begin_vertex>
` + Iu),
    l.vertexShader = l.vertexShader.replace("#include <beginnormal_vertex>", Tu + `
` + Fu),
    l.vertexShader = l.vertexShader.replace("#include <project_vertex>", _u),
    l.fragmentShader = l.fragmentShader.replace("#include <normal_fragment_begin>", kr),
    l.fragmentShader = l.fragmentShader.replace("#include <normal_fragment_maps>", Eu),
    l.fragmentShader = l.fragmentShader.replace("#define LAMBERT", `#define LAMBERT
` + ku),
    l.fragmentShader = l.fragmentShader.replace("#include <map_fragment>", Pu),
    l.fragmentShader = l.fragmentShader.replace("#include <lights_fragment_begin>", Nu),
    l.fragmentShader = l.fragmentShader.replace("vec3 outgoingLight = reflectedLight.directDiffuse + reflectedLight.indirectDiffuse + totalEmissiveRadiance;", "vec3 outgoingLight = reflectedLight.directDiffuse + reflectedLight.indirectDiffuse + reflectedLight.directSpecular * totalEmissiveRadiance;")
}
;
let df = .25;
const ge = new K({
...
ge.userData.noiseMap = {
    value: Ui
};
ge.userData.sproutNear = {
    value: 100 * 100
};
ge.userData.sproutFar = {
    value: 200 * 200
};
ge.userData.vehiclePos = {
    value: new m
};
ge.userData.flatten = {
    value: !1
...
ge.onBeforeCompile = l => {
    ...
    l.uniforms.shadowFactor = Lt,
    l.uniforms.seasonIndex = F.userData.seasonIndex,
    l.vertexShader = l.vertexShader.replace("#include <common>", "#include <common>" + Ou + vo),
    l.vertexShader = l.vertexShader.replace("#include <project_vertex>", "" + Bu),
    l.fragmentShader = l.fragmentShader.replace("#include <common>", "#include <common>" + Uu + wo),
    l.fragmentShader = l.fragmentShader.replace("#include <map_fragment>", zu + `
` + Wu),
    l.fragmentShader = l.fragmentShader.replace("#include <normal_fragment_begin>", Hu),
    l.fragmentShader = l.fragmentShader.replace("#include <lights_lambert_pars_fragment>", An),
    l.fragmentShader = l.fragmentShader.replace("#include <lights_fragment_begin>", mn),
    l.fragmentShader = l.fragmentShader.replace("vec3 outgoingLight = reflectedLight.directDiffuse + reflectedLight.indirectDiffuse + totalEmissiveRadiance;", "vec3 outgoingLight = reflectedLight.directDiffuse + reflectedLight.indirectDiffuse + reflectedLight.directDiffuse * totalEmissiveRadiance;")
}
;
let cf = .5;
...
Re.userData.noiseMap = {
    value: af
};
Re.userData.sproutNear = {
    value: 100 * 100
};
Re.userData.sproutFar = {
    value: 200 * 200
};
...
Re.onBeforeCompile = l => {
    ...
    l.uniforms.vehiclePos = ge.userData.vehiclePos,
    l.uniforms.flatten = ge.userData.flatten,
    l.vertexShader = l.vertexShader.replace("#include <common>", "#include <common>" + Gu),
    l.vertexShader = l.vertexShader.replace("#include <project_vertex>", "" + Vu),
    l.fragmentShader = l.fragmentShader.replace("#include <common>", "#include <common>" + ju),
    l.fragmentShader = l.fragmentShader.replace("#include <map_fragment>", Qu),
    l.fragmentShader = l.fragmentShader.replace("#include <normal_fragment_begin>", Zu),
    l.fragmentShader = l.fragmentShader.replace("#include <lights_lambert_pars_fragment>", An),
    l.fragmentShader = l.fragmentShader.replace("#include <lights_fragment_begin>", mn),
    l.fragmentShader = l.fragmentShader.replace("vec3 outgoingLight = reflectedLight.directDiffuse + reflectedLight.indirectDiffuse + totalEmissiveRadiance;", "vec3 outgoingLight = reflectedLight.directDiffuse + reflectedLight.indirectDiffuse + reflectedLight.directDiffuse * totalEmissiveRadiance;")
}
...
So.onBeforeCompile = l => (l.fragmentShader = l.fragmentShader.replace("#include <lights_pars_begin>", sf),
l);
...
const uf = "" + new URL("../assets/tree_01.49d91079.obj",import.meta.url).href
  ...
  , Sf = "data:model/obj;base64,"
  , H = {}
  , Di = 100
  , bf = {
    maxCached: 32,
...
class yf {
    ...
    destroy() {
        delete this.cache,
        delete this.cacheAccess,
        delete this.cacheLayer
    }
    getXZ(i, e) {
        return 0
    }
    ...
    getTile(i, e) {
        return H.bx = i + Di,
        H.bz = e + Di,
        this.cache[H.bx] && this.cache[H.bx][H.bz] ? this.cacheAccess[H.bx][H.bz] = 2 : this.cacheTile(i, e),
    ...
    cacheTile(i, e) {
        ...
        H.bx = i + Di,
        H.bz = e + Di,
        H.bx in this.cache || (this.cache[H.bx] = {},
        ...
        if (!(!i && this.cacheCount <= this.config.maxCached))
            for (H.ox in this.cache) {
                for (H.oz in this.cache[H.ox])
                    if (this.cacheAccess[H.ox][H.oz] < 0 || this.cacheLayer[H.ox][H.oz] !== this.curLayer[H.ox < Di ? 0 : 1]) {
                        if (delete this.cache[H.ox][H.oz],
                        ...
                        this.cacheAccess[H.ox][H.oz] -= 1;
                if (Object.keys(this.cache[H.ox]).length == 0 && (delete this.cache[H.ox],
    ...
    incrementLayer(i, e=!1) {
        !this.config.spiralise && !e || (this.curLayer[i]++,
        this.pruneCache(!0))
    }
    setLayers(i, e=!1) {
        !this.config.spiralise && !e || (this.curLayer[0] = i[0],
        this.curLayer[1] = i[1],
        this.pruneCache(!0))
    }
    cosLerp(i) {
...
(function(l, i) {
    (function(e, s) {
        ...
        return e.importState = function(a) {
            var t = new e;
            return t.importState(a),
            t
        }
        ,
        e;
...
class Sn extends yf {
    ...
    getXZ(e, s, a=null) {
        ...
        for (y.layer of y.tile) {
            ...
            y.ix1 < y.sq ? y.n1 = this.dotGridGradient(y.layer, y.ix1, y.iz, y.sx, y.sz) : y.n1 = this.dotGridGradient(this.getTile(y.ox + 1, y.oz)[y.depth], 0, y.iz, y.sx - y.sq, y.sz),
            y.int0 = this.smootherLerp(y.n0, y.n1, y.qx),
            y.iz1 < y.sq ? (y.n0 = this.dotGridGradient(y.layer, y.ix, y.iz1, y.sx, y.sz),
            y.ix1 < y.sq ? y.n1 = this.dotGridGradient(y.layer, y.ix1, y.iz1, y.sx, y.sz) : y.n1 = this.dotGridGradient(this.getTile(y.ox + 1, y.oz)[y.depth], 0, y.iz1, y.sx - y.sq, y.sz)) : (y.n0 = this.dotGridGradient(this.getTile(y.ox, y.oz + 1)[y.depth], y.ix, 0, y.sx, y.sz - y.sq),
            y.ix1 < y.sq ? y.n1 = this.dotGridGradient(this.getTile(y.ox, y.oz + 1)[y.depth], y.ix1, 0, y.sx, y.sz - y.sq) : y.n1 = this.dotGridGradient(this.getTile(y.ox + 1, y.oz + 1)[y.depth], 0, 0, y.sx - y.sq, y.sz - y.sq)),
    ...
    generateTile(e, s) {
        if (this.config.repeated && this.protoTile)
            return this.protoTile;
        let a, t, r, c, g;
        this.config.repeated ? g = new window.alea(this.config.seed) : g = new window.alea(this.config.seed + "#" + this.curLayer[e < 0 ? 0 : 1] + "#" + e + "#" + s);
        ...
        for (a = 0; a < this.config.depth; a++) {
            ...
            x.push(w),
            f = this.getNextDepthResolution(f, a)
        }
        return this.config.repeated && (this.protoTile = x),
        x
    }
    ...
    dotGridGradient(e, s, a, t, r) {
        return y.grad = e[s][a],
        (t - s) * y.grad.x + (r - a) * y.grad.y
    }
}
let Mt = 1e3, bn = {}, yn = 30, pa = {}, bo = 400, Dn, it, yo, ps, Do = 16, Aa = .4, As = !1, ma = !0, va, Tf = 20, os, If, Ff, Mn, ki, wa, Ln, Rn = .5, Cn = .8, Tn = 1, _f = .5, kf = .4, Pf = .8, Ef = 1, Nf = 1, In = 0, Fn = 1, _n, kn, Pn, fi, ms, Mo, ti, vs, Lo, En, Nn, On, Bn, Un, Hn, zn = {}, Of = 30, Bf = .75, Wn = 256, Gn = {}, Vn = 5e3, Uf = -.3, Hf = 11, zf = 4, Wf = 2, Gf = 1.8, Vf = .7, jf = .7, jn = !0, Zn = 2, Qn = 5e3;
const Zf = [[uf, ff, pf, Af], [mf, vf, wf, xf]];
let Qf = !1
  , xa = 1e4
  , Xf = .8
  , Yf = 1.5
...
let il = 25
  ...
  , Ta = 4
  , rl = [];
const fp = [1, .25, 0, .25, 1]
  , pp = [1, .565, .25, .0625, 0, .0625, .25, .565, 1];
let Ia = 200
  , Fa = 1600
  , nl = 20
  , ll = !1
...
const Lp = new Sn({
  ...
  , Cp = (l, i, e, s) => {
    ...
    i.s == Math.sign(i.g) ? i.ga = Math.max(0, Math.abs(i.g) - 1) / 3 : i.ga = 0,
    i.w = it + Aa + .25 + i.ga,
    i.y -= .01 + .01 * i.gfa,
    i.ga = Math.min(1, Math.max(0, i.ga)) ** 2,
    i.blend = i.n.blend + i.t * (i.n.next.blend - i.n.blend),
    he.rm = Do * (.4 + .6 * i.blend);
    let a = (i.d - i.w) / 16;
    return a < 0 && (a = 0),
    a > 1 && (a = 1),
    a = (1 - a) ** 2,
    a > 0 && (l += a * Lp.getXZ(e, s),
    i.ga > 0 && (l += Rp.getXZ(e, s) * a * i.ga)),
    i.d < i.w + he.rm ? i.d < yo && !i.n.bridge ? i.y : (he.lt = Math.max(0, Math.min(1, (i.d - i.w) / he.rm)),
    he.lt = xl(he.lt),
    he.h = l,
    he.rd = i.d - i.w,
    i.n.bridge && ((t = i.n.next) != null && t.bridge) && (i.n.next.next.bridge ? (r = i.n.prev) != null && r.bridge ? he.lt = 1 : he.lt = Math.max(i.t, he.lt) : he.lt = Math.max(1 - i.t, he.lt),
    i.d < it + Aa + 1 && he.h > i.y && (he.h = i.y)),
    he.h * he.lt + i.y * (1 - he.lt)) : l
}
  , xl = l => l > .3333 ? (he.lerp = 1 - (l - .3333) / .6667,
1 - he.lerp * he.lerp * .5) : l * 1.5
...
class wA {
    constructor(i={}, e={}, s, a) {
        ...
        "spiralise"in i ? _.spiralise = i.spiralise : _.spiralise = !_.direction && !_.isStraight,
        i.turnTrackers)
            for (let t = 0; t < this.turnTrackers.length; t++) {
                let r = this.turnTrackers[t]
                  , c = i.turnTrackers[t];
                c && (this.turnTrackers[t] = {
                    ...r,
                    ...c
                })
            }
    ...
    load() {
        if (Date.now() - this.loadCheckTime > 2e3) {
            if (v.tail.i - this.loadCheckProgress < 50 && (this.loadCheckCounter--,
            se.add(" - Midline failing to progress; tail at " + v.tail.i + ", last check " + this.loadCheckProgress),
            this.loadCheckCounter <= 0)) {
                let e = tr();
                throw Le.set("seed", Ka(), !0),
                location.hash = tr(),
                new Error("Failed to generate road " + e + " - please refresh to try a different seed.")
            }
            this.loadCheckTime = Date.now(),
            this.loadCheckProgress = v.tail.i
        }
        if (v.tail.i < this.startNode + es)
            return this.update(),
            v.tail.i > this.loadCheckLog && v.tail.i % 500 == 0 && (this.loadCheckLog = v.tail.i,
            console.log("Midline loaded to " + v.tail.i / 100 + "km")),
            v.vehicleNode.i < this.startNode && v.tail.i - v.vehicleNode.i > Mi && (v.vehicleNode = v.vehicleNode.next,
            v.vehicleIndex = v.vehicleNode.i),
            !1;
        for (; v.vehicleNode.i < this.startNode; )
            v.vehicleNode = v.vehicleNode.next;
        return v.vehicleIndex = v.vehicleNode.i,
        !0
    }
    restartGeneration() {
        this.restartCount++,
    ...
    makeHeadNode() {
        ...
        delete v.head.rWallDist) : v.head = {
            i: -5,
        ...
        _.spiralise ? (this.targetDir.copy(v.head.p).negate().normalize(),
        this.targetDir.set(-this.targetDir.z, 0, this.targetDir.x).normalize()) : _.direction ? (this.targetDir.x = _.direction.x,
        this.targetDir.z = _.direction.z,
        this.targetDir.normalize()) : (console.log("MIDLINE: No target direction given; aiming for origin"),
        ...
        this.prevTargetSide = Math.sign(this.midlineOrth.dot(this.targetDir) * -1),
    ...
    checkUpdateHeadHeightmap() {
        _.spiralise && this.headHeightmap.prevSide !== Math.sign(v.head.p.z) && this.headHeightmap.nextLayerSwitch === Math.sign(v.head.p.x) && (this.headHeightmap.prevSide = Math.sign(v.head.p.z),
        ...
        se.add("MIDLINE: Incrementing head heightmap: " + this.headHeightmap.layers[0] + ", " + this.headHeightmap.layers[1] + " @ node " + v.head.i + "(x " + v.head.p.x + ")"))
    }
    checkUpdateTailHeightmap() {
        _.spiralise && this.tailHeightmap.prevSide !== Math.sign(v.tail.p.z) && this.tailHeightmap.nextLayerSwitch === Math.sign(v.tail.p.x) && (this.tailHeightmap.prevSide = Math.sign(v.tail.p.z),
    ...
    getNextStartingPose() {
        ...
        let r = !1;
        for (_.startPos && this.restartCount > 2 && console.log("FAILED TO GENERATE FROM START POS"); ; ) {
            if (_.startPos && this.restartCount < 3)
                ...
                if (this.restartCount > 20) {
                    ...
                    se.add("MIDLINE: Incrementing tail heightmap layers: " + this.tailHeightmap.layers[0] + ", " + this.tailHeightmap.layers[1]),
                    this.headHeightmap.layers[0]++,
                    this.headHeightmap.layers[1]++,
                    this.heightmapLayerState.set([...this.headHeightmap.layers]),
                    se.add("MIDLINE: Incrementing head heightmap layers: " + this.headHeightmap.layers[0] + ", " + this.headHeightmap.layers[1]),
                    this.restartCount = 0,
                    i = 0;
                    continue
                } else
                    this.restartCount > 0 && (this.restartCount % 2 == 1 ? i = _.restartMargin * Math.ceil(this.restartCount / 2) : i = _.restartMargin * -(this.restartCount / 2));
                e = 0,
                a = this.targetRadius + i
            } else {
                this.restartCount > 20 ? (i += t.next() * _.restartMargin,
                this.restartCount = 0) : i = t.next() * _.restartMargin;
                let x = t.next() * Math.PI * 2;
                e = Math.cos(x) * i,
                a = Math.sin(x) * i
            }
            if (s = this.heightmap.getXZ(e, a),
            ...
            if (_.startHeading && this.restartCount < 3)
                ...
                this.tVec.set(.99, 0, .01);
            else {
                let x = (s - c) / (g - c)
                  , w = (s - g) / (f - g);
                if (x >= 0 && x <= 1)
                    this.tVec.set(x, 0, (1 - x) * -1).normalize();
                else if (w >= 0 && w <= 1)
                    this.tVec.set(1 - w, 0, w).normalize();
                else {
                    this.restartCount++,
                    console.log("Starting angle issue ", x, w);
                    continue
                }
            }
            return this.restartCount && se.add("MIDLINE: Start-pose attempts: " + this.restartCount),
            {
                position: {
                    x: e,
                    y: s,
    ...
    deleteState() {
        ...
        for (A.t of this.turnTrackers)
            A.t.n = null
    }
    rebuildFine(i) {
        for (_.fineHorizon = i,
        v.fineTail = v.head; v.fineTail.i < v.vehicleIndex + _.fineHorizon && v.fineTail.i < v.tail.i - Mi; )
            this.extendFine()
    }
    reset(i, e) {
        this.deleteState(),
    ...
    extendFine() {
        ...
        A.n.prev ? (A.vecB.copy(A.n.p).sub(A.n.prev.p).multiply(ts).normalize(),
        A.minDot = Math.min(A.vecA.dot(A.vecB), A.vecA.dot(A.vecC)),
        A.minDot > 1 && (A.minDot = 1),
        A.segs = Math.ceil(1 - A.vecA.dot(A.vecB)) * 10) : A.minDot = A.vecA.dot(A.vecC),
        A.minDot = (1 - Math.max(A.minDot, .99)) * 100,
        ...
        A.prevFine = A.n,
        A.n.fs = A.segs,
        A.i = 1; A.i <= A.segs; A.i++)
            A.i < A.segs ? (A.nextFine = {
                next: A.n.next,
                prev: A.n,
                nextFine: null,
                prevFine: A.prevFine,
            ...
            A.t = A.i / A.segs,
            Pp.getPoint(xr + xr * A.t, A.nextFine.p)) : (A.nextFine = v.fineTail.next,
            A.nextFine.prevFine = A.prevFine),
            A.prevFine.nextFine = A.nextFine,
            A.prevFine.prevFine && (A.pdx = A.nextFine.p.x - A.prevFine.prevFine.p.x,
    ...
    extendMidline() {
        var e, s;
        this.didExtend = !0,
        v.tail.i > es && v.tail.i - v.vehicleIndex < Mi && !this.allowEmergencyBridge && !this.bridging && (this.allowEmergencyBridge = !0),
        A.feelDist = _.feelDist * (1 + this.waterFactor),
        A.feelL = this.heightmap.getMidlineXZ(Math.cos(v.tail.a - _.feelAng) * A.feelDist + v.tail.p.x, Math.sin(v.tail.a - _.feelAng) * A.feelDist + v.tail.p.z, this.heightmap.midlineDepth),
        A.feelR = this.heightmap.getMidlineXZ(Math.cos(v.tail.a + _.feelAng) * A.feelDist + v.tail.p.x, Math.sin(v.tail.a + _.feelAng) * A.feelDist + v.tail.p.z, this.heightmap.midlineDepth),
        A.feelA = this.heightmap.getMidlineXZ(v.tail.p.x, v.tail.p.z, this.heightmap.midlineDepth),
        A.feelA = Math.max(A.feelA, _.minElev),
        this.waterFactor = 0,
        this.byWater = !1,
        A.feelR < _.minElev * 2 ? this.byWater = !0 : A.feelL < _.minElev * 2 && (this.byWater = !0),
        A.feelAvg = (A.feelR + A.feelL) / 2,
        A.feelAvg < _.minElev * 3 && (A.feelAvg > _.minElev ? this.waterFactor = 1 - (A.feelAvg - _.minElev) / (_.minElev * 2) : this.waterFactor = 1),
        ...
        this.midlineDir.set(Math.cos(v.tail.a), 0, Math.sin(v.tail.a)),
        this.midlineOrth.set(-this.midlineDir.z, 0, this.midlineDir.x),
        p.targetDot = Math.max(Math.min(1, this.midlineDir.dot(this.targetDir)), -1),
        p.targetSide = Math.sign(this.midlineOrth.dot(this.targetDir) * -1) || this.prevTargetSide,
        p.targetSide == this.prevTargetSide && this.targetOverflow > 1.5 && (p.targetSide == 1 ? p.targetSide = -2 : p.targetSide = 2),
        p.targetSide != this.prevTargetSide ? (p.targetSide > this.prevTargetSide ? this.prevT < 0 ? (this.targetOverflow += this.prevT,
        this.inOverflow && this.targetOverflow <= 0 && (this.targetOverflow = .01),
        this.targetOverflow > 0 ? (p.targetSide = this.prevTargetSide,
        p.targetDot = -1) : this.targetOverflow = 0) : (this.targetOverflow += this.prevT,
        p.targetSide = this.prevTargetSide,
        p.targetDot = -1) : this.prevT > 0 ? (this.targetOverflow -= this.prevT,
        this.inOverflow && this.targetOverflow <= 0 && (this.targetOverflow = .01),
        this.targetOverflow > 0 ? (p.targetSide = this.prevTargetSide,
        p.targetDot = -1) : this.targetOverflow = 0) : (this.targetOverflow -= this.prevT,
        p.targetSide = this.prevTargetSide,
        p.targetDot = -1),
        this.accumulatedOverflow += this.targetOverflow) : (this.targetOverflow = 0,
        this.accumulatedOverflow > 0 && (this.accumulatedOverflow -= 3,
        ...
        (A.gradLeftAbs > 1 || A.gradRightAbs > 1) && (A.gradDif = (A.gradLeft - A.gradRight) / 2,
        A.gradAvg = (A.gradLeft + A.gradRight) / 2,
        A.gradLeft > 1 && A.gradRight > 1 || A.gradLeft < -1 && A.gradRight < -1 ? A.gradLeftAbs < A.gradRightAbs ? (A.maxT = 1,
        A.minT = 1) : (A.maxT = -1,
        A.minT = -1) : (A.gradLeftAbs > 1 && (A.gradLeft < 0 ? A.maxT = (1 + A.gradAvg) / Math.abs(A.gradDif) : A.maxT = (1 - A.gradAvg) / Math.abs(A.gradDif)),
        A.gradRightAbs > 1 && (A.gradRight < 0 ? A.minT = (1 + A.gradAvg) / Math.abs(A.gradDif) : A.minT = (1 - A.gradAvg) / Math.abs(A.gradDif),
        A.minT *= -1))),
        A.gradAvg = (Math.abs(A.gradLat) + Math.abs(A.gradLon)) / 2,
        A.maxDif = _.maxTurnDelta + Math.abs(A.gradAvg) * .5,
        A.maxT > this.prevT ? A.maxT = Math.min(A.maxT, this.prevT + A.maxDif) : A.maxT = Math.max(A.maxT, this.prevT - A.maxDif),
        A.minT < this.prevT ? A.minT = Math.max(A.minT, this.prevT - A.maxDif) : A.minT = Math.min(A.minT, this.prevT + A.maxDif),
        this.byWater && (A.gradLat < 0 ? A.maxT > 0 && (A.maxT *= 1 - this.waterFactor) : A.minT < 0 && (A.minT *= 1 - this.waterFactor)),
        A.bT = Math.max(Math.min(A.maxT, A.bT), A.minT),
        !this.bridging && this.byWater && (this.tVec.set(0, 0, 0),
        this.targetOverflow <= 0 && A.gradLon < -.3 && Math.abs(A.gradLat) < .5 ? (this.tVec.x = this.midlineDir.x,
        this.tVec.z = this.midlineDir.z,
        this.tVec.normalize(),
        this.testForBridge(v.tail.prev, 1, this.tVec),
        this.bridge.optionA.copy(this.landing)) : this.bridge.optionA.set(0, 0, 0),
        ...
        this.tVec.normalize(),
        p.targetDot + 1 * p.bridgeTargetSide > -1 ? (this.testForBridge(v.tail.prev, 1, this.tVec),
        this.bridge.optionB.copy(this.landing)) : this.bridge.optionB.set(0, 0, 0),
        p.targetDot + .7071 * p.bridgeTargetSide > -1 ? (this.tVec.x += this.midlineDir.x,
        this.tVec.z += this.midlineDir.z,
        this.tVec.normalize(),
        this.testForBridge(v.tail.prev, 1, this.tVec),
        this.bridge.optionC.copy(this.landing)) : this.bridge.optionC.set(0, 0, 0)),
        A.gradLon2 = A.gradLon * A.gradLon,
        A.gradLon2 <= 1 ? (!this.byWater || A.gradLon > 0) && (A.bT *= A.gradLon2) : A.bT < 0 ? A.bT = A.minT : A.bT = A.maxT,
        A.bT = Math.max(Math.min(A.maxT, A.bT), A.minT),
        this.antiWeight = 0,
        this.antiTargetRange > 0 && (p.d = v.tail.p.x - this.antiTarget.x,
        p.d = p.d * p.d + (v.tail.p.z - this.antiTarget.z) * (v.tail.p.z - this.antiTarget.z),
        this.antiDir.set(this.antiTarget.x - v.tail.p.x, 0, this.antiTarget.z - v.tail.p.z),
        this.antiDir.normalize(),
        p.antiDot = this.midlineDir.dot(this.antiDir),
        p.d < this.antiTargetRange ? (this.antiWeight = 1 - p.d / this.antiTargetRange,
        ...
        p.antiRedirect = Math.max(Math.min(A.maxT, p.antiRedirect), A.minT),
        A.bT = this.antiWeight * p.antiRedirect + (1 - this.antiWeight) * A.bT) : p.antiDot < -.707 && (this.antiTargetRange = 0,
        this.revertTrackerIndex = null,
        this.trackRevertCount = 0,
        this.antiTargetTriggerCount = 0,
        this.allowEmergencyBridge = !1)),
        p.targetAdjust = (1 - (p.targetDot + 1) / 2) * (1 - this.waterFactor * this.waterFactor),
        ...
        p.violatedOverflow = (this.accumulatedOverflow > Fp || this.targetOverflow > 3) && !this.bridging,
        p.shouldBridge = !1,
        !this.bridging && this.bridge.spawnNode && (p.bridgeRevertNodes = v.tail.i - this.bridge.spawnNode.i,
        p.bridgeRevertNodes > hi && this.resetBridgeState(),
        p.bridgeQualityThreshold = p.targetDot < 0 ? .5 + p.targetDot / 2 : .5 + p.targetDot * .25,
        p.bridgeQualityThreshold -= this.antiTargetTriggerCount * .1,
        ...
        p.shouldBridge = !this.bridging && this.bridge.quality >= p.bridgeQualityThreshold && p.bridgeRevertNodes >= p.bridgeRevertMinNodes && p.bridgeRevertNodes <= p.bridgeRevertMaxNodes),
        p.violatedTurnback = !1;
        for (p.tracker of this.turnTrackers)
            if (p.tracker.da += v.tail.da,
            p.tracker.n.i <= v.tail.i - p.tracker.m && (p.tracker.da -= p.tracker.n.da,
            p.tracker.n = p.tracker.n.next),
            p.tracker.daThreshold = p.tracker.a,
            Math.abs(p.tracker.da) > p.tracker.daThreshold && (p.trackerDir.copy(v.tail.p).sub(p.tracker.n.p).normalize(),
            p.tracker.targetDot = p.trackerDir.dot(this.targetDir),
            p.tracker.daThreshold = p.tracker.a,
            p.tracker.tolerance = (p.tracker.targetDot + p.targetDot) / 2,
            ((p.targetDot < 0 || p.tracker.targetDot < 0) && this.byWater || this.targetOverflow > 0) && (p.tracker.tolerance = 0),
            p.tracker.tolerance > 0 && (p.tracker.daThreshold = p.tracker.a + p.tracker.tolerance * p.tracker.toleranceFactor)),
            Math.abs(p.tracker.da) > p.tracker.daThreshold || p.shouldBridge || p.tracker.gThreshold && Math.abs(v.tail.g) > p.tracker.gThreshold || Math.abs(A.gradLon) > 5) {
                this.trackerViolation = p.tracker.i + ": " + (Math.abs(p.tracker.da) / p.tracker.a * 100).toFixed(1) + "%, " + (p.targetDot.toFixed(1) + " vs " + p.tracker.o),
                p.violatedTurnback = !0;
                break
            }
        if (!_.isStraight && (p.violatedTurnback || p.shouldBridge || p.violatedOverflow)) {
            if (this.bridging && (p.shouldBridge = !1,
            this.bridging = !1,
            ...
            this.didExtend = !1,
            p.violatedTurnback ? this.lastResetIndex > 0 && Math.abs(this.lastResetIndex - v.tail.i) < p.tracker.m * 2 || this.revertTrackerIndex == p.tracker.i && this.antiWeight > 0 ? (p.violatedTurnbackMulti = !0,
            p.revertDistance = Math.max(p.tracker.m, this.antiTargetRevert + p.tracker.r * (this.antiTargetTriggerCount + 1)),
            v.tail.i - p.revertDistance < this.maxRetractIndex && (p.revertDistance = v.tail.i - this.maxRetractIndex + (this.antiTargetTriggerCount + 1))) : p.revertDistance = p.tracker.m : p.violatedOverflow && (p.revertDistance = this.antiTargetRevert + 25,
            p.revertDistance > hi && (p.revertDistance = hi),
            p.revertDistance = Math.max(50, p.revertDistance)),
            p.shouldBridge || !this.bridging && this.bridge.spawnNode && this.bridge.quality > 0 && p.bridgeRevertNodes < p.revertDistance ? (this.bridging = !0,
            ...
            p.maxRevert = !1) : p.violatedOverflow ? (this.antiTargetRevert += 25,
            this.antiTargetRevert > hi && (p.maxRetract = !0,
            this.antiTargetRevert = hi),
            p.revertDistance = Math.max(50, this.antiTargetRevert),
            this.antiTarget.lerp(v.tail.p, 1 / (this.antiTargetTriggerCount + 1)),
            this.allowEmergencyBridge = !0) : (this.antiTargetTriggerPoint.copy(v.tail.p),
            p.violatedTurnbackMulti ? (this.antiTargetTriggerCount++,
            this.antiTargetRevert = Math.max(p.tracker.m, this.antiTargetRevert + p.tracker.r * this.antiTargetTriggerCount),
            v.tail.i - this.antiTargetRevert < this.maxRetractIndex ? (this.antiTarget.lerp(v.tail.p, this.rand()),
            this.antiTargetRevert = v.tail.i - this.maxRetractIndex + this.antiTargetTriggerCount,
            this.allowEmergencyBridge = !0,
            p.maxRevert = !0) : this.antiTarget.lerp(v.tail.p, 1 / (this.antiTargetTriggerCount + 1)),
            p.revertDistance = this.antiTargetRevert) : (this.revertTrackerIndex = p.tracker.i,
            this.antiTarget.copy(v.tail.p).add(p.tracker.n.p).multiplyScalar(.5),
            ...
            for (; v.tail.i > p.resetIndex; ) {
                if (!v.tail.bridge && ((e = v.tail.prev) != null && e.bridge)) {
                    for (p.bn = v.tail.prev; (s = p.bn) != null && s.bridge; )
                        p.bn = p.bn.prev;
                    if (p.bn.i < p.resetIndex)
                        break;
                    this.antiBridgePoint.copy(v.tail.p)
                }
                if (v.tail.prev == null || v.tail.i - v.head.i < yt || v.tail.d > 0 && v.tail.gfa < .1 && Math.abs(v.tail.g) < .1 && Math.abs(v.tail.i - this.lastResetIndex) > this.antiTargetRevert / 4)
                    break;
                v.tail.o && (v.tail.o < 0 ? this.accumulatedOverflow += v.tail.o : this.accumulatedOverflow -= v.tail.o),
            ...
            if (this.smoothWindowHead.i > v.tail.i - yt)
                for (p.startI = 0,
                this.smoothWindowHead.i <= v.tail.i ? p.startI = Math.max(0, v.tail.i - this.smoothWindowHead.i) : (this.smoothWindowHead = v.tail,
                this.smoothWindowHead.p.y += this.smoothWindowHead.h),
                p.i = p.startI; p.i <= yt; p.i++)
                    this.smoothWindowHead.prev && (this.smoothWindowHead = this.smoothWindowHead.prev,
                    this.smoothWindowHead.p.y += this.smoothWindowHead.h);
            if (this.bridging || (this.antiTargetRange = this.antiTarget.distanceToSquared(v.tail.p) * 4,
            this.lastResetIndex = v.tail.i),
            !this.bridging && this.bridge.spawnNode && this.bridge.spawnNode.i > v.tail.i && this.resetBridgeState(),
            v.vehicleIndex > v.tail.i)
                return console.error("Midline has somehow reverted behind car?"),
            ...
            for (p.tracker2 of this.turnTrackers)
                for (p.tracker2.n = v.tail,
                p.tracker2.da = v.tail.da,
                p.i = 0; p.i < p.tracker2.m && p.tracker2.n.prev; p.i++)
                    p.tracker2.n = p.tracker2.n.prev,
                    p.tracker2.da += p.tracker2.n.da;
            return this.prevT = v.tail.t,
            this.waterFactor = Math.max(Math.min(1, 1 - (v.tail.p.y - _.minElev) / (_.minElev * 2)), 0),
            "o"in v.tail ? v.tail.o < 0 ? (this.prevTargetSide = -1,
            this.targetOverflow = -v.tail.o) : (this.prevTargetSide = 1,
            this.targetOverflow = v.tail.o) : (this.midlineDir.set(Math.cos(v.tail.a), 0, Math.sin(v.tail.a)),
            this.midlineOrth.set(-this.midlineDir.z, 0, this.midlineDir.x),
        ...
        if (this.bridging)
            if (this.onBridgeApproach) {
                p.vecA.set(this.bridge.landing.x - this.bridge.spawnNode.p.x, 0, this.bridge.landing.z - this.bridge.spawnNode.p.z).normalize();
                let a = Math.atan2(p.vecA.z, p.vecA.x)
                  , t = v.tail.a - a;
                t < -Math.PI ? t += Math.PI * 2 : t > Math.PI && (t -= Math.PI * 2);
                let r = t / _.feelAng;
                A.bT = Math.min(Math.max(-this.bridgeApproachFactor, r), this.bridgeApproachFactor),
                this.bridgeApproachFactor < 1.4 && (this.bridgeApproachFactor = 1.4),
                Math.abs(A.bT) < .25 && (A.bT = 0)
            } else
                A.bT = 0;
        _.isStraight && (A.bT = 0),
        this.bridging || (A.bT *= _.smoothFactor),
        _.squared && A.bT < 1 && A.bT > -1 && (A.bT < 0 ? A.bT = A.bT * A.bT * -1 : A.bT *= A.bT),
        this.prevT = A.bT,
        A.bDir = v.tail.a - A.bT * _.feelAng,
        A.bDir < -Math.PI ? A.bDir += Math.TAU : A.bDir > Math.PI && (A.bDir -= Math.TAU),
        p.roadSinkFactor = _.roadSink,
        A.feelAvg < 10 ? p.roadSinkFactor = 0 : A.feelAvg < 20 && (p.roadSinkFacotr *= (A.feelAvg - 10) / 10),
        ...
        let i = {
            i: v.tail.i + 1,
            p: new m(p.x,Math.max(this.heightmap.getXZ(p.x, p.z, this.heightmap.midlineDepth), _.minElev) - p.roadSinkFactor,p.z),
            a: A.bDir,
            d: p.targetDot,
            da: A.bT * _.feelAng,
            h: 0,
        ...
        return this.totalDA += Math.abs(i.da),
        this.bridging && (this.onBridgeApproach ? (i.p.y <= this.bridge.height && A.bT == 0 && (v.tail.bridge = !0,
        this.onBridgeApproach = !1),
        i.p.y > this.bridge.height ? i.p.y = (this.bridge.height + i.p.y) / 2 : i.p.y = Math.max(i.p.y, this.bridge.height)) : i.p.y > _.minElev && i.p.y > this.bridge.height - 1 ? (this.onBridgeDismount = !1,
        this.bridging = !1,
        this.allowEmergencyBridge = !1,
        this.resetBridgeState(),
        i.p.y = (i.p.y + this.bridge.height) / 2) : i.p.y = Math.max(i.p.y, this.bridge.height)),
        (this.bridging && !this.onBridgeApproach && !this.onBridgeDismount || _.isStraight && i.p.y <= 2) && (i.bridge = !0),
        this.targetOverflow > 0 && (i.o = this.targetOverflow * p.targetSide),
        v.tail.next = i,
        isNaN(p.x) ? (se.add("MIDLINE: NaN at index " + i.i),
        ...
        !1) : (v.tail = i,
        this.maxRetractIndex = Math.max(this.maxRetractIndex, v.tail.i - hi),
        _.spiralise && (this.tVec.copy(v.tail.p).negate().normalize(),
        this.targetDir.set(-this.tVec.z, 0, this.tVec.x).normalize(),
        p.factor = 0,
        _.isStraight || (p.rad = v.tail.p.length(),
        p.rad < this.targetRadius ? (p.rad < this.targetRadiusMin ? p.factor = 1 : p.factor = 1 - (p.rad - this.targetRadiusMin) / this.targetMargin,
        p.factor *= p.factor,
        this.targetDir.lerp(this.tVec.negate(), p.factor).normalize()) : (p.rad > this.targetRadiusMax ? p.factor = 1 : p.factor = (p.rad - this.targetRadius) / this.targetMargin,
        p.factor *= p.factor,
    ...
    improveBridgeStartNode() {
        let i, e, s = this.bridge.spawnNode, a = this.bridge.spawnNode.p.distanceToSquared(this.bridge.landing), t = a + 225, r = new rs, c = new rs;
        c.x = s.p.x - s.prev.p.x,
        c.y = s.p.z - s.prev.p.z,
        c.normalize(),
        r.set(this.bridge.landing.x - s.p.x, this.bridge.landing.z - s.p.z).normalize(),
        e = c.dot(r);
        let g = c.dot(r);
        if (s = s.prev,
        !!s)
            for (let f = 0; f < 10 && !(!s.prev || s.p.y > this.bridge.landing.y + 4); f++)
                ...
                e = c.dot(r),
                i < a && (a = i,
                this.bridge.spawnNode = s),
                e > g && (e > .707 || i < t) && (g = e,
                this.bridge.spawnNode = s),
                e < .707 && (this.bridge.spawnNode = s),
                s = s.prev
    }
    testForBridge(i, e, s) {
        let a = 0
          ...
          , c = t / 2
          , g = !1;
        if (this.landing.x = i.p.x + s.x * t * e,
        ...
        this.landing.y < 2 && (this.landing.y = 0,
        a = Li,
        g = !0),
        ...
        for (let x = 0; x < r; x++) {
            if (this.landing.x = i.p.x + s.x * c * e,
        ...
        if (c < ta || this.landing.distanceTo(this.antiBridgePoint) < kp)
            return;
        let f = this.checkBridgeQuality(i.p, this.landing, c);
        f > 0 && (f > this.bridge.quality || this.bridge.spawnNode && this.bridge.spawnNode.i < v.tail.i - 50) && (this.bridge.quality = f,
        this.bridge.spawnNode = i,
        this.bridge.distance = c,
        this.bridge.landing.copy(this.landing))
    }
    checkBridgeQuality(i, e, s) {
        p.bridgeMid.copy(i).add(e).multiplyScalar(.5);
        let a = 1 - (s - ta) / Li
          , t = 1 - Math.min(1, Math.abs(i.y - e.y) / 4)
          , r = this.heightmap.getXZ(p.bridgeMid.x, p.bridgeMid.z, this.heightmap.midlineDepth);
        if (r > 0)
            return -1;
        r > -2 ? r = r / -2 : r = 1,
        ...
        if (p.bridgeDir.y = p.bridgeDir.x,
        p.bridgeDir.x = -p.bridgeDir.z,
        p.bridgeDir.z = p.bridgeDir.y,
        p.bridgeDir.y = 0,
        p.bridgeTest.copy(p.bridgeDir).multiplyScalar(s).add(p.bridgeMid),
        p.bridgeCheckRight = this.heightmap.getXZ(p.bridgeTest.x, p.bridgeTest.z, this.heightmap.midlineDepth),
        p.bridgeCheckRight > 0 || (p.bridgeCheckRight > -4 ? p.bridgeCheckRight = p.bridgeCheckRight / -4 : p.bridgeCheckRight = 1,
        p.bridgeTest.copy(p.bridgeDir).multiplyScalar(-s).add(p.bridgeMid),
        p.bridgeCheckLeft = this.heightmap.getXZ(p.bridgeTest.x, p.bridgeTest.z, this.heightmap.midlineDepth),
        p.bridgeCheckLeft > 0))
            return -1;
        p.bridgeCheckLeft > -4 ? p.bridgeCheckLeft = p.bridgeCheckLeft / -4 : p.bridgeCheckLeft = 1;
        let g = (p.bridgeCheckLeft + p.bridgeCheckRight) / 2;
        return p.bridgeTest.copy(p.bridgeDir).multiplyScalar(s / 2).add(p.bridgeMid),
        p.bridgeCheckRight = this.heightmap.getXZ(p.bridgeTest.x, p.bridgeTest.z, this.heightmap.midlineDepth),
        p.bridgeCheckRight > 0 || (p.bridgeTest.copy(p.bridgeDir).multiplyScalar(-s / 2).add(p.bridgeMid),
        p.bridgeCheckLeft = this.heightmap.getXZ(p.bridgeTest.x, p.bridgeTest.z, this.heightmap.midlineDepth),
        p.bridgeCheckLeft > 0) ? -1 : (a + t + r + c + g) / 5
    }
    smoothCurves() {
        if (this.config.smoothingStrength == 0)
            return;
        this.smoothCurvesD();
    ...
    smoothCurvesB() {
        ...
        let e = i.prev
          ...
          , a = (e.p.x + s.p.x) / 2
          , t = (e.p.z + s.p.z) / 2
          , r = Math.max(.25, Math.min(1, Math.abs(e.da - s.da) / 1.2));
        i.p.x = i.p.x * (1 - r) + a * r,
        i.p.z = i.p.z * (1 - r) + t * r
    }
    smoothCurvesD() {
        ...
        let e = i.prev
          ...
          , t = (e.p.z + s.p.z) / 2
          , r = (e.da + i.da + s.da) / 3
          , c = 1 - Math.max(.25, Math.min(1, Math.abs(r) / .4));
    ...
    smoothHeight() {
        ...
        p.bridgeLerp = 1,
        p.i = 0; p.i < yt; p.i++)
            p.n.bridge && (p.windowHasBridge = !0,
